export const __webpack_esm_id__ = "vendors-src_calendar_view_YearComponent_mjs";
export const __webpack_esm_ids__ = ["vendors-src_calendar_view_YearComponent_mjs"];
