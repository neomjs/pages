...
class Base extends _core_Base_mjs__WEBPACK_IMPORTED_MODULE_2__["default"] {
    ...
    beforeSetStateProvider(value, oldValue) {
        ...
        if (value) {
            ...
            return _util_ClassSystem_mjs__WEBPACK_IMPORTED_MODULE_0__["default"].beforeSetInstance(value, 'Neo.state.Provider', defaultValues)
        }
    ...
    #executeVdomUpdate(vdom, vnode, resolve, reject) {
        ...
        opts.vdom  = _manager_Component_mjs__WEBPACK_IMPORTED_MODULE_1__["default"].getVdomTree(vdom, me.updateDepth);
        opts.vnode = _manager_Component_mjs__WEBPACK_IMPORTED_MODULE_1__["default"].getVnodeTree(vnode, me.updateDepth);
    ...
    async render(mount) {
        ...
        if (me.vdom) {
            ...
            const data = await Neo.vdom.Helper.create({
                ...
                windowId   : me.windowId,
                ..._manager_Component_mjs__WEBPACK_IMPORTED_MODULE_1__["default"].getVdomTree(me.vdom)
            });
