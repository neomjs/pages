    ...
    async processReadonlyCodeBlocks(contentString, windowId) {
        ...
        let updatedContent = contentString.replace(regexReadonly, (match, language, code) => {
            ...
            replacementPromises.push(
                _util_HighlightJs_mjs__WEBPACK_IMPORTED_MODULE_1__["default"].highlightAuto(code, windowId)
                    .then(highlightedHtml => ({
                        after: `<pre data-${language} class="hljs" id="pre-readonly-${_core_IdGenerator_mjs__WEBPACK_IMPORTED_MODULE_2__["default"].getId()}">${highlightedHtml.trim()}</pre>`,
                        token
                    }))
            );
            return token;
