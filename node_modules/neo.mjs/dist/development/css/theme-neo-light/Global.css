...
:root .neo-theme-neo-light {
  ...
  --sem-color-bg-neutral-active: var(--gray-900);
  ...
  --sem-color-bg-neutral-hover: var(--gray-900);
  ...
  --sem-color-surface-disabled: var(--gray-200);
  --sem-color-surface-neutral-active: rgba(0, 0, 0, .1);
  --sem-color-surface-neutral-default: var(--gray-50);
  --sem-color-surface-neutral-highlighted: var(--white);
  --sem-color-surface-neutral-hover: rgba(0, 0, 0, .05);
  --sem-color-surface-primary-active: var(--purple-700);
  --sem-color-surface-primary-background: var(--purple-100);
  --sem-color-surface-primary-default: var(--purple-400);
  --sem-color-surface-primary-hover: var(--purple-500);
  --sem-color-text-disabled: var(--gray-300);
  --sem-color-text-neutral-contrast: var(--black);
  --sem-color-text-neutral-default: var(--gray-900);
  --sem-color-text-neutral-reversed: var(--white);
  --sem-color-text-neutral-subdued: var(--gray-700);
  --sem-color-text-primary-default: var(--purple-400);
  --sem-color-icon-neutral-contrast: var(--black);
  --sem-color-icon-neutral-default: var(--gray-900);
  --sem-color-icon-neutral-reversed: var(--white);
  --sem-color-icon-neutral-subdued: var(--gray-700);
  --sem-color-icon-primary-default: var(--purple-400);
...
:root .neo-theme-neo-light {
  ...
  --cmp-list-item-surface-default: #fff;
...
:root .neo-theme-neo-light i, :root .neo-theme-neo-light em {
  font-style: italic;
}
:root .neo-theme-neo-light code:not(.hljs) {
...
:root .neo-theme-neo-light h1 code:not(.hljs), :root .neo-theme-neo-light h2 code:not(.hljs), :root .neo-theme-neo-light h3 code:not(.hljs), :root .neo-theme-neo-light h4 code:not(.hljs), :root .neo-theme-neo-light h5 code:not(.hljs), :root .neo-theme-neo-light h6 code:not(.hljs) {
  margin: 0 0.15em;
  padding: 0 0.3em;
}
:root .neo-theme-neo-light mark {
