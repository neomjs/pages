:root .neo-theme-neo-dark {
  ...
  --button-badge-color: var(--sem-color-fg-neutral-inverted);
  ...
  --button-ripple-background-color: #435DB1;
  ...
  --button-secondary-text-color-disabled: var(--sem-color-text-disabled);
  ...
  --button-secondary-ripple-background-color: #435DB1;
  ...
  --button-ghost-ripple-background-color: #435DB1;
...
:root .neo-theme-neo-dark .neo-button {
  min-width: var(--cmp-button-height);
}
:root .neo-theme-neo-dark .neo-button.neo-button-tertiary {
