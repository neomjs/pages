:root .neo-theme-neo-dark {
  --menu-list-background-color: var(--sem-color-surface-neutral-default);
  --menu-list-border-color: var(--sem-color-border-default);
  ...
  --menu-list-item-icon-color: var(--sem-color-icon-primary-default);
  --menu-list-item-icon-color-disabled: var(--sem-color-icon-neutral-subdued);
  --menu-list-item-icon-color-selected: var(--sem-color-icon-primary-default);
