:root .neo-theme-neo-dark {
  --covid-helix-background-color: var(--sem-color-bg-neutral-default);
  --covid-helix-border-color: var(--sem-color-border-default);
  ...
  --covid-helix-item-wrapper-background-color: rgba(73,120,184,.2);
}
