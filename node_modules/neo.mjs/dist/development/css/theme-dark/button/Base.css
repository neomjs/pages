:root .neo-theme-dark {
  ...
  --button-ripple-background-color: #4a6987;
  ...
  --button-ghost-border-hover: 1px solid #282828;
  ...
  --button-tertiary-background-color-disabled: var(--button-background-color-hover);
