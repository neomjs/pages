.neo-table-body:focus {
  outline: none;
}
.neo-table-body .neo-center {
  text-align: center;
}
.neo-table-body .neo-right {
  text-align: right;
}
.neo-table-body .neo-table-row .neo-table-cell.neo-is-modified:after {
...
.neo-table-body .neo-table-row .neo-table-cell.selected-column-cell {
