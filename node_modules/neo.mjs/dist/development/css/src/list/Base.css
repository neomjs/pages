...
.neo-list {
  color-scheme: var(--list-scrollbar-color-scheme, light);
...
.neo-list.neo-use-wrapper-node {
  inset: 0;
  position: absolute;
}
.neo-list .neo-list-header {
  position: sticky;
  top: 0;
}
...
.neo-list .neo-list-item:not(.neo-list-header) {
  cursor: pointer;
}
.neo-list .neo-list-item:not(.neo-list-header):hover {
  background-color: var(--list-item-background-color-hover);
  color: var(--list-container-list-color);
}
.neo-list .neo-list-item:not(.neo-list-header):active {
  background-color: var(--list-item-background-color-active);
  color: var(--list-container-list-color);
}
.neo-list .neo-list-item.neo-navigator-active-item {
  outline: var(--list-item-focus-outline);
  outline-offset: var(--list-item-focus-outline-offset);
}
.neo-list .neo-list-item[aria-selected=true] {
