...
.neo-file-upload-state-upload-failed .neo-file-upload-state-icon, .neo-file-upload-state-scan-failed .neo-file-upload-state-icon, .neo-file-upload-field.neo-invalid .neo-file-upload-state-icon {
  background-image: none;
  color: var(--fileuploadfield-error-color);
  border: 3px solid var(--fileuploadfield-error-color);
}
.neo-file-upload-state-upload-failed .neo-file-upload-state, .neo-file-upload-state-scan-failed .neo-file-upload-state, .neo-file-upload-field.neo-invalid .neo-file-upload-state {
  color: var(--fileuploadfield-error-color);
}
