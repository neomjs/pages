...
.neo-file-upload-state-upload-failed .neo-file-upload-state-icon::after, .neo-file-upload-state-upload-failed .neo-file-upload-action-button::after, .neo-file-upload-state-scan-failed .neo-file-upload-state-icon::after, .neo-file-upload-state-scan-failed .neo-file-upload-action-button::after {
  content: var(--cancel-icon-codepoint);
}
.neo-file-upload-state-upload-failed .neo-file-upload-state-icon, .neo-file-upload-state-upload-failed .neo-file-upload-state, .neo-file-upload-state-scan-failed .neo-file-upload-state-icon, .neo-file-upload-state-scan-failed .neo-file-upload-state {
