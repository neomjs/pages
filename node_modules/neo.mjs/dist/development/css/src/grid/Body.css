...
.neo-grid-body .neo-grid-body-content {
  position: relative;
}
...
.neo-grid-body .neo-grid-row .neo-grid-cell.neo-locked-end-first-column {
...
.neo-grid-body .neo-grid-row .neo-grid-cell:not(.neo-locked-start):not(.neo-locked-end) {
  transform: translateX(calc(var(--grid-scroll-left, 0px) * -1));
}
...
.neo-mouse .neo-grid-row:not(.neo-selected):hover .neo-grid-cell, .neo-mouse .neo-grid-row:not(.neo-selected).neo-hover .neo-grid-cell {
