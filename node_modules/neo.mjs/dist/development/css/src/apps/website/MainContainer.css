...
.website-main-container .website-center-region {
  max-width: 824px;
}
.website-main-container .website-main-tabcontainer {
  transition: margin var(--website-transition-duration) ease-out;
}
.website-main-container .website-main-tabcontainer .neo-tab-content-container {
  border: none;
}
