...
.neo-code-live-preview .live-preview-container {
...
.neo-code-live-preview .live-preview-container .neo-tab-header-toolbar {
  background-color: var(--sem-color-surface-neutral-default);
  border: 1px solid var(--live-preview-border-color);
...
.neo-code-live-preview .live-preview-container .neo-tab-strip {
  margin-top: calc(var(--cmp-tab-strip-height) * -1 - 1px);
}
.neo-code-live-preview .live-preview-container .neo-tab-body-container {
...
/*# sourceMappingURL=LivePreview.css.map */