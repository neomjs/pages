...
/***/ "./. lazy recursive ^\\.\\/.*\\/task\\.mjs$ exclude: (?:\\/%7C\\\\)(dist%7Cnode_modules) referencedExports: onStart"
/*!**********************************************************************************************************************************!*\
  !*** ././ lazy ^\.\/.*\/task\.mjs$ exclude: (?:\/%7C\\)(dist%7Cnode_modules) referencedExports: onStart strict namespace object ***!
  \**********************************************************************************************************************************/
(module) {
...
webpackEmptyAsyncContext.id = "./. lazy recursive ^\\.\\/.*\\/task\\.mjs$ exclude: (?:\\/%7C\\\\)(dist%7Cnode_modules) referencedExports: onStart";
...
class Task extends _Base_mjs__WEBPACK_IMPORTED_MODULE_1__["default"] {
    ...
    onRegisterNeoConfig(msg) {
        ...
        __webpack_require__("./. lazy recursive ^\\.\\/.*\\/task\\.mjs$ exclude: (?:\\/%7C\\\\)(dist%7Cnode_modules) referencedExports: onStart")(`./${path}/task.mjs`).then(module => {
            module.onStart()
        })
    }
}
