...
/***/ "./. lazy recursive ^\\.\\/.*\\/task\\.mjs$ include: (?:apps%7Cexamples%7Csrc)\\/.*task\\.mjs$ exclude: (?:\\/%7C\\\\)(buildScripts%7Cdist%7Cnode_modules(?:\\/%7C\\\\)(?%21neo\\.mjs)%7Cai(?:\\/%7C\\\\)%7Cserver\\.mjs%7Cdevindex(?:\\/%7C\\\\)services) referencedExports: onStart"
/*!***************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ././ lazy ^\.\/.*\/task\.mjs$ include: (?:apps%7Cexamples%7Csrc)\/.*task\.mjs$ exclude: (?:\/%7C\\)(buildScripts%7Cdist%7Cnode_modules(?:\/%7C\\)(?%21neo\.mjs)%7Cai(?:\/%7C\\)%7Cserver\.mjs%7Cdevindex(?:\/%7C\\)services) referencedExports: onStart strict namespace object ***!
  \***************************************************************************************************************************************************************************************************************************************************************************************/
...
webpackAsyncContext.id = "./. lazy recursive ^\\.\\/.*\\/task\\.mjs$ include: (?:apps%7Cexamples%7Csrc)\\/.*task\\.mjs$ exclude: (?:\\/%7C\\\\)(buildScripts%7Cdist%7Cnode_modules(?:\\/%7C\\\\)(?%21neo\\.mjs)%7Cai(?:\\/%7C\\\\)%7Cserver\\.mjs%7Cdevindex(?:\\/%7C\\\\)services) referencedExports: onStart";
...
class Task extends _Base_mjs__WEBPACK_IMPORTED_MODULE_1__["default"] {
    ...
    onRegisterNeoConfig(msg) {
        ...
        __webpack_require__("./. lazy recursive ^\\.\\/.*\\/task\\.mjs$ include: (?:apps%7Cexamples%7Csrc)\\/.*task\\.mjs$ exclude: (?:\\/%7C\\\\)(buildScripts%7Cdist%7Cnode_modules(?:\\/%7C\\\\)(?%21neo\\.mjs)%7Cai(?:\\/%7C\\\\)%7Cserver\\.mjs%7Cdevindex(?:\\/%7C\\\\)services) referencedExports: onStart")(`./${path}/task.mjs`).then(module => {
            module.onStart()
        })
    }
}
