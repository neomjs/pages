...
/***/ "./. lazy recursive ^\\.\\/.*\\/task\\.mjs$ exclude: (?:\\/%7C\\\\)(buildScripts%7Cdist%7Cnode_modules)\\/(?%21neo.mjs) referencedExports: onStart"
/*!****************************************************************************************************************************************************************!*\
  !*** ././ lazy ^\.\/.*\/task\.mjs$ exclude: (?:\/%7C\\)(buildScripts%7Cdist%7Cnode_modules)\/(?%21neo.mjs) referencedExports: onStart strict namespace object ***!
  \****************************************************************************************************************************************************************/
...
webpackAsyncContext.id = "./. lazy recursive ^\\.\\/.*\\/task\\.mjs$ exclude: (?:\\/%7C\\\\)(buildScripts%7Cdist%7Cnode_modules)\\/(?%21neo.mjs) referencedExports: onStart";
...
class Task extends _Base_mjs__WEBPACK_IMPORTED_MODULE_1__["default"] {
    ...
    onRegisterNeoConfig(msg) {
        ...
        __webpack_require__("./. lazy recursive ^\\.\\/.*\\/task\\.mjs$ exclude: (?:\\/%7C\\\\)(buildScripts%7Cdist%7Cnode_modules)\\/(?%21neo.mjs) referencedExports: onStart")(`./${path}/task.mjs`).then(module => {
            module.onStart()
        })
    }
}
