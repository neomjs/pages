...
class Main extends _core_export_mjs__WEBPACK_IMPORTED_MODULE_1__.Base {
     ...
     */
    onUpdateDom(data) {
        if (!data.windowId || data.windowId === _worker_Manager_mjs__WEBPACK_IMPORTED_MODULE_7__["default"].windowId) {
