...
/***/ "./. lazy recursive ^\\.\\/.*\\/canvas\\.mjs$ exclude: (?:\\/%7C\\\\)(buildScripts%7Cdist%7Cnode_modules)\\/(?%21neo.mjs) referencedExports: onStart"
/*!******************************************************************************************************************************************************************!*\
  !*** ././ lazy ^\.\/.*\/canvas\.mjs$ exclude: (?:\/%7C\\)(buildScripts%7Cdist%7Cnode_modules)\/(?%21neo.mjs) referencedExports: onStart strict namespace object ***!
  \******************************************************************************************************************************************************************/
...
var map = {
	"./apps/agentos/canvas.mjs": [
		"./apps/agentos/canvas.mjs",
		"apps_agentos_canvas_mjs"
	],
	"./apps/agentos/childapps/swarm/canvas.mjs": [
		"./apps/agentos/childapps/swarm/canvas.mjs",
		"apps_agentos_childapps_swarm_canvas_mjs"
	],
...
webpackAsyncContext.id = "./. lazy recursive ^\\.\\/.*\\/canvas\\.mjs$ exclude: (?:\\/%7C\\\\)(buildScripts%7Cdist%7Cnode_modules)\\/(?%21neo.mjs) referencedExports: onStart";
...
class Canvas extends _Base_mjs__WEBPACK_IMPORTED_MODULE_1__["default"] {
    ...
    onRegisterNeoConfig(msg) {
        ...
        __webpack_require__("./. lazy recursive ^\\.\\/.*\\/canvas\\.mjs$ exclude: (?:\\/%7C\\\\)(buildScripts%7Cdist%7Cnode_modules)\\/(?%21neo.mjs) referencedExports: onStart")(`./${path}/canvas.mjs`).then(module => {
            module.onStart()
        })
    }
}
