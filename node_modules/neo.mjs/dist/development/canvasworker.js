...
/***/ "./. lazy recursive ^\\.\\/.*\\.mjs$ include: (?:apps%7Cexamples%7Csrc)\\/.*canvas\\/.*\\.mjs$ exclude: (?:\\/%7C\\\\)(buildScripts%7Cdist%7Cnode_modules(?:\\/%7C\\\\)(?%21neo\\.mjs)%7Cai(?:\\/%7C\\\\)%7C\\.claude(?:\\/%7C\\\\)%7Cserver\\.mjs%7Cdevindex(?:\\/%7C\\\\)services%7Ctest(?:\\/%7C\\\\))"
/*!****************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ././ lazy ^\.\/.*\.mjs$ include: (?:apps%7Cexamples%7Csrc)\/.*canvas\/.*\.mjs$ exclude: (?:\/%7C\\)(buildScripts%7Cdist%7Cnode_modules(?:\/%7C\\)(?%21neo\.mjs)%7Cai(?:\/%7C\\)%7C\.claude(?:\/%7C\\)%7Cserver\.mjs%7Cdevindex(?:\/%7C\\)services%7Ctest(?:\/%7C\\)) strict namespace object ***!
  \****************************************************************************************************************************************************************************************************************************************************************************************************/
...
const map = {
	"./apps/portal/canvas/FooterCanvas.mjs": [
		"./apps/portal/canvas/FooterCanvas.mjs",
		[
			"vendors-apps_portal_canvas_FooterCanvas_mjs"
		]
	],
	"./apps/portal/canvas/Helper.mjs": [
		"./apps/portal/canvas/Helper.mjs",
		[
			"apps_portal_canvas_Helper_mjs"
		]
	],
	"./apps/portal/canvas/HomeCanvas.mjs": [
		"./apps/portal/canvas/HomeCanvas.mjs",
		[
			"vendors-apps_portal_canvas_HomeCanvas_mjs"
		]
	],
	"./apps/portal/canvas/ServicesCanvas.mjs": [
		"./apps/portal/canvas/ServicesCanvas.mjs",
		[
			"vendors-apps_portal_canvas_ServicesCanvas_mjs"
		]
	],
	"./apps/portal/canvas/TimelineCanvas.mjs": [
		"./apps/portal/canvas/TimelineCanvas.mjs",
		[
			"vendors-apps_portal_canvas_TimelineCanvas_mjs"
		]
	],
	"./examples/component/canvas/MainContainer.mjs": [
		"./examples/component/canvas/MainContainer.mjs",
		[
			"vendors-examples_component_canvas_MainContainer_mjs"
		]
	],
	...
	"./examples/component/canvas/canvas.mjs": [
		"./examples/component/canvas/canvas.mjs",
		[
			"examples_component_canvas_canvas_mjs"
		]
	],
	"./src/canvas/Base.mjs": [
		"./src/canvas/Base.mjs",
	...
	"./src/canvas/Header.mjs": [
		"./src/canvas/Header.mjs",
		[
			"vendors-src_canvas_Header_mjs"
		]
	],
	"./src/canvas/Sparkline.mjs": [
		"./src/canvas/Sparkline.mjs",
		[
			"vendors-src_canvas_Sparkline_mjs"
		]
	],
...
webpackAsyncContext.id = "./. lazy recursive ^\\.\\/.*\\.mjs$ include: (?:apps%7Cexamples%7Csrc)\\/.*canvas\\/.*\\.mjs$ exclude: (?:\\/%7C\\\\)(buildScripts%7Cdist%7Cnode_modules(?:\\/%7C\\\\)(?%21neo\\.mjs)%7Cai(?:\\/%7C\\\\)%7C\\.claude(?:\\/%7C\\\\)%7Cserver\\.mjs%7Cdevindex(?:\\/%7C\\\\)services%7Ctest(?:\\/%7C\\\\))";
module.exports = webpackAsyncContext;

/***/ },

/***/ "./. lazy recursive ^\\.\\/.*\\/canvas\\.mjs$ include: (?:apps%7Cexamples%7Csrc)\\/.*canvas\\.mjs$ exclude: (?:\\/%7C\\\\)(buildScripts%7Cdist%7Cnode_modules(?:\\/%7C\\\\)(?%21neo\\.mjs)%7Cai(?:\\/%7C\\\\)%7C\\.claude(?:\\/%7C\\\\)%7Cserver\\.mjs%7Cdevindex(?:\\/%7C\\\\)services%7Ctest(?:\\/%7C\\\\)) referencedExports: onStart"
/*!***********************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ././ lazy ^\.\/.*\/canvas\.mjs$ include: (?:apps%7Cexamples%7Csrc)\/.*canvas\.mjs$ exclude: (?:\/%7C\\)(buildScripts%7Cdist%7Cnode_modules(?:\/%7C\\)(?%21neo\.mjs)%7Cai(?:\/%7C\\)%7C\.claude(?:\/%7C\\)%7Cserver\.mjs%7Cdevindex(?:\/%7C\\)services%7Ctest(?:\/%7C\\)) referencedExports: onStart strict namespace object ***!
  \***********************************************************************************************************************************************************************************************************************************************************************************************************************************/
(module, __unused_webpack_exports, __webpack_require__) {
...
webpackAsyncContext.keys = () => (Object.keys(map));
webpackAsyncContext.id = "./. lazy recursive ^\\.\\/.*\\/canvas\\.mjs$ include: (?:apps%7Cexamples%7Csrc)\\/.*canvas\\.mjs$ exclude: (?:\\/%7C\\\\)(buildScripts%7Cdist%7Cnode_modules(?:\\/%7C\\\\)(?%21neo\\.mjs)%7Cai(?:\\/%7C\\\\)%7C\\.claude(?:\\/%7C\\\\)%7Cserver\\.mjs%7Cdevindex(?:\\/%7C\\\\)services%7Ctest(?:\\/%7C\\\\)) referencedExports: onStart";
module.exports = webpackAsyncContext;
...
class Canvas extends _Base_mjs__WEBPACK_IMPORTED_MODULE_1__["default"] {
    ...
    async loadModule({path}) {
        ...
        try {
            await __webpack_require__("./. lazy recursive ^\\.\\/.*\\.mjs$ include: (?:apps%7Cexamples%7Csrc)\\/.*canvas\\/.*\\.mjs$ exclude: (?:\\/%7C\\\\)(buildScripts%7Cdist%7Cnode_modules(?:\\/%7C\\\\)(?%21neo\\.mjs)%7Cai(?:\\/%7C\\\\)%7C\\.claude(?:\\/%7C\\\\)%7Cserver\\.mjs%7Cdevindex(?:\\/%7C\\\\)services%7Ctest(?:\\/%7C\\\\))")(`./${path}.mjs`);
    ...
    onRegisterNeoConfig(msg) {
        ...
        if (_Neo_mjs__WEBPACK_IMPORTED_MODULE_0__["default"].config.useCanvasWorkerStartingPoint) {
            ...
            __webpack_require__("./. lazy recursive ^\\.\\/.*\\/canvas\\.mjs$ include: (?:apps%7Cexamples%7Csrc)\\/.*canvas\\.mjs$ exclude: (?:\\/%7C\\\\)(buildScripts%7Cdist%7Cnode_modules(?:\\/%7C\\\\)(?%21neo\\.mjs)%7Cai(?:\\/%7C\\\\)%7C\\.claude(?:\\/%7C\\\\)%7Cserver\\.mjs%7Cdevindex(?:\\/%7C\\\\)services%7Ctest(?:\\/%7C\\\\)) referencedExports: onStart")(`./${path}/canvas.mjs`).then(module => {
                module.onStart()
            })
        }
    }
