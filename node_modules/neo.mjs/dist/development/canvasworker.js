...
/***/ "./. lazy recursive ^\\.\\/.*\\/canvas\\.mjs$ exclude: (?:\\/%7C\\\\)(dist%7Cnode_modules)\\/(?%21neo.mjs) referencedExports: onStart"
/*!***************************************************************************************************************************************************!*\
  !*** ././ lazy ^\.\/.*\/canvas\.mjs$ exclude: (?:\/%7C\\)(dist%7Cnode_modules)\/(?%21neo.mjs) referencedExports: onStart strict namespace object ***!
  \***************************************************************************************************************************************************/
...
webpackAsyncContext.id = "./. lazy recursive ^\\.\\/.*\\/canvas\\.mjs$ exclude: (?:\\/%7C\\\\)(dist%7Cnode_modules)\\/(?%21neo.mjs) referencedExports: onStart";
...
class Canvas extends _Base_mjs__WEBPACK_IMPORTED_MODULE_1__["default"] {
    ...
    onRegisterNeoConfig(msg) {
        ...
        __webpack_require__("./. lazy recursive ^\\.\\/.*\\/canvas\\.mjs$ exclude: (?:\\/%7C\\\\)(dist%7Cnode_modules)\\/(?%21neo.mjs) referencedExports: onStart")(`./${path}/canvas.mjs`).then(module => {
            module.onStart()
        })
    }
}
