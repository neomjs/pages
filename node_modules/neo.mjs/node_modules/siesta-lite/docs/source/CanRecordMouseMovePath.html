...
*/
<span id='Siesta-Recorder-Role-CanRecordMouseMovePath'>/**
</span>@class Siesta.Recorder.Role.CanRecordMouseMovePath
...
Role(&#39;Siesta.Recorder.Role.CanRecordMouseMovePath&#39;, {
    ...
    has : {
<span id='Siesta-Recorder-Role-CanRecordMouseMovePath-cfg-recordMouseMovePath'>        /**
</span>         * @cfg {Boolean/String} recordMouseMovePath Set this option to `true` to enable recording of path, the user was 
