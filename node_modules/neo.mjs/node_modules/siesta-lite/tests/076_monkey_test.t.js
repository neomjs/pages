StartTest(function (t) {
    ...
    t.it('Monkey should avoid certain elements', function (t) {

        document.body.innerHTML =
            '<div style="position : absolute">' +
                '<p class="cls">ignore<p>yes, ignore</p><p>yes, ignore</p></p>' +
                '<p class="do_not_ignore">do not ignore</p>' +
                '<p class="another">ignore<p>yes, ignore</p></p>' +
            '</div>';
        ...
        t.chain(
            { monkeyTest : 'body > div', nbrInteractions : 20, skipTargets : [ '.cls', '.another' ] }
        )
    }, 90000);
