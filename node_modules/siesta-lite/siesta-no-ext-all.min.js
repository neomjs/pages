...
!0;return(new b(a,c)).c},create:function(b,c,d){if(!b)return(new c(b,d)).c;var e=this;if(/^\./.test(b))return this.executeIn(a.top,function(){return e.create(b.replace(/^\./,""),c,d)});for(var f=d||{},g=a.S.saneSplit(b,"."),r=this.getCurrent(),t=r==a.top?[]:a.S.saneSplit(r.meta.name,"."),v=0;v<g.length;v++){var z=g[v],x=v==g.length-1;if("meta"==z||"my"==z||!z)throw"Module name ["+b+"] may not include a part called 'meta' or 'my' or empty part.";var u=r[z];t.push(z);var A=t.join("."),B=!1;if("undefined"==
typeof u)x?(u=this.earlyCreate(A,c,f),B=!0):u=(new a.Namespace.Keeper(A)).c,r[z]=u;else if(x&&u&&u.meta)if(r=u.meta,c==a.Namespace.Keeper)r.extend(f);else if(r instanceof a.Namespace.Keeper)r.plant(this.earlyCreate(A,c,f)),B=!0;else{if(!a.C.ignoreRepeatedDeclarations)throw Error("Double declaration of ["+A+"]");}else if(x&&!(u&&u.meta&&u.meta.meta))throw"Trying to setup module "+A+" failed. There is already something: "+u;x&&this.prepareMeta(u.meta);B&&u.meta.construct(f);r=u}return r},prepareMeta:function(){},
...
"Please enable popups for the host with this test suite running: "+this.parentWindow.location.host;"v"!="\v"&&!this.parentWindow.msWriteProfilerMark||this.sourceURL||(b=this.getDocument(),b.open(),b.write(""),b.close());this.cachedOnError&&this.installOnErrorHandler(this.cachedOnError);var d=this,e=function(a,b){var c=!1,e=!0,m=a.document,n=m.documentElement,q=m.addEventListener?"addEventListener":"attachEvent",p=m.addEventListener?"removeEventListener":"detachEvent",r=m.addEventListener?"":"on",
t=function(e){if("readystatechange"!=e.type||"complete"==m.readyState)("load"==e.type?a:m)[p](r+e.type,t,!1),!c&&(c=!0)&&b.call(a,d)},v=function(){try{n.doScroll("left")}catch(a){setTimeout(v,50);return}t("poll")};if("complete"==m.readyState)b.call(a,d);else{if(m.createEventObject&&n.doScroll){try{e=!a.frameElement}catch(z){}e&&v()}m[q](r+"DOMContentLoaded",t,!1);m[q](r+"readystatechange",t,!1);a[q](r+"load",t,!1)}};this.sourceURL?setTimeout(function(){e(c,a||function(){})},10):e(c,a||function(){})},
...
(function(){function a(a){return 10>a?"0"+a:a}function b(a){e.lastIndex=0;return e.test(a)?'"'+a.replace(e,function(a){var b=k[a];return"string"===typeof b?b:"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)})+'"':'"'+a+'"'}function c(a,d){var e,k,r,t,v=f,z,x=d[a];x&&"object"===typeof x&&"function"===typeof x.toJSON&&(x=x.toJSON(a));"function"===typeof l&&(x=l.call(d,a,x));switch(typeof x){case "string":return b(x);case "number":return isFinite(x)?String(x):"null";case "boolean":case "null":return String(x);
case "object":if(!x)return"null";f+=g;z=[];if("[object Array]"===Object.prototype.toString.apply(x)){t=x.length;for(e=0;e<t;e+=1)z[e]=c(e,x)||"null";r=0===z.length?"[]":f?"[\n"+f+z.join(",\n"+f)+"\n"+v+"]":"["+z.join(",")+"]";f=v;return r}if(l&&"object"===typeof l)for(t=l.length,e=0;e<t;e+=1)"string"===typeof l[e]&&(k=l[e],(r=c(k,x))&&z.push(b(k)+(f?": ":":")+r));else for(k in x)Object.prototype.hasOwnProperty.call(x,k)&&(r=c(k,x))&&z.push(b(k)+(f?": ":":")+r);r=0===z.length?"{}":f?"{\n"+f+z.join(",\n"+
f)+"\n"+v+"}":"{"+z.join(",")+"}";f=v;return r}}"function"!==typeof Date.prototype.toJSON&&(Date.prototype.toJSON=function(b){return isFinite(this.valueOf())?this.getUTCFullYear()+"-"+a(this.getUTCMonth()+1)+"-"+a(this.getUTCDate())+"T"+a(this.getUTCHours())+":"+a(this.getUTCMinutes())+":"+a(this.getUTCSeconds())+"Z":null},String.prototype.toJSON=Number.prototype.toJSON=Boolean.prototype.toJSON=function(a){return this.valueOf()});var d=/[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,
...
b,c,d,e,f){a.completed=!0;b?this.suppressPassedWaitForAssertion||f?this.fireEvent("assertiondiscard",this,a):this.pass(c,d,a):(this.fail(c,d,a),e&&e())},waitFor:function(a,b,c,d,e){var f=Siesta.Resource("Siesta.Test.More"),g=" "+f.get("conditionToBeFulfilled"),k="waitFor",l=this,m=l.getSourceLine(),n=l.originalSetTimeout,q=l.originalClearTimeout,p,r;if(1===arguments.length&&"Object"==this.typeOf(a)){var t=a;a=t.method;b=t.callback;c=t.scope;d=t.timeout;e=t.interval;g=t.description||g;k=t.assertionName||
k;r=t.suppressAssertion;p=t.errback}else t={};var v="Number"==this.typeOf(a);b=b||function(){};var g=v?a+" "+f.get("ms"):g,z,x=l.startWaiting(f.get("waitingFor")+" "+g,m);e=e||this.waitForPollInterval;d=d||this.waitForTimeout;var u=this.beginAsync((v?a:d)+3*e,function(){A=!0;q(z);l.finalizeWaiting(x,!1,f.get("waitedTooLong")+": "+g,{assertionName:k,annotation:"Function"===l.typeOf(t.annotation)?t.annotation():f.get("conditionNotFulfilled")+" "+d+f.get("ms")},p,r);return!0}),A=!1;this.on("beforetestfinalize",
function(){A||(A=!0,l.finalizeWaiting(x,!1,f.get("waitingAborted"),null,null,r),l.endAsync(u),q(z))},null,{single:!0});if(v){if(0>a)throw Error("Cannot wait for a negative amount of time");z=n(function(){A=!0;l.finalizeWaiting(x,!0,f.get("Waited")+" "+a+" "+f.get("ms"),null,null,r||0===a);l.endAsync(u);l.processCallbackFromTest(b,[],c||l)},a)}else{var B,F=new Date,C=function(){var m=new Date-F;if(m>d)l.endAsync(u),l.finalizeWaiting(x,!1,f.get("waitedTooLong")+": "+g,{assertionName:k,annotation:"Function"===
l.typeOf(t.annotation)?t.annotation():f.get("conditionNotFulfilled")+" "+d+f.get("ms")},p,r),A=!0;else{try{B=a.call(c||l)}catch(q){l.endAsync(u);l.finalizeWaiting(x,!1,k+" "+f.get("checkerException"),{assertionName:k,got:q.toString(),gotDesc:f.get("Exception")},p,r);A=!0;return}null!=B&&!1!==B?(l.endAsync(u),A=!0,l.finalizeWaiting(x,!0,f.get("Waited")+" "+m+" "+f.get("msFor")+" "+g,"Function"===l.typeOf(t.annotation)?t.annotation():null,null,(r||0===m)&&!t.description),l.processCallbackFromTest(b,
[B],c||l)):z=n(C,e)}};C()}return{force:function(){A||(A=!0,q(z),l.endAsync(u),l.finalizeWaiting(x,!0,f.get("forcedWaitFinalization")+" "+g,null,null,r),l.processCallbackFromTest(b,[],c||l))}}},waitForMs:function(){return this.waitFor.apply(this,arguments)},waitForFn:function(){return this.waitFor.apply(this,arguments)},analyzeChainStep:function(a){a=a.toString();var b=!a.match(/^function/),c;return(c=b?a.match(/^\(/)?a.match(/\(\s*(.*?)\s*(?:,|\))/)[1]:a.match(/(.*?)\s*=>/)[1]:a.match(/function\s*[^(]*\(\s*(.*?)\s*(?:,|\))/)[1])?
...
return!0});return{next:function(){var x=arguments.callee;x.__CALLED__&&e.fail(b.get("calledMoreThanOnce",{num:c+1,line:k}));x.__CALLED__=!0;f||e.endAsync(g);l=Array.prototype.slice.call(arguments);a.desc&&e.pass(a.desc);d.next()},async:g}};if(a instanceof Siesta.Test)e.launchSubTest(a,g(!0).next);else if(e.typeOf(a).match(/^(Async)?Function$/)||e.typeOf(a.action).match(/^(Async)?Function$/)){var t=e.typeOf(a).match(/^(Async)?Function$/)?a:a.action,g=g(!1),v=f?function(){}:g.next;l.unshift(v);var z;
if(e.transparentEx)z=t.apply(e,l);else{var x=e.getExceptionCatcher()(function(){z=t.apply(e,l)});void 0!==x&&(f||e.endAsync(g.async),e.failWithException(x,b.get("chainStepEx")))}z||f||e.analyzeChainStep(t)||e.fail(b.get("stepFn")+" ["+t.toString()+"] "+b.get("notUsingNext"));z&&e.handleReturnedPromise(z,v,e.formatString("The promise returned from the chain step ["+e.stringifyChainStep(a)+"] did not resolve within {time}ms",{time:e.defaultTimeout}));f&&(e.endAsync(g.async),a.desc&&e.pass(a.desc))}else("String"==
...
[],g=b,k=g.hasOwnProperty("got"),l=g.hasOwnProperty("need"),m=g.gotDesc||"Got",n=g.needDesc||"Need",e=g.assertionName;b=g.annotation;g.ownTextOnly||!e&&!d||f.push("Failed assertion "+(e?"`"+e+"` ":"")+this.formatSourceLine(d));if(k&&l)var q=Math.max(m.length,n.length),m=this.appendSpaces(m,q-m.length+1),n=this.appendSpaces(n,q-n.length+1);k&&f.push(m+": "+Siesta.Util.Serializer.stringify(g.got));l&&f.push(n+": "+Siesta.Util.Serializer.stringify(g.need));b&&f.push(b);b=f.join("\n")}c&&(c.name=e,c.passed=
...
d=b.scope||this,e=b.shallow,f=b.checkParents||e,g=b.fullMatchingParents,k=b.onlyParents||g;if(k&&f)throw Error("Can't combine `onlyParents` and `checkParents` options");var l=this.idProp,m=this.parentNodeProp,n=this.childNodesProp,q=this.isLeaf,p=b.rootVisible,r={},t=function(a){r[a[l]]=!0;for(a=a[m];a&&!r[a[l]];)r[a[l]]=!0,a=a[m]},v=function(a,b){b(a);for(var c=a[n],d=c.length,e=0;e<d;e++)q(a)?b(a):v(c[e],b)};p&&(r[a[l]]=!0);var z=function(b){if(!b.hidden){var m,A,B;if(q(b))c.call(d,b,r)&&t(b);else if(k){if(m=
c.call(d,b))if(t(b),g){v(b,function(a){r[a[l]]=!0});return}b=b[n];A=b.length;for(B=0;B<A;B++)m&&q(b[B])?r[b[B][l]]=!0:q(b[B])||z(b[B])}else if(f&&(m=c.call(d,b,r))&&t(b),!f||!e||e&&(m||b==a&&!p))for(b=b[n],A=b.length,B=0;B<A;B++)z(b[B])}};z(a);return r}}});Role("Siesta.Util.Role.CanDetectES6",{has:{supportsArrowFunctions:function(){return this.canEvaluate("x => x")}},methods:{canEvaluate:function(a){try{return eval(a),!0}catch(b){return!1}}}});
...
k.stack?k.stack+"":d+" "+e+" "+f}))}},processURL:function(a,b,c,d,e,f,g){function k(){var b=Siesta.Resource("Siesta.Project");r.setup(function(g,k,r){l.onAfterScopePreload(g,m,v,k);k&&Joose.O.each(k,function(a,c){q.unshift({isException:!1,message:b.get("preloadHasFailed",{url:c})})});r&&q.push({isException:!0,message:b.get("crossOriginFailed",{url:g.sourceURL})});g.scope?l.launchTest({testHolder:n,desc:a,scopeProvider:g,contentManager:c,launchState:d,preloadErrors:q,onErrorHandler:p,onErrorHandlerBorrowing:t,
startTestAnchor:r?null:g.scope.StartTest,noCleanup:f,reusingSandbox:!1},e):e()})}var l=this,m=a.url;if(a.isMissing)e();else{delete d.notLaunchedByAutomationId[a.automationElementId];var n={},q=[],p=this.getOnErrorHandler(n,q),r=this.setupScope(a,d.launchId);b=this.getDescriptorConfig(a,"transparentEx");var t=r.addOnErrorHandler(p,!b);a.preset.eachResource(function(b){c.hasContentOf(b)&&l.canUseCachedContent(b,a)?l.addCachedResourceToPreloads(r,c,b,a):(b=b.asDescriptor(),b.url&&(b.url=l.resolveURL(b.url,
r,a)),r.addPreload(b))});l.prepareScopeSeeding(r,a,c);b=l.getDescriptorConfig(a,"testClass");"String"==l.typeOf(b)&&(b=Joose.S.strToClass(b));g=l.getNewTestConfiguration(a,r,c,d,g);var v=n.test=new b(g);this.onBeforeScopePreload(r,m,v);v.earlySetup(function(){k()},function(a){q.push({isException:!1,message:a});k()})}},launchTest:function(a,b){var c=a.scopeProvider,d=a.desc,e=this,f=d.url,g=a.testHolder,k=a.noCleanup,l=a.cleanupUrl,m=g.test;m.callback=function(){k||e.isKeepingResultForURL(f)||e.cleanupScopeForURL(l||
f);b&&b(g);g=null};if(c.crossOriginFailed)m.isFinished()||m.start(a.preloadErrors),m=a=null;else{var n=a.startTestAnchor,q=n&&n.args,p=c.scope;Joose.O.extend(m,{startTestAnchor:n,exceptionCatcher:n.exceptionCatcher,testErrorClass:n.testErrorClass,global:p,originalSetTimeout:a.originalSetTimeout||p.setTimeout,originalClearTimeout:a.originalClearTimeout||p.clearTimeout,run:q&&("function"==typeof q[0]?q[0]:q[1]),reusingSandbox:a.reusingSandbox});if(a.onErrorHandler){if(a.onErrorHandlerBorrowing)a.onErrorHandlerBorrowing();
...
"undefined"==typeof Promise&&function(a,b){"object"===typeof exports&&"undefined"!==typeof module?module.exports=b():"function"===typeof define&&define.amd?define(b):a.ES6Promise=b()}(this,function(){function a(){return function(){return process.nextTick(f)}}function b(){return"undefined"!==typeof pa?function(){pa(f)}:e()}function c(){var a=0,b=new U(f),c=document.createTextNode("");b.observe(c,{characterData:!0});return function(){c.data=a=++a%2}}function d(){var a=new MessageChannel;a.port1.onmessage=
f;return function(){return a.port2.postMessage(0)}}function e(){var a=setTimeout;return function(){return a(f,1)}}function f(){for(var a=0;a<O;a+=2)(0,J[a])(J[a+1]),J[a]=void 0,J[a+1]=void 0;O=0}function g(){try{var a=Function("return this")().require("vertx");pa=a.runOnLoop||a.runOnContext;return b()}catch(c){return e()}}function k(a,b){var c=this,d=new this.constructor(m);void 0===d[I]&&K(d);var e=c._state;if(e){var f=arguments[e-1];w(function(){return F(e,d,f,c._result)})}else A(c,d,a,b);return d}
function l(a){if(a&&"object"===typeof a&&a.constructor===this)return a;var b=new this(m);v(b,a);return b}function m(){}function n(a){try{return a.then}catch(b){return G.error=b,G}}function q(a,b,c,d){try{a.call(b,c,d)}catch(e){return e}}function p(a,b,c){w(function(a){var d=!1,e=q(c,b,function(c){d||(d=!0,b!==c?v(a,c):x(a,c))},function(b){d||(d=!0,u(a,b))},"Settle: "+(a._label||" unknown promise"));!d&&e&&(d=!0,u(a,e))},a)}function r(a,b){b._state===V?x(a,b._result):b._state===Q?u(a,b._result):A(b,
void 0,function(b){return v(a,b)},function(b){return u(a,b)})}function t(a,b,c){b.constructor===a.constructor&&c===k&&b.constructor.resolve===l?r(a,b):c===G?(u(a,G.error),G.error=null):void 0===c?x(a,b):"function"===typeof c?p(a,b,c):x(a,b)}function v(a,b){if(a===b)u(a,new TypeError("You cannot resolve a promise with itself"));else{var c=typeof b;null===b||"object"!==c&&"function"!==c?x(a,b):t(a,b,n(b))}}function z(a){a._onerror&&a._onerror(a._result);B(a)}function x(a,b){a._state===R&&(a._result=
b,a._state=V,0!==a._subscribers.length&&w(B,a))}function u(a,b){a._state===R&&(a._state=Q,a._result=b,w(z,a))}function A(a,b,c,d){var e=a._subscribers,f=e.length;a._onerror=null;e[f]=b;e[f+V]=c;e[f+Q]=d;0===f&&a._state&&w(B,a)}function B(a){var b=a._subscribers,c=a._state;if(0!==b.length){for(var d,e,f=a._result,g=0;g<b.length;g+=3)d=b[g],e=b[g+c],d?F(c,d,e,f):e(f);a._subscribers.length=0}}function F(a,b,c,d){var e="function"===typeof c,f,g=void 0,h=void 0,k=void 0;if(e){try{f=c(d)}catch(l){G.error=
l,f=G}f===G?(k=!0,g=f.error,f.error=null):h=!0;if(b===f){u(b,new TypeError("A promises callback cannot return that same promise."));return}}else f=d,h=!0;b._state===R&&(e&&h?v(b,f):k?u(b,g):a===V?x(b,f):a===Q&&u(b,f))}function C(a,b){try{b(function(b){v(a,b)},function(b){u(a,b)})}catch(c){u(a,c)}}function K(a){a[I]=P++;a._state=void 0;a._result=void 0;a._subscribers=[]}var ba=void 0,da=ba=Array.isArray?Array.isArray:function(a){return"[object Array]"===Object.prototype.toString.call(a)},O=0,pa=void 0,
ea=void 0,w=function(a,b){J[O]=a;J[O+1]=b;O+=2;2===O&&(ea?ea(f):M())},W=(ba="undefined"!==typeof window?window:void 0)||{},U=W.MutationObserver||W.WebKitMutationObserver,W="undefined"===typeof self&&"undefined"!==typeof process&&"[object process]"==={}.toString.call(process),h="undefined"!==typeof Uint8ClampedArray&&"undefined"!==typeof importScripts&&"undefined"!==typeof MessageChannel,J=Array(1E3),M=void 0,M=W?a():U?c():h?d():void 0===ba&&"function"===typeof require?g():e(),I=Math.random().toString(36).substring(2),
R=void 0,V=1,Q=2,G={error:null},P=0,X=function(){function a(b,c){this._instanceConstructor=b;this.promise=new b(m);this.promise[I]||K(this.promise);da(c)?(this._remaining=this.length=c.length,this._result=Array(this.length),0===this.length?x(this.promise,this._result):(this.length=this.length||0,this._enumerate(c),0===this._remaining&&x(this.promise,this._result))):u(this.promise,Error("Array Methods must be provided an Array"))}a.prototype._enumerate=function(a){for(var b=0;this._state===R&&b<a.length;b++)this._eachEntry(a[b],
b)};a.prototype._eachEntry=function(a,b){var c=this._instanceConstructor,d=c.resolve;d===l?(d=n(a),d===k&&a._state!==R?this._settledAt(a._state,b,a._result):"function"!==typeof d?(this._remaining--,this._result[b]=a):c===L?(c=new c(m),t(c,a,d),this._willSettleAt(c,b)):this._willSettleAt(new c(function(b){return b(a)}),b)):this._willSettleAt(d(a),b)};a.prototype._settledAt=function(a,b,c){var d=this.promise;d._state===R&&(this._remaining--,a===Q?u(d,c):this._result[b]=c);0===this._remaining&&x(d,this._result)};
a.prototype._willSettleAt=function(a,b){var c=this;A(a,void 0,function(a){return c._settledAt(V,b,a)},function(a){return c._settledAt(Q,b,a)})};return a}(),L=function(){function a(b){this[I]=P++;this._result=this._state=void 0;this._subscribers=[];if(m!==b){if("function"!==typeof b)throw new TypeError("You must pass a resolver function as the first argument to the promise constructor");if(this instanceof a)C(this,b);else throw new TypeError("Failed to construct 'Promise': Please use the 'new' operator, this object constructor cannot be called as a function.");
}}a.prototype["catch"]=function(a){return this.then(null,a)};a.prototype["finally"]=function(a){var b=this.constructor;return this.then(function(c){return b.resolve(a()).then(function(){return c})},function(c){return b.resolve(a()).then(function(){throw c;})})};return a}();L.prototype.then=k;L.all=function(a){return(new X(this,a)).promise};L.race=function(a){var b=this;return da(a)?new b(function(c,d){for(var e=a.length,f=0;f<e;f++)b.resolve(a[f]).then(c,d)}):new b(function(a,b){return b(new TypeError("You must pass an array to race."))})};
L.resolve=l;L.reject=function(a){var b=new this(m);u(b,a);return b};L._setScheduler=function(a){ea=a};L._setAsap=function(a){w=a};L._asap=w;L.polyfill=function(){var a=void 0;if("undefined"!==typeof global)a=global;else if("undefined"!==typeof self)a=self;else try{a=Function("return this")()}catch(b){throw Error("polyfill failed because global object is unavailable in this environment");}var c=a.Promise;if(c){var d=null;try{d=Object.prototype.toString.call(c.resolve())}catch(b){}if("[object Promise]"===
d&&!c.cast)return}a.Promise=L};L.Promise=L;L.polyfill();return L});
!function(a,b,c){("undefined"!=typeof window?window:a)[b]=c()}(this,"bowser",function(){function a(a){function b(c){return(c=a.match(c))&&1<c.length&&c[1]||""}function c(b){return(b=a.match(b))&&1<b.length&&b[2]||""}var d=b(/(ipod|iphone|ipad)/i).toLowerCase(),e=!/like android/i.test(a)&&/android/i.test(a),n=/nexus\s*[0-6]\s*/i.test(a),q=!n&&/nexus\s*[0-9]+/i.test(a),p=/CrOS/.test(a),r=/silk/i.test(a),t=/sailfish/i.test(a),v=/tizen/i.test(a),z=/(web|hpw)os/i.test(a),x=/windows phone/i.test(a);/SamsungBrowser/i.test(a);
var u=!x&&/windows/i.test(a),A=!d&&!r&&/macintosh/i.test(a),B=!e&&!t&&!v&&!z&&/linux/i.test(a),F=b(/edge\/(\d+(\.\d+)?)/i),C=b(/version\/(\d+(\.\d+)?)/i),K=/tablet/i.test(a),ba=!K&&/[^-]mobi/i.test(a),da=/xbox/i.test(a);/opera/i.test(a)?p={name:"Opera",opera:!0,version:C||b(/(?:opera|opr|opios)[\s\/](\d+(\.\d+)?)/i)}:/opr|opios/i.test(a)?p={name:"Opera",opera:!0,version:b(/(?:opr|opios)[\s\/](\d+(\.\d+)?)/i)||C}:/SamsungBrowser/i.test(a)?p={name:"Samsung Internet for Android",samsungBrowser:!0,version:C||
...
version:b(/(?:epiphany)[\s\/](\d+(?:\.\d+)+)/i)}:/puffin/i.test(a)?p={name:"Puffin",puffin:!0,version:b(/(?:puffin)[\s\/](\d+(?:\.\d+)?)/i)}:/sleipnir/i.test(a)?p={name:"Sleipnir",sleipnir:!0,version:b(/(?:sleipnir)[\s\/](\d+(?:\.\d+)+)/i)}:/k-meleon/i.test(a)?p={name:"K-Meleon",kMeleon:!0,version:b(/(?:k-meleon)[\s\/](\d+(?:\.\d+)+)/i)}:x?(p={name:"Windows Phone",windowsphone:!0},F?(p.msedge=!0,p.version=F):(p.msie=!0,p.version=b(/iemobile\/(\d+(\.\d+)?)/i))):/msie|trident/i.test(a)?p={name:"Internet Explorer",
...
(p={name:"Firefox",firefox:!0,version:b(/(?:firefox|iceweasel|fxios)[ \/](\d+(\.\d+)?)/i)},/\((mobile|tablet);[^\)]*rv:[\d\.]+\)/i.test(a)&&(p.firefoxos=!0)):r?p={name:"Amazon Silk",silk:!0,version:b(/silk\/(\d+(\.\d+)?)/i)}:/phantom/i.test(a)?p={name:"PhantomJS",phantom:!0,version:b(/phantomjs\/(\d+(\.\d+)?)/i)}:/slimerjs/i.test(a)?p={name:"SlimerJS",slimer:!0,version:b(/slimerjs\/(\d+(\.\d+)?)/i)}:/blackberry|\bbb\d+/i.test(a)||/rim\stablet/i.test(a)?p={name:"BlackBerry",blackberry:!0,version:C||
...
(p.name=p.name||"Blink",p.blink=!0):(p.name=p.name||"Webkit",p.webkit=!0),!p.version&&C&&(p.version=C)):!p.opera&&/gecko\//i.test(a)&&(p.name=p.name||"Gecko",p.gecko=!0,p.version=p.version||b(/gecko\/(\d+(\.\d+)?)/i));p.windowsphone||p.msedge||!e&&!p.silk?p.windowsphone||p.msedge||!d?A?p.mac=!0:da?p.xbox=!0:u?p.windows=!0:B&&(p.linux=!0):(p[d]=!0,p.ios=!0):p.android=!0;u="";p.windowsphone?u=b(/windows phone (?:os)?\s?(\d+(\.\d+)*)/i):d?(u=b(/os (\d+([_\s]\d+)*) like mac os x/i),u=u.replace(/[_\s]/g,
".")):e?u=b(/android[ \/-](\d+(\.\d+)*)/i):p.webos?u=b(/(?:web|hpw)os\/(\d+(\.\d+)*)/i):p.blackberry?u=b(/rim\stablet\sos\s(\d+(\.\d+)*)/i):p.bada?u=b(/bada\/(\d+(\.\d+)*)/i):p.tizen&&(u=b(/tizen[\/\s](\d+(\.\d+)*)/i));u&&(p.osversion=u);u=u.split(".")[0];if(K||q||"ipad"==d||e&&(3==u||4<=u&&!ba)||p.silk)p.tablet=!0;else if(ba||"iphone"==d||"ipod"==d||e||n||p.blackberry||p.webos||p.bada)p.mobile=!0;p.msedge||p.msie&&10<=p.version||p.yandexbrowser&&15<=p.version||p.vivaldi&&1<=p.version||p.chrome&&
...
f,b,!0)||h.data(a,g,b,!0)||(h.removeData(a,e,!0),k.resolve())},0)}function f(){return!1}function g(){return!0}function k(a,c,d){var e=h.extend({},d[0]);e.type=a;e.originalEvent={};e.liveFired=b;h.event.handle.call(c,e);e.isDefaultPrevented()&&d[0].preventDefault()}function l(a){var b,c,d,e,f,g,k,l,m,y,n,E=[];e=[];f=h._data(this,"events");if(a.liveFired!==this&&f&&f.live&&!a.target.disabled&&(!a.button||"click"!==a.type)){a.namespace&&(n=new RegExp("(^|\\.)"+a.namespace.split(".").join("\\.(?:.*\\.)?")+
"(\\.|$)"));a.liveFired=this;var p=f.live.slice(0);for(k=0;k<p.length;k++)f=p[k],f.origType.replace(Ea,"")===a.type?e.push(f.selector):p.splice(k--,1);e=h(a.target).closest(e,a.currentTarget);l=0;for(m=e.length;l<m;l++)for(y=e[l],k=0;k<p.length;k++)if(f=p[k],y.selector===f.selector&&(!n||n.test(f.namespace))&&!y.elem.disabled){g=y.elem;d=null;if("mouseenter"===f.preType||"mouseleave"===f.preType)a.type=f.preType,(d=h(a.relatedTarget).closest(f.selector)[0])&&h.contains(g,d)&&(d=g);d&&d===g||E.push({elem:g,
handleObj:f,level:y.level})}l=0;for(m=E.length;l<m;l++){e=E[l];if(c&&e.level>c)break;a.currentTarget=e.elem;a.data=e.handleObj.data;a.handleObj=e.handleObj;n=e.handleObj.origHandler.apply(e.elem,arguments);if(!1===n||a.isPropagationStopped())if(c=e.level,!1===n&&(b=!1),a.isImmediatePropagationStopped())break}return b}}function m(a,b){return(a&&"*"!==a?a+".":"")+b.replace(Va,"`").replace(Wa,"&")}function n(a){return!a||!a.parentNode||11===a.parentNode.nodeType}function q(a,b,c){b=b||0;if(h.isFunction(b))return h.grep(a,
function(a,d){return!!b.call(a,d,a)===c});if(b.nodeType)return h.grep(a,function(a,d){return a===b===c});if("string"===typeof b){var d=h.grep(a,function(a){return 1===a.nodeType});if(Xa.test(b))return h.filter(b,d,!c);b=h.filter(b,d)}return h.grep(a,function(a,d){return 0<=h.inArray(a,b)===c})}function p(a,b){return h.nodeName(a,"table")?a.getElementsByTagName("tbody")[0]||a.appendChild(a.ownerDocument.createElement("tbody")):a}function r(a,b){if(1===b.nodeType&&h.hasData(a)){var c=h.expando,d=h.data(a),
...
b.checked=a.checked),b.value!==a.value&&(b.value=a.value);else if("option"===c)b.selected=a.defaultSelected;else if("input"===c||"textarea"===c)b.defaultValue=a.defaultValue;b.removeAttribute(h.expando)}}function v(a){return"getElementsByTagName"in a?a.getElementsByTagName("*"):"querySelectorAll"in a?a.querySelectorAll("*"):[]}function z(a){if("checkbox"===a.type||"radio"===a.type)a.defaultChecked=a.checked}function x(a){h.nodeName(a,"input")?z(a):"getElementsByTagName"in a&&h.grep(a.getElementsByTagName("input"),
z)}function u(a,b){b.src?h.ajax({url:b.src,async:!1,dataType:"script"}):h.globalEval((b.text||b.textContent||b.innerHTML||"").replace(H,"/*$0*/"));b.parentNode&&b.parentNode.removeChild(b)}function A(a,b,c){var d="width"===b?a.offsetWidth:a.offsetHeight,e="width"===b?qa:Ya;if(0<d)return"border"!==c&&h.each(e,function(){c||(d-=parseFloat(h.css(a,"padding"+this))||0);d="margin"===c?d+(parseFloat(h.css(a,c+this))||0):d-(parseFloat(h.css(a,"border"+this+"Width"))||0)}),d+"px";d=Z(a,b,b);if(0>d||null==
d)d=a.style[b]||0;d=parseFloat(d)||0;c&&h.each(e,function(){d+=parseFloat(h.css(a,"padding"+this))||0;"padding"!==c&&(d+=parseFloat(h.css(a,"border"+this+"Width"))||0);"margin"===c&&(d+=parseFloat(h.css(a,c+this))||0)});return d+"px"}function B(a){return function(b,c){"string"!==typeof b&&(c=b,b="*");if(h.isFunction(c))for(var d=b.toLowerCase().split(gb),e=0,f=d.length,g,k;e<f;e++)g=d[e],(k=/^\+/.test(g))&&(g=g.substr(1)||"*"),g=a[g]=a[g]||[],g[k?"unshift":"push"](c)}}function F(a,c,d,e,f,g){f=f||
c.dataTypes[0];g=g||{};g[f]=!0;f=a[f];for(var h=0,k=f?f.length:0,l=a===Za,m;h<k&&(l||!m);h++)m=f[h](c,d,e),"string"===typeof m&&(!l||g[m]?m=b:(c.dataTypes.unshift(m),m=F(a,c,d,e,m,g)));!l&&m||g["*"]||(m=F(a,c,d,e,"*",g));return m}function C(a,b,c,d){if(h.isArray(b))h.each(b,function(b,e){c||rb.test(a)?d(a,e):C(a+"["+("object"===typeof e||h.isArray(e)?b:"")+"]",e,c,d)});else if(c||null==b||"object"!==typeof b)d(a,b);else for(var e in b)C(a+"["+e+"]",b[e],c,d)}function K(){try{return new a.XMLHttpRequest}catch(b){}}
function ba(){setTimeout(da,0);return La=h.now()}function da(){La=b}function O(a,b){var c={};h.each(hb.concat.apply([],hb.slice(0,b)),function(){c[this]=a});return c}function pa(a){if(!$a[a]){var b=w.body,c=h("<"+a+">").appendTo(b),d=c.css("display");c.remove();if("none"===d||""===d)ka||(ka=w.createElement("iframe"),ka.frameBorder=ka.width=ka.height=0),b.appendChild(ka),ya&&ka.createElement||(ya=(ka.contentWindow||ka.contentDocument).document,ya.write(("CSS1Compat"===w.compatMode?"<!doctype html>":
"")+"<html><body>"),ya.close()),c=ya.createElement(a),ya.body.appendChild(c),d=h.css(c,"display"),b.removeChild(ka);$a[a]=d}return $a[a]}function ea(a){return h.isWindow(a)?a:9===a.nodeType?a.defaultView||a.parentWindow:!1}var w=a.document,W=a.navigator,U=a.location,h=function(){function c(){if(!d.isReady){try{w.documentElement.doScroll("left")}catch(a){setTimeout(c,1);return}d.ready()}}var d=function(a,b){return new d.fn.init(a,b,g)},e=a.jQuery,f=a.$,g,h=/^(?:[^<]*(<[\w\W]+>)[^>]*$|#([\w\-]*)$)/,
k=/\S/,l=/^\s+/,m=/\s+$/,y=/\d/,n=/^<(\w+)\s*\/?>(?:<\/\1>)?$/,E=/^[\],:{}\s]*$/,p=/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,H=/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,u=/(?:^|:|,)(?:\s*\[)+/g,r=/(webkit)[ \/]([\w.]+)/,x=/(opera)(?:.*version)?[ \/]([\w.]+)/,q=/(msie) ([\w.]+)/,ib=/(mozilla)(?:.*? rv:([\w.]+))?/,sb=/-([a-z])/ig,tb=function(a,b){return b.toUpperCase()},ga=W.userAgent,Ma,Na,t,A=Object.prototype.toString,N=Object.prototype.hasOwnProperty,v=Array.prototype.push,B=
Array.prototype.slice,ta=String.prototype.trim,ra=Array.prototype.indexOf,oa={};d.fn=d.prototype={constructor:d,init:function(a,c,e){var f;if(!a)return this;if(a.nodeType)return this.context=this[0]=a,this.length=1,this;if("body"===a&&!c&&w.body)return this.context=w,this[0]=w.body,this.selector=a,this.length=1,this;if("string"===typeof a){f="<"===a.charAt(0)&&">"===a.charAt(a.length-1)&&3<=a.length?[null,a,null]:h.exec(a);if(!f||!f[1]&&c)return!c||c.jquery?(c||e).find(a):this.constructor(c).find(a);
if(f[1])return e=(c=c instanceof d?c[0]:c)?c.ownerDocument||c:w,(a=n.exec(a))?d.isPlainObject(c)?(a=[w.createElement(a[1])],d.fn.attr.call(a,c,!0)):a=[e.createElement(a[1])]:(a=d.buildFragment([f[1]],[e]),a=(a.cacheable?d.clone(a.fragment):a.fragment).childNodes),d.merge(this,a);if((c=w.getElementById(f[2]))&&c.parentNode){if(c.id!==f[2])return e.find(a);this.length=1;this[0]=c}this.context=w;this.selector=a;return this}if(d.isFunction(a))return e.ready(a);a.selector!==b&&(this.selector=a.selector,
...
b){return d.each(this,a,b)},ready:function(a){d.bindReady();Na.done(a);return this},eq:function(a){return-1===a?this.slice(a):this.slice(a,+a+1)},first:function(){return this.eq(0)},last:function(){return this.eq(-1)},slice:function(){return this.pushStack(B.apply(this,arguments),"slice",B.call(arguments).join(","))},map:function(a){return this.pushStack(d.map(this,function(b,c){return a.call(b,c,b)}))},end:function(){return this.prevObject||this.constructor(null)},push:v,sort:[].sort,splice:[].splice};
d.fn.init.prototype=d.fn;d.extend=d.fn.extend=function(){var a,c,e,f,D,g=arguments[0]||{},h=1,k=arguments.length,Y=!1;"boolean"===typeof g&&(Y=g,g=arguments[1]||{},h=2);"object"===typeof g||d.isFunction(g)||(g={});k===h&&(g=this,--h);for(;h<k;h++)if(null!=(a=arguments[h]))for(c in a)e=g[c],f=a[c],g!==f&&(Y&&f&&(d.isPlainObject(f)||(D=d.isArray(f)))?(D?(D=!1,e=e&&d.isArray(e)?e:[]):e=e&&d.isPlainObject(e)?e:{},g[c]=d.extend(Y,e,f)):f!==b&&(g[c]=f));return g};d.extend({noConflict:function(b){a.$===
d&&(a.$=f);b&&a.jQuery===d&&(a.jQuery=e);return d},isReady:!1,readyWait:1,holdReady:function(a){a?d.readyWait++:d.ready(!0)},ready:function(a){if(!0===a&&!--d.readyWait||!0!==a&&!d.isReady){if(!w.body)return setTimeout(d.ready,1);d.isReady=!0;!0!==a&&0<--d.readyWait||(Na.resolveWith(w,[d]),d.fn.trigger&&d(w).trigger("ready").unbind("ready"))}},bindReady:function(){if(!Na){Na=d._Deferred();if("complete"===w.readyState)return setTimeout(d.ready,1);if(w.addEventListener)w.addEventListener("DOMContentLoaded",
t,!1),a.addEventListener("load",d.ready,!1);else if(w.attachEvent){w.attachEvent("onreadystatechange",t);a.attachEvent("onload",d.ready);var b=!1;try{b=null==a.frameElement}catch(e){}w.documentElement.doScroll&&b&&c()}}},isFunction:function(a){return"function"===d.type(a)},isArray:Array.isArray||function(a){return"array"===d.type(a)},isWindow:function(a){return a&&"object"===typeof a&&"setInterval"in a},isNaN:function(a){return null==a||!y.test(a)||isNaN(a)},type:function(a){return null==a?String(a):
oa[A.call(a)]||"object"},isPlainObject:function(a){if(!a||"object"!==d.type(a)||a.nodeType||d.isWindow(a)||a.constructor&&!N.call(a,"constructor")&&!N.call(a.constructor.prototype,"isPrototypeOf"))return!1;for(var c in a);return c===b||N.call(a,c)},isEmptyObject:function(a){for(var b in a)return!1;return!0},error:function(a){throw a;},parseJSON:function(b){if("string"!==typeof b||!b)return null;b=d.trim(b);if(a.JSON&&a.JSON.parse)return a.JSON.parse(b);if(E.test(b.replace(p,"@").replace(H,"]").replace(u,
"")))return(new Function("return "+b))();d.error("Invalid JSON: "+b)},parseXML:function(b,c,e){a.DOMParser?(e=new DOMParser,c=e.parseFromString(b,"text/xml")):(c=new ActiveXObject("Microsoft.XMLDOM"),c.async="false",c.loadXML(b));(e=c.documentElement)&&e.nodeName&&"parsererror"!==e.nodeName||d.error("Invalid XML: "+b);return c},noop:function(){},globalEval:function(b){b&&k.test(b)&&(a.execScript||function(b){a.eval.call(a,b)})(b)},camelCase:function(a){return a.replace(sb,tb)},nodeName:function(a,
b){return a.nodeName&&a.nodeName.toUpperCase()===b.toUpperCase()},each:function(a,c,e){var f,D=0,g=a.length,h=g===b||d.isFunction(a);if(e)if(h)for(f in a){if(!1===c.apply(a[f],e))break}else for(;D<g&&!1!==c.apply(a[D++],e););else if(h)for(f in a){if(!1===c.call(a[f],f,a[f]))break}else for(;D<g&&!1!==c.call(a[D],D,a[D++]););return a},trim:ta?function(a){return null==a?"":ta.call(a)}:function(a){return null==a?"":a.toString().replace(l,"").replace(m,"")},makeArray:function(a,b){var c=b||[];if(null!=
a){var e=d.type(a);null==a.length||"string"===e||"function"===e||"regexp"===e||d.isWindow(a)?v.call(c,a):d.merge(c,a)}return c},inArray:function(a,b){if(ra)return ra.call(b,a);for(var c=0,d=b.length;c<d;c++)if(b[c]===a)return c;return-1},merge:function(a,c){var d=a.length,e=0;if("number"===typeof c.length)for(var f=c.length;e<f;e++)a[d++]=c[e];else for(;c[e]!==b;)a[d++]=c[e++];a.length=d;return a},grep:function(a,b,c){var d=[],e;c=!!c;for(var f=0,D=a.length;f<D;f++)e=!!b(a[f],f),c!==e&&d.push(a[f]);
...
g.reject):--f;f||g.resolveWith(g,c)}else g!==a&&g.resolveWith(g,e?[a]:[]);return g.promise()}});h.support=function(){var a=w.createElement("div"),b=w.documentElement,c,d,e,f,g,k;a.setAttribute("className","t");a.innerHTML="   <link/><table></table><a href='/a' style='top:1px;float:left;opacity:.55;'>a</a><input type='checkbox'/>";c=a.getElementsByTagName("*");d=a.getElementsByTagName("a")[0];if(!c||!c.length||!d)return{};e=w.createElement("select");f=e.appendChild(w.createElement("option"));c=a.getElementsByTagName("input")[0];
...
this;setTimeout(function(){h.dequeue(c,b)},a)})},clearQueue:function(a){return this.queue(a||"fx",[])},promise:function(a,c){function d(){--k||e.resolveWith(f,[f])}"string"!==typeof a&&(a=b);a=a||"fx";for(var e=h.Deferred(),f=this,g=f.length,k=1,l=a+"defer",m=a+"queue",y=a+"mark",n;g--;)if(n=h.data(f[g],l,b,!0)||(h.data(f[g],m,b,!0)||h.data(f[g],y,b,!0))&&h.data(f[g],l,h._Deferred(),!0))k++,n.done(d);d();return e.promise()}});var V=/[\n\t\r]/g,Q=/\s+/,G=/\r/g,P=/^(?:button|input)$/i,X=/^(?:button|input|object|select|textarea)$/i,
L=/^a(?:rea)?$/i,Da=/^(?:autofocus|autoplay|async|checked|controls|defer|disabled|hidden|loop|multiple|open|readonly|required|scoped|selected)$/i,Ja=/\:|^on/,ca,xa;h.fn.extend({attr:function(a,b){return h.access(this,a,b,!0,h.attr)},removeAttr:function(a){return this.each(function(){h.removeAttr(this,a)})},prop:function(a,b){return h.access(this,a,b,!0,h.prop)},removeProp:function(a){a=h.propFix[a]||a;return this.each(function(){try{this[a]=b,delete this[a]}catch(c){}})},addClass:function(a){var b,
...
a.parentNode&&a.parentNode.selectedIndex}}));h.support.checkOn||h.each(["radio","checkbox"],function(){h.valHooks[this]={get:function(a){return null===a.getAttribute("value")?"on":a.value}}});h.each(["radio","checkbox"],function(){h.valHooks[this]=h.extend(h.valHooks[this],{set:function(a,b){if(h.isArray(b))return a.checked=0<=h.inArray(h(a).val(),b)}})});var Ea=/\.(.*)$/,ha=/^(?:textarea|input|select)$/i,Va=/\./g,Wa=/ /g,ja=/[^\w\s.|`]/g,Ka=function(a){return a.replace(ja,"\\$&")};h.event={add:function(a,
c,d,e){if(3!==a.nodeType&&8!==a.nodeType){if(!1===d)d=f;else if(!d)return;var g,k;d.handler&&(g=d,d=g.handler);d.guid||(d.guid=h.guid++);if(k=h._data(a)){var l=k.events,m=k.handle;l||(k.events=l={});m||(k.handle=m=function(a){return"undefined"===typeof h||a&&h.event.triggered===a.type?b:h.event.handle.apply(m.elem,arguments)});m.elem=a;c=c.split(" ");for(var y,n=0,E;y=c[n++];){k=g?h.extend({},g):{handler:d,data:e};-1<y.indexOf(".")?(E=y.split("."),y=E.shift(),k.namespace=E.slice(0).sort().join(".")):
(E=[],k.namespace="");k.type=y;k.guid||(k.guid=d.guid);var p=l[y],H=h.event.special[y]||{};p||(p=l[y]=[],H.setup&&!1!==H.setup.call(a,e,E,m)||(a.addEventListener?a.addEventListener(y,m,!1):a.attachEvent&&a.attachEvent("on"+y,m)));H.add&&(H.add.call(a,k),k.handler.guid||(k.handler.guid=d.guid));p.push(k);h.event.global[y]=!0}a=null}}},global:{},remove:function(a,c,d,e){if(3!==a.nodeType&&8!==a.nodeType){!1===d&&(d=f);var g,k,l=0,m,y,n,E,p,H,u=h.hasData(a)&&h._data(a),r=u&&u.events;if(u&&r)if(c&&c.type&&
(d=c.handler,c=c.type),!c||"string"===typeof c&&"."===c.charAt(0))for(g in c=c||"",r)h.event.remove(a,g+c);else{for(c=c.split(" ");g=c[l++];)if(E=g,m=0>g.indexOf("."),y=[],m||(y=g.split("."),g=y.shift(),n=new RegExp("(^|\\.)"+h.map(y.slice(0).sort(),Ka).join("\\.(?:.*\\.)?")+"(\\.|$)")),p=r[g])if(d){E=h.event.special[g]||{};for(k=e||0;k<p.length;k++)if(H=p[k],d.guid===H.guid){if(m||n.test(H.namespace))null==e&&p.splice(k--,1),E.remove&&E.remove.call(a,H);if(null!=e)break}if(0===p.length||null!=e&&
1===p.length)E.teardown&&!1!==E.teardown.call(a,y)||h.removeEvent(a,g,u.handle),delete r[g]}else for(k=0;k<p.length;k++)if(H=p[k],m||n.test(H.namespace))h.event.remove(a,E,H.handler,k),p.splice(k--,1);if(h.isEmptyObject(r)){if(c=u.handle)c.elem=null;delete u.events;delete u.handle;h.isEmptyObject(u)&&h.removeData(a,b,!0)}}}},customEvent:{getData:!0,setData:!0,changeData:!0},trigger:function(c,d,e,f){var g=c.type||c,k=[],l;0<=g.indexOf("!")&&(g=g.slice(0,-1),l=!0);0<=g.indexOf(".")&&(k=g.split("."),
...
g,e[g]())}catch(y){}m&&(e[f]=m);h.event.triggered=b}}return c.result}}},handle:function(c){c=h.event.fix(c||a.event);var d=((h._data(this,"events")||{})[c.type]||[]).slice(0),e=!c.exclusive&&!c.namespace,f=Array.prototype.slice.call(arguments,0);f[0]=c;c.currentTarget=this;for(var g=0,k=d.length;g<k;g++){var l=d[g];if(e||c.namespace_re.test(l.namespace))if(c.handler=l.handler,c.data=l.data,c.handleObj=l,l=l.handler.apply(this,f),l!==b&&(c.result=l,!1===l&&(c.preventDefault(),c.stopPropagation())),
...
isImmediatePropagationStopped:f};var la=function(a){var b=a.relatedTarget,c=!1,d=a.type;a.type=a.data;b!==this&&(b&&(c=h.contains(this,b)),c||(h.event.handle.apply(this,arguments),a.type=d))},Oa=function(a){a.type=a.data;h.event.handle.apply(this,arguments)};h.each({mouseenter:"mouseover",mouseleave:"mouseout"},function(a,b){h.event.special[a]={setup:function(c){h.event.add(this,b,c&&c.selector?Oa:la,a)},teardown:function(a){h.event.remove(this,b,a&&a.selector?Oa:la)}}});h.support.submitBubbles||
...
Pa=function(a){var b=a.type,c=a.value;"radio"===b||"checkbox"===b?c=a.checked:"select-multiple"===b?c=-1<a.selectedIndex?h.map(a.options,function(a){return a.selected}).join("-"):"":h.nodeName(a,"select")&&(c=a.selectedIndex);return c},za=function(a,c){var d=a.target,e,f;ha.test(d.nodeName)&&!d.readOnly&&(e=h._data(d,"_change_data"),f=Pa(d),"focusout"===a.type&&"radio"===d.type||h._data(d,"_change_data",f),e===b||f===e||null==e&&!f||(a.type="change",a.liveFired=b,h.event.trigger(a,c,d)))};h.event.special.change=
{filters:{focusout:za,beforedeactivate:za,click:function(a){var b=a.target,c=h.nodeName(b,"input")?b.type:"";("radio"===c||"checkbox"===c||h.nodeName(b,"select"))&&za.call(this,a)},keydown:function(a){var b=a.target,c=h.nodeName(b,"input")?b.type:"";(13===a.keyCode&&!h.nodeName(b,"textarea")||32===a.keyCode&&("checkbox"===c||"radio"===c)||"select-multiple"===c)&&za.call(this,a)},beforeactivate:function(a){a=a.target;h._data(a,"_change_data",Pa(a))}},setup:function(a,b){if("file"===this.type)return!1;
for(var c in ma)h.event.add(this,c+".specialChange",ma[c]);return ha.test(this.nodeName)},teardown:function(a){h.event.remove(this,".specialChange");return ha.test(this.nodeName)}};ma=h.event.special.change.filters;ma.focus=ma.beforeactivate}h.support.focusinBubbles||h.each({focus:"focusin",blur:"focusout"},function(a,b){function c(a){var d=h.event.fix(a);d.type=b;d.originalEvent={};h.event.trigger(d,null,d.target);d.isDefaultPrevented()&&a.preventDefault()}var d=0;h.event.special[b]={setup:function(){0===
...
arguments,c=a.guid||h.guid++,d=0,e=function(c){var e=(h.data(this,"lastToggle"+a.guid)||0)%d;h.data(this,"lastToggle"+a.guid,e+1);c.preventDefault();return b[e].apply(this,arguments)||!1};for(e.guid=c;d<b.length;)b[d++].guid=c;return this.click(e)},hover:function(a,b){return this.mouseenter(a).mouseleave(b||a)}});var Fa={focus:"focusin",blur:"focusout",mouseenter:"mouseover",mouseleave:"mouseout"};h.each(["live","die"],function(a,c){h.fn[c]=function(a,d,e,g){var k=0,l,D,y=g||this.selector,n=g?this:
h(this.context);if("object"===typeof a&&!a.preventDefault){for(l in a)n[c](l,d,a[l],y);return this}if("die"===c&&!a&&g&&"."===g.charAt(0))return n.unbind(g),this;if(!1===d||h.isFunction(d))e=d||f,d=b;for(a=(a||"").split(" ");null!=(g=a[k++]);)if(l=Ea.exec(g),D="",l&&(D=l[0],g=g.replace(Ea,"")),"hover"===g)a.push("mouseenter"+D,"mouseleave"+D);else if(l=g,Fa[g]?(a.push(Fa[g]+D),g+=D):g=(Fa[g]||g)+D,"live"===c){D=0;for(var E=n.length;D<E;D++)h.event.add(n[D],"live."+m(g,y),{data:d,selector:y,handler:e,
origType:g,origHandler:e,preType:l})}else n.unbind("live."+m(g,y),e);return this}});h.each("blur focus focusin focusout load resize scroll unload click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup error".split(" "),function(a,b){h.fn[b]=function(a,c){null==c&&(c=a,a=null);return 0<arguments.length?this.bind(b,a,c):this.trigger(b)};h.attrFn&&(h.attrFn[b]=!0)});(function(){function a(b,c,d,e,f,g){f=0;for(var k=e.length;f<k;f++){var h=
e[f];if(h){for(var l=!1,h=h[b];h;){if(h.sizcache===d){l=e[h.sizset];break}1!==h.nodeType||g||(h.sizcache=d,h.sizset=f);if(h.nodeName.toLowerCase()===c){l=h;break}h=h[b]}e[f]=l}}}function c(a,b,d,e,f,g){f=0;for(var k=e.length;f<k;f++){var h=e[f];if(h){for(var l=!1,h=h[a];h;){if(h.sizcache===d){l=e[h.sizset];break}if(1===h.nodeType)if(g||(h.sizcache=d,h.sizset=f),"string"!==typeof b){if(h===b){l=!0;break}}else if(0<y.filter(b,[h]).length){l=h;break}h=h[a]}e[f]=l}}}var d=/((?:\((?:\([^()]+\)|[^()]+)+\)|\[(?:\[[^\[\]]*\]|['"][^'"]*['"]|[^\[\]'"]+)+\]|\\.|[^ >+~,(\[\\]+)+|[>+~])(\s*,\s*)?((?:.|\r|\n)*)/g,
e=0,f=Object.prototype.toString,g=!1,k=!0,l=/\\/g,m=/\W/;[0,0].sort(function(){k=!1;return 0});var y=function(a,b,c,e){c=c||[];var g=b=b||w;if(1!==b.nodeType&&9!==b.nodeType)return[];if(!a||"string"!==typeof a)return c;var k,h,l,D,m,ia=!0,fa=y.isXML(b),p=[],H=a;do if(d.exec(""),k=d.exec(H))if(H=k[3],p.push(k[1]),k[2]){D=k[3];break}while(k);if(1<p.length&&E.exec(a))if(2===p.length&&n.relative[p[0]])h=q(p[0]+p[1],b);else for(h=n.relative[p[0]]?[b]:y(p.shift(),b);p.length;)a=p.shift(),n.relative[a]&&
(a+=p.shift()),h=q(a,h);else if(!e&&1<p.length&&9===b.nodeType&&!fa&&n.match.ID.test(p[0])&&!n.match.ID.test(p[p.length-1])&&(k=y.find(p.shift(),b,fa),b=k.expr?y.filter(k.expr,k.set)[0]:k.set[0]),b)for(k=e?{expr:p.pop(),set:u(e)}:y.find(p.pop(),1!==p.length||"~"!==p[0]&&"+"!==p[0]||!b.parentNode?b:b.parentNode,fa),h=k.expr?y.filter(k.expr,k.set):k.set,0<p.length?l=u(h):ia=!1;p.length;)k=m=p.pop(),n.relative[m]?k=p.pop():m="",null==k&&(k=b),n.relative[m](l,k,fa);else l=[];l||(l=h);l||y.error(m||a);
if("[object Array]"===f.call(l))if(ia)if(b&&1===b.nodeType)for(a=0;null!=l[a];a++)l[a]&&(!0===l[a]||1===l[a].nodeType&&y.contains(b,l[a]))&&c.push(h[a]);else for(a=0;null!=l[a];a++)l[a]&&1===l[a].nodeType&&c.push(h[a]);else c.push.apply(c,l);else u(l,c);D&&(y(D,g,c,e),y.uniqueSort(c));return c};y.uniqueSort=function(a){if(r&&(g=k,a.sort(r),g))for(var b=1;b<a.length;b++)a[b]===a[b-1]&&a.splice(b--,1);return a};y.matches=function(a,b){return y(a,null,null,b)};y.matchesSelector=function(a,b){return 0<
y(b,null,null,[a]).length};y.find=function(a,b,c){var d;if(!a)return[];for(var e=0,f=n.order.length;e<f;e++){var g,k=n.order[e];if(g=n.leftMatch[k].exec(a)){var h=g[1];g.splice(1,1);if("\\"!==h.substr(h.length-1)&&(g[1]=(g[1]||"").replace(l,""),d=n.find[k](g,b,c),null!=d)){a=a.replace(n.match[k],"");break}}}d||(d="undefined"!==typeof b.getElementsByTagName?b.getElementsByTagName("*"):[]);return{set:d,expr:a}};y.filter=function(a,c,d,e){for(var f,g,k=a,h=[],l=c,D=c&&c[0]&&y.isXML(c[0]);a&&c.length;){for(var m in n.filter)if(null!=
(f=n.leftMatch[m].exec(a))&&f[2]){var ia,fa,p=n.filter[m];fa=f[1];g=!1;f.splice(1,1);if("\\"!==fa.substr(fa.length-1)){l===h&&(h=[]);if(n.preFilter[m])if(f=n.preFilter[m](f,l,d,h,e,D),!f)g=ia=!0;else if(!0===f)continue;if(f)for(var E=0;null!=(fa=l[E]);E++)if(fa){ia=p(fa,f,E,l);var Y=e^!!ia;d&&null!=ia?Y?g=!0:l[E]=!1:Y&&(h.push(fa),g=!0)}if(ia!==b){d||(l=h);a=a.replace(n.match[m],"");if(!g)return[];break}}}if(a===k)if(null==g)y.error(a);else break;k=a}return l};y.error=function(a){throw Error("Syntax error, unrecognized expression: "+
a);};var n=y.selectors={order:["ID","NAME","TAG"],match:{ID:/#((?:[\w\u00c0-\uFFFF\-]|\\.)+)/,CLASS:/\.((?:[\w\u00c0-\uFFFF\-]|\\.)+)/,NAME:/\[name=['"]*((?:[\w\u00c0-\uFFFF\-]|\\.)+)['"]*\]/,ATTR:/\[\s*((?:[\w\u00c0-\uFFFF\-]|\\.)+)\s*(?:(\S?=)\s*(?:(['"])(.*?)\3|(#?(?:[\w\u00c0-\uFFFF\-]|\\.)*)|)|)\s*\]/,TAG:/^((?:[\w\u00c0-\uFFFF\*\-]|\\.)+)/,CHILD:/:(only|nth|last|first)-child(?:\(\s*(even|odd|(?:[+\-]?\d+|(?:[+\-]?\d*)?n\s*(?:[+\-]\s*\d+)?))\s*\))?/,POS:/:(nth|eq|gt|lt|first|last|even|odd)(?:\((\d*)\))?(?=[^\-]|$)/,
PSEUDO:/:((?:[\w\u00c0-\uFFFF\-]|\\.)+)(?:\((['"]?)((?:\([^\)]+\)|[^\(\)]*)+)\2\))?/},leftMatch:{},attrMap:{"class":"className","for":"htmlFor"},attrHandle:{href:function(a){return a.getAttribute("href")},type:function(a){return a.getAttribute("type")}},relative:{"+":function(a,b){var c="string"===typeof b,d=c&&!m.test(b),c=c&&!d;d&&(b=b.toLowerCase());for(var d=0,e=a.length,f;d<e;d++)if(f=a[d]){for(;(f=f.previousSibling)&&1!==f.nodeType;);a[d]=c||f&&f.nodeName.toLowerCase()===b?f||!1:f===b}c&&y.filter(b,
a,!0)},">":function(a,b){var c,d="string"===typeof b,e=0,f=a.length;if(d&&!m.test(b))for(b=b.toLowerCase();e<f;e++){if(c=a[e])c=c.parentNode,a[e]=c.nodeName.toLowerCase()===b?c:!1}else{for(;e<f;e++)(c=a[e])&&(a[e]=d?c.parentNode:c.parentNode===b);d&&y.filter(b,a,!0)}},"":function(b,d,f){var g,k=e++,h=c;"string"!==typeof d||m.test(d)||(g=d=d.toLowerCase(),h=a);h("parentNode",d,k,b,g,f)},"~":function(b,d,f){var g,k=e++,h=c;"string"!==typeof d||m.test(d)||(g=d=d.toLowerCase(),h=a);h("previousSibling",
d,k,b,g,f)}},find:{ID:function(a,b,c){if("undefined"!==typeof b.getElementById&&!c)return(a=b.getElementById(a[1]))&&a.parentNode?[a]:[]},NAME:function(a,b){if("undefined"!==typeof b.getElementsByName){for(var c=[],d=b.getElementsByName(a[1]),e=0,f=d.length;e<f;e++)d[e].getAttribute("name")===a[1]&&c.push(d[e]);return 0===c.length?null:c}},TAG:function(a,b){if("undefined"!==typeof b.getElementsByTagName)return b.getElementsByTagName(a[1])}},preFilter:{CLASS:function(a,b,c,d,e,f){a=" "+a[1].replace(l,
"")+" ";if(f)return a;f=0;for(var g;null!=(g=b[f]);f++)g&&(e^(g.className&&0<=(" "+g.className+" ").replace(/[\t\n\r]/g," ").indexOf(a))?c||d.push(g):c&&(b[f]=!1));return!1},ID:function(a){return a[1].replace(l,"")},TAG:function(a,b){return a[1].replace(l,"").toLowerCase()},CHILD:function(a){if("nth"===a[1]){a[2]||y.error(a[0]);a[2]=a[2].replace(/^\+|\s*/g,"");var b=/(-?)(\d*)(?:n([+\-]?\d*))?/.exec("even"===a[2]&&"2n"||"odd"===a[2]&&"2n+1"||!/\D/.test(a[2])&&"0n+"+a[2]||a[2]);a[2]=b[1]+(b[2]||1)-
0;a[3]=b[3]-0}else a[2]&&y.error(a[0]);a[0]=e++;return a},ATTR:function(a,b,c,d,e,f){b=a[1]=a[1].replace(l,"");!f&&n.attrMap[b]&&(a[1]=n.attrMap[b]);a[4]=(a[4]||a[5]||"").replace(l,"");"~="===a[2]&&(a[4]=" "+a[4]+" ");return a},PSEUDO:function(a,b,c,e,f){if("not"===a[1])if(1<(d.exec(a[3])||"").length||/^\w/.test(a[3]))a[3]=y(a[3],null,null,b);else return a=y.filter(a[3],b,c,1^f),c||e.push.apply(e,a),!1;else if(n.match.POS.test(a[0])||n.match.CHILD.test(a[0]))return!0;return a},POS:function(a){a.unshift(!0);
...
if(e)return e(a,c,b,d)}}},E=n.match.POS,p=function(a,b){return"\\"+(b-0+1)},H;for(H in n.match)n.match[H]=new RegExp(n.match[H].source+/(?![^\[]*\])(?![^\(]*\))/.source),n.leftMatch[H]=new RegExp(/(^(?:.|\r|\n)*?)/.source+n.match[H].source.replace(/\\(\d+)/g,p));var u=function(a,b){a=Array.prototype.slice.call(a,0);return b?(b.push.apply(b,a),b):a};try{Array.prototype.slice.call(w.documentElement.childNodes,0)[0].nodeType}catch(ib){u=function(a,b){var c=0,d=b||[];if("[object Array]"===f.call(a))Array.prototype.push.apply(d,
a);else if("number"===typeof a.length)for(var e=a.length;c<e;c++)d.push(a[c]);else for(;a[c];c++)d.push(a[c]);return d}}var r,x;w.documentElement.compareDocumentPosition?r=function(a,b){return a===b?(g=!0,0):a.compareDocumentPosition&&b.compareDocumentPosition?a.compareDocumentPosition(b)&4?-1:1:a.compareDocumentPosition?-1:1}:(r=function(a,b){if(a===b)return g=!0,0;if(a.sourceIndex&&b.sourceIndex)return a.sourceIndex-b.sourceIndex;var c,d,e=[],f=[];c=a.parentNode;d=b.parentNode;var k=c;if(c===d)return x(a,
b);if(!c)return-1;if(!d)return 1;for(;k;)e.unshift(k),k=k.parentNode;for(k=d;k;)f.unshift(k),k=k.parentNode;c=e.length;d=f.length;for(k=0;k<c&&k<d;k++)if(e[k]!==f[k])return x(e[k],f[k]);return k===c?x(a,f[k],-1):x(e[k],b,1)},x=function(a,b,c){if(a===b)return c;for(a=a.nextSibling;a;){if(a===b)return-1;a=a.nextSibling}return 1});y.getText=function(a){for(var b="",c,d=0;a[d];d++)c=a[d],3===c.nodeType||4===c.nodeType?b+=c.nodeValue:8!==c.nodeType&&(b+=y.getText(c.childNodes));return b};(function(){var a=
w.createElement("div"),c="script"+(new Date).getTime(),d=w.documentElement;a.innerHTML="<a name='"+c+"'/>";d.insertBefore(a,d.firstChild);w.getElementById(c)&&(n.find.ID=function(a,c,d){if("undefined"!==typeof c.getElementById&&!d)return(c=c.getElementById(a[1]))?c.id===a[1]||"undefined"!==typeof c.getAttributeNode&&c.getAttributeNode("id").nodeValue===a[1]?[c]:b:[]},n.filter.ID=function(a,b){var c="undefined"!==typeof a.getAttributeNode&&a.getAttributeNode("id");return 1===a.nodeType&&c&&c.nodeValue===
b});d.removeChild(a);d=a=null})();(function(){var a=w.createElement("div");a.appendChild(w.createComment(""));0<a.getElementsByTagName("*").length&&(n.find.TAG=function(a,b){var c=b.getElementsByTagName(a[1]);if("*"===a[1]){for(var d=[],e=0;c[e];e++)1===c[e].nodeType&&d.push(c[e]);c=d}return c});a.innerHTML="<a href='#'></a>";a.firstChild&&"undefined"!==typeof a.firstChild.getAttribute&&"#"!==a.firstChild.getAttribute("href")&&(n.attrHandle.href=function(a){return a.getAttribute("href",2)});a=null})();
w.querySelectorAll&&function(){var a=y,b=w.createElement("div");b.innerHTML="<p class='TEST'></p>";if(!b.querySelectorAll||0!==b.querySelectorAll(".TEST").length){y=function(b,c,d,e){c=c||w;if(!e&&!y.isXML(c)){var f=/^(\w+$)|^\.([\w\-]+$)|^#([\w\-]+$)/.exec(b);if(f&&(1===c.nodeType||9===c.nodeType)){if(f[1])return u(c.getElementsByTagName(b),d);if(f[2]&&n.find.CLASS&&c.getElementsByClassName)return u(c.getElementsByClassName(f[2]),d)}if(9===c.nodeType){if("body"===b&&c.body)return u([c.body],d);if(f&&
f[3]){var g=c.getElementById(f[3]);if(g&&g.parentNode){if(g.id===f[3])return u([g],d)}else return u([],d)}try{return u(c.querySelectorAll(b),d)}catch(k){}}else if(1===c.nodeType&&"object"!==c.nodeName.toLowerCase()){var f=c,h=(g=c.getAttribute("id"))||"__sizzle__",l=c.parentNode,D=/^\s*[+~]/.test(b);g?h=h.replace(/'/g,"\\$&"):c.setAttribute("id",h);D&&l&&(c=c.parentNode);try{if(!D||l)return u(c.querySelectorAll("[id='"+h+"'] "+b),d)}catch(k){}finally{g||f.removeAttribute("id")}}}return a(b,c,d,e)};
for(var c in a)y[c]=a[c];b=null}}();(function(){var a=w.documentElement,b=a.matchesSelector||a.mozMatchesSelector||a.webkitMatchesSelector||a.msMatchesSelector;if(b){var c=!b.call(w.createElement("div"),"div"),d=!1;try{b.call(w.documentElement,"[test!='']:sizzle")}catch(e){d=!0}y.matchesSelector=function(a,e){e=e.replace(/\=\s*([^'"\]]*)\s*\]/g,"='$1']");if(!y.isXML(a))try{if(d||!n.match.PSEUDO.test(e)&&!/!=/.test(e)){var f=b.call(a,e);if(f||!c||a.document&&11!==a.document.nodeType)return f}}catch(g){}return 0<
y(e,null,null,[a]).length}}})();(function(){var a=w.createElement("div");a.innerHTML="<div class='test e'></div><div class='test'></div>";a.getElementsByClassName&&0!==a.getElementsByClassName("e").length&&(a.lastChild.className="e",1!==a.getElementsByClassName("e").length&&(n.order.splice(1,0,"CLASS"),n.find.CLASS=function(a,b,c){if("undefined"!==typeof b.getElementsByClassName&&!c)return b.getElementsByClassName(a[1])},a=null))})();y.contains=w.documentElement.contains?function(a,b){return a!==
b&&(a.contains?a.contains(b):!0)}:w.documentElement.compareDocumentPosition?function(a,b){return!!(a.compareDocumentPosition(b)&16)}:function(){return!1};y.isXML=function(a){return(a=(a?a.ownerDocument||a:0).documentElement)?"HTML"!==a.nodeName:!1};var q=function(a,b){for(var c,d=[],e="",f=b.nodeType?[b]:b;c=n.match.PSEUDO.exec(a);)e+=c[0],a=a.replace(n.match.PSEUDO,"");a=n.relative[a]?a+"*":a;c=0;for(var g=f.length;c<g;c++)y(a,f[c],d);return y.filter(e,d)};h.find=y;h.expr=y.selectors;h.expr[":"]=
h.expr.filters;h.unique=y.uniqueSort;h.text=y.getText;h.isXMLDoc=y.isXML;h.contains=y.contains})();var ab=/Until$/,bb=/^(?:parents|prevUntil|prevAll)/,Aa=/,/,Xa=/^.[^:#\[\.,]*$/,cb=Array.prototype.slice,sa=h.expr.match.POS,db={children:!0,contents:!0,next:!0,prev:!0};h.fn.extend({find:function(a){var b=this,c,d;if("string"!==typeof a)return h(a).filter(function(){c=0;for(d=b.length;c<d;c++)if(h.contains(b[c],this))return!0});var e=this.pushStack("","find",a),f,g,k;c=0;for(d=this.length;c<d;c++)if(f=
e.length,h.find(a,this[c],e),0<c)for(g=f;g<e.length;g++)for(k=0;k<f;k++)if(e[k]===e[g]){e.splice(g--,1);break}return e},has:function(a){var b=h(a);return this.filter(function(){for(var a=0,c=b.length;a<c;a++)if(h.contains(this,b[a]))return!0})},not:function(a){return this.pushStack(q(this,a,!1),"not",a)},filter:function(a){return this.pushStack(q(this,a,!0),"filter",a)},is:function(a){return!!a&&("string"===typeof a?0<h.filter(a,this).length:0<this.filter(a).length)},closest:function(a,b){var c=[],
d,e,f=this[0];if(h.isArray(a)){var g,k={},l=1;if(f&&a.length){d=0;for(e=a.length;d<e;d++)g=a[d],k[g]||(k[g]=sa.test(g)?h(g,b||this.context):g);for(;f&&f.ownerDocument&&f!==b;){for(g in k)d=k[g],(d.jquery?-1<d.index(f):h(f).is(d))&&c.push({selector:g,elem:f,level:l});f=f.parentNode;l++}}return c}g=sa.test(a)||"string"!==typeof a?h(a,b||this.context):0;d=0;for(e=this.length;d<e;d++)for(f=this[d];f;)if(g?-1<g.index(f):h.find.matchesSelector(f,a)){c.push(f);break}else if(f=f.parentNode,!f||!f.ownerDocument||
...
a)},children:function(a){return h.sibling(a.firstChild)},contents:function(a){return h.nodeName(a,"iframe")?a.contentDocument||a.contentWindow.document:h.makeArray(a.childNodes)}},function(a,b){h.fn[a]=function(c,d){var e=h.map(this,b,c),f=cb.call(arguments);ab.test(a)||(d=c);d&&"string"===typeof d&&(e=h.filter(d,e));e=1<this.length&&!db[a]?h.unique(e):e;(1<this.length||Aa.test(d))&&bb.test(a)&&(e=e.reverse());return this.pushStack(e,a,f.join(","))}});h.extend({filter:function(a,b,c){c&&(a=":not("+
a+")");return 1===b.length?h.find.matchesSelector(b[0],a)?[b[0]]:[]:h.find.matches(a,b)},dir:function(a,c,d){var e=[];for(a=a[c];a&&9!==a.nodeType&&(d===b||1!==a.nodeType||!h(a).is(d));)1===a.nodeType&&e.push(a),a=a[c];return e},nth:function(a,b,c,d){b=b||1;for(d=0;a&&(1!==a.nodeType||++d!==b);a=a[c]);return a},sibling:function(a,b){for(var c=[];a;a=a.nextSibling)1===a.nodeType&&a!==b&&c.push(a);return c}});var Ga=/ jQuery\d+="(?:\d+|null)"/g,S=/^\s+/,aa=/<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/ig,
Ha=/<([\w:]+)/,Qa=/<tbody/i,Ra=/<|&#?\w+;/,Sa=/<(?:script|object|embed|option|style)/i,Ta=/checked\s*(?:[^=]|=\s*.checked.)/i,y=/\/(java|ecma)script/i,H=/^\s*<!(?:\[CDATA\[|\-\-)/,E={option:[1,"<select multiple='multiple'>","</select>"],legend:[1,"<fieldset>","</fieldset>"],thead:[1,"<table>","</table>"],tr:[2,"<table><tbody>","</tbody></table>"],td:[3,"<table><tbody><tr>","</tr></tbody></table>"],col:[2,"<table><tbody></tbody><colgroup>","</colgroup></table>"],area:[1,"<map>","</map>"],_default:[0,
...
empty:function(){for(var a=0,b;null!=(b=this[a]);a++)for(1===b.nodeType&&h.cleanData(b.getElementsByTagName("*"));b.firstChild;)b.removeChild(b.firstChild);return this},clone:function(a,b){a=null==a?!1:a;b=null==b?a:b;return this.map(function(){return h.clone(this,a,b)})},html:function(a){if(a===b)return this[0]&&1===this[0].nodeType?this[0].innerHTML.replace(Ga,""):null;if("string"!==typeof a||Sa.test(a)||!h.support.leadingWhitespace&&S.test(a)||E[(Ha.exec(a)||["",""])[1].toLowerCase()])h.isFunction(a)?
this.each(function(b){var c=h(this);c.html(a.call(this,b,c.html()))}):this.empty().append(a);else{a=a.replace(aa,"<$1></$2>");try{for(var c=0,d=this.length;c<d;c++)1===this[c].nodeType&&(h.cleanData(this[c].getElementsByTagName("*")),this[c].innerHTML=a)}catch(e){this.empty().append(a)}}return this},replaceWith:function(a){if(this[0]&&this[0].parentNode){if(h.isFunction(a))return this.each(function(b){var c=h(this),d=c.html();c.replaceWith(a.call(this,b,d))});"string"!==typeof a&&(a=h(a).detach());
return this.each(function(){var b=this.nextSibling,c=this.parentNode;h(this).remove();b?h(b).before(a):h(c).append(a)})}return this.length?this.pushStack(h(h.isFunction(a)?a():a),"replaceWith",a):this},detach:function(a){return this.remove(a,!0)},domManip:function(a,c,d){var e,f,g,k=a[0],l=[];if(!h.support.checkClone&&3===arguments.length&&"string"===typeof k&&Ta.test(k))return this.each(function(){h(this).domManip(a,c,d,!0)});if(h.isFunction(k))return this.each(function(e){var f=h(this);a[0]=k.call(this,
e,c?f.html():b);f.domManip(a,c,d)});if(this[0]){e=k&&k.parentNode;e=h.support.parentNode&&e&&11===e.nodeType&&e.childNodes.length===this.length?{fragment:e}:h.buildFragment(a,this,l);g=e.fragment;if(f=1===g.childNodes.length?g=g.firstChild:g.firstChild){c=c&&h.nodeName(f,"tr");for(var m=0,y=this.length,n=y-1;m<y;m++)d.call(c?p(this[m],f):this[m],e.cacheable||1<y&&m<n?h.clone(g,!0,!0):g)}l.length&&h.each(l,u)}return this}});h.buildFragment=function(a,b,c){var d,e,f,g;b&&b[0]&&(g=b[0].ownerDocument||
b[0]);g.createDocumentFragment||(g=w);1===a.length&&"string"===typeof a[0]&&512>a[0].length&&g===w&&"<"===a[0].charAt(0)&&!Sa.test(a[0])&&(h.support.checkClone||!Ta.test(a[0]))&&(e=!0,(f=h.fragments[a[0]])&&1!==f&&(d=f));d||(d=g.createDocumentFragment(),h.clean(a,g,d,c));e&&(h.fragments[a[0]]=f?d:1);return{fragment:d,cacheable:e}};h.fragments={};h.each({appendTo:"append",prependTo:"prepend",insertBefore:"before",insertAfter:"after",replaceAll:"replaceWith"},function(a,b){h.fn[a]=function(c){var d=
[];c=h(c);var e=1===this.length&&this[0].parentNode;if(e&&11===e.nodeType&&1===e.childNodes.length&&1===c.length)return c[b](this[0]),this;for(var e=0,f=c.length;e<f;e++){var g=(0<e?this.clone(!0):this).get();h(c[e])[b](g);d=d.concat(g)}return this.pushStack(d,a,c.selector)}});h.extend({clone:function(a,b,c){var d=a.cloneNode(!0),e,f,g;if(!(h.support.noCloneEvent&&h.support.noCloneChecked||1!==a.nodeType&&11!==a.nodeType||h.isXMLDoc(a)))for(t(a,d),e=v(a),f=v(d),g=0;e[g];++g)t(e[g],f[g]);if(b&&(r(a,
d),c))for(e=v(a),f=v(d),g=0;e[g];++g)r(e[g],f[g]);return d},clean:function(a,b,c,d){b=b||w;"undefined"===typeof b.createElement&&(b=b.ownerDocument||b[0]&&b[0].ownerDocument||w);for(var e=[],f,g=0,k;null!=(k=a[g]);g++)if("number"===typeof k&&(k+=""),k){if("string"===typeof k)if(Ra.test(k)){k=k.replace(aa,"<$1></$2>");f=(Ha.exec(k)||["",""])[1].toLowerCase();var l=E[f]||E._default,m=l[0],n=b.createElement("div");for(n.innerHTML=l[1]+k+l[2];m--;)n=n.lastChild;if(!h.support.tbody)for(m=Qa.test(k),l=
"table"!==f||m?"<table>"!==l[1]||m?[]:n.childNodes:n.firstChild&&n.firstChild.childNodes,f=l.length-1;0<=f;--f)h.nodeName(l[f],"tbody")&&!l[f].childNodes.length&&l[f].parentNode.removeChild(l[f]);!h.support.leadingWhitespace&&S.test(k)&&n.insertBefore(b.createTextNode(S.exec(k)[0]),n.firstChild);k=n.childNodes}else k=b.createTextNode(k);var p;if(!h.support.appendChecked)if(k[0]&&"number"===typeof(p=k.length))for(f=0;f<p;f++)x(k[f]);else x(k);k.nodeType?e.push(k):e=h.merge(e,k)}if(c)for(a=function(a){return!a.type||
y.test(a.type)},g=0;e[g];g++)!d||!h.nodeName(e[g],"script")||e[g].type&&"text/javascript"!==e[g].type.toLowerCase()?(1===e[g].nodeType&&(b=h.grep(e[g].getElementsByTagName("script"),a),e.splice.apply(e,[g+1,0].concat(b))),c.appendChild(e[g])):d.push(e[g].parentNode?e[g].parentNode.removeChild(e[g]):e[g]);return e},cleanData:function(a){for(var b,c,d=h.cache,e=h.expando,f=h.event.special,g=h.support.deleteExpando,k=0,l;null!=(l=a[k]);k++)if(!l.nodeName||!h.noData[l.nodeName.toLowerCase()])if(c=l[h.expando]){if((b=
d[c]&&d[c][e])&&b.events){for(var m in b.events)f[m]?h.event.remove(l,m):h.removeEvent(l,m,b.handle);b.handle&&(b.handle.elem=null)}g?delete l[h.expando]:l.removeAttribute&&l.removeAttribute(h.expando);delete d[c]}}});var ga=/alpha\([^)]*\)/i,N=/opacity=([^)]*)/,ta=/([A-Z]|^ms)/g,ra=/^-?\d+(?:px)?$/i,na=/^-?\d/,oa=/^[+\-]=/,ua=/[^+\-\.\de]+/g,Ia={position:"absolute",visibility:"hidden",display:"block"},qa=["Left","Right"],Ya=["Top","Bottom"],Z,jb,kb;h.fn.css=function(a,c){return 2===arguments.length&&
c===b?this:h.access(this,a,c,!0,function(a,c,d){return d!==b?h.style(a,c,d):h.css(a,c)})};h.extend({cssHooks:{opacity:{get:function(a,b){if(b){var c=Z(a,"opacity","opacity");return""===c?"1":c}return a.style.opacity}}},cssNumber:{fillOpacity:!0,fontWeight:!0,lineHeight:!0,opacity:!0,orphans:!0,widows:!0,zIndex:!0,zoom:!0},cssProps:{"float":h.support.cssFloat?"cssFloat":"styleFloat"},style:function(a,c,d,e){if(a&&3!==a.nodeType&&8!==a.nodeType&&a.style){var f,g=h.camelCase(c),k=a.style,l=h.cssHooks[g];
c=h.cssProps[g]||g;if(d!==b){if(e=typeof d,!("number"===e&&isNaN(d)||null==d||("string"===e&&oa.test(d)&&(d=+d.replace(ua,"")+parseFloat(h.css(a,c)),e="number"),"number"!==e||h.cssNumber[g]||(d+="px"),l&&"set"in l&&(d=l.set(a,d))===b)))try{k[c]=d}catch(m){}}else return l&&"get"in l&&(f=l.get(a,!1,e))!==b?f:k[c]}},css:function(a,c,d){var e,f;c=h.camelCase(c);f=h.cssHooks[c];c=h.cssProps[c]||c;"cssFloat"===c&&(c="float");if(f&&"get"in f&&(e=f.get(a,!0,d))!==b)return e;if(Z)return Z(a,c)},swap:function(a,
b,c){var d={},e;for(e in b)d[e]=a.style[e],a.style[e]=b[e];c.call(a);for(e in b)a.style[e]=d[e]}});h.curCSS=h.css;h.each(["height","width"],function(a,b){h.cssHooks[b]={get:function(a,c,d){var e;if(c){if(0!==a.offsetWidth)return A(a,b,d);h.swap(a,Ia,function(){e=A(a,b,d)});return e}},set:function(a,b){if(ra.test(b)){if(b=parseFloat(b),0<=b)return b+"px"}else return b}}});h.support.opacity||(h.cssHooks.opacity={get:function(a,b){return N.test((b&&a.currentStyle?a.currentStyle.filter:a.style.filter)||
"")?parseFloat(RegExp.$1)/100+"":b?"1":""},set:function(a,b){var c=a.style,d=a.currentStyle;c.zoom=1;var e=h.isNaN(b)?"":"alpha(opacity="+100*b+")",d=d&&d.filter||c.filter||"";c.filter=ga.test(d)?d.replace(ga,e):d+" "+e}});h(function(){h.support.reliableMarginRight||(h.cssHooks.marginRight={get:function(a,b){var c;h.swap(a,{display:"inline-block"},function(){c=b?Z(a,"margin-right","marginRight"):a.style.marginRight});return c}})});w.defaultView&&w.defaultView.getComputedStyle&&(jb=function(a,c){var d,
e;c=c.replace(ta,"-$1").toLowerCase();if(!(e=a.ownerDocument.defaultView))return b;if(e=e.getComputedStyle(a,null))d=e.getPropertyValue(c),""!==d||h.contains(a.ownerDocument.documentElement,a)||(d=h.style(a,c));return d});w.documentElement.currentStyle&&(kb=function(a,b){var c,d=a.currentStyle&&a.currentStyle[b],e=a.runtimeStyle&&a.runtimeStyle[b],f=a.style;!ra.test(d)&&na.test(d)&&(c=f.left,e&&(a.runtimeStyle.left=a.currentStyle.left),f.left="fontSize"===b?"1em":d||0,d=f.pixelLeft+"px",f.left=c,
e&&(a.runtimeStyle.left=e));return""===d?"auto":d});Z=jb||kb;h.expr&&h.expr.filters&&(h.expr.filters.hidden=function(a){var b=a.offsetHeight;return 0===a.offsetWidth&&0===b||!h.support.reliableHiddenOffsets&&"none"===(a.style.display||h.css(a,"display"))},h.expr.filters.visible=function(a){return!h.expr.filters.hidden(a)});var ub=/%20/g,rb=/\[\]$/,lb=/\r?\n/g,vb=/#.*$/,wb=/^(.*?):[ \t]*([^\r\n]*)\r?$/mg,xb=/^(?:color|date|datetime|email|hidden|month|number|password|range|search|tel|text|time|url|week)$/i,
yb=/^(?:GET|HEAD)$/,zb=/^\/\//,mb=/\?/,Ab=/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi,Bb=/^(?:select|textarea)/i,gb=/\s+/,Cb=/([?&])_=[^&]*/,nb=/^([\w\+\.\-]+:)(?:\/\/([^\/?#:]*)(?::(\d+))?)?/,ob=h.fn.load,Za={},pb={},va,wa;try{va=U.href}catch(D){va=w.createElement("a"),va.href="",va=va.href}wa=nb.exec(va.toLowerCase())||[];h.fn.extend({load:function(a,c,d){if("string"!==typeof a&&ob)return ob.apply(this,arguments);if(!this.length)return this;var e=a.indexOf(" ");if(0<=e){var f=a.slice(e,
a.length);a=a.slice(0,e)}e="GET";c&&(h.isFunction(c)?(d=c,c=b):"object"===typeof c&&(c=h.param(c,h.ajaxSettings.traditional),e="POST"));var g=this;h.ajax({url:a,type:e,dataType:"html",data:c,complete:function(a,b,c){c=a.responseText;a.isResolved()&&(a.done(function(a){c=a}),g.html(f?h("<div>").append(c.replace(Ab,"")).find(f):c));d&&g.each(d,[c,b,a])}});return this},serialize:function(){return h.param(this.serializeArray())},serializeArray:function(){return this.map(function(){return this.elements?
h.makeArray(this.elements):this}).filter(function(){return this.name&&!this.disabled&&(this.checked||Bb.test(this.nodeName)||xb.test(this.type))}).map(function(a,b){var c=h(this).val();return null==c?null:h.isArray(c)?h.map(c,function(a,c){return{name:b.name,value:a.replace(lb,"\r\n")}}):{name:b.name,value:c.replace(lb,"\r\n")}}).get()}});h.each("ajaxStart ajaxStop ajaxComplete ajaxError ajaxSuccess ajaxSend".split(" "),function(a,b){h.fn[b]=function(a){return this.bind(b,a)}});h.each(["get","post"],
function(a,c){h[c]=function(a,d,e,f){h.isFunction(d)&&(f=f||e,e=d,d=b);return h.ajax({type:c,url:a,data:d,success:e,dataType:f})}});h.extend({getScript:function(a,c){return h.get(a,b,c,"script")},getJSON:function(a,b,c){return h.get(a,b,c,"json")},ajaxSetup:function(a,b){b?h.extend(!0,a,h.ajaxSettings,b):(b=a,a=h.extend(!0,h.ajaxSettings,b));for(var c in{context:1,url:1})c in b?a[c]=b[c]:c in h.ajaxSettings&&(a[c]=h.ajaxSettings[c]);return a},ajaxSettings:{url:va,isLocal:/^(?:about|app|app\-storage|.+\-extension|file|widget):$/.test(wa[1]),
global:!0,type:"GET",contentType:"application/x-www-form-urlencoded",processData:!0,async:!0,accepts:{xml:"application/xml, text/xml",html:"text/html",text:"text/plain",json:"application/json, text/javascript","*":"*/*"},contents:{xml:/xml/,html:/html/,json:/json/},responseFields:{xml:"responseXML",text:"responseText"},converters:{"* text":a.String,"text html":!0,"text json":h.parseJSON,"text xml":h.parseXML}},ajaxPrefilter:B(Za),ajaxTransport:B(pb),ajax:function(a,c){function d(a,c,n,p){if(2!==q){q=
2;r&&clearTimeout(r);u=b;E=p||"";A.readyState=a?4:0;var H,D,x;if(n){p=e;var ia=A,t=p.contents,N=p.dataTypes,Y=p.responseFields,v,B,w,ta;for(B in Y)B in n&&(ia[Y[B]]=n[B]);for(;"*"===N[0];)N.shift(),v===b&&(v=p.mimeType||ia.getResponseHeader("content-type"));if(v)for(B in t)if(t[B]&&t[B].test(v)){N.unshift(B);break}if(N[0]in n)w=N[0];else{for(B in n){if(!N[0]||p.converters[B+" "+N[0]]){w=B;break}ta||(ta=B)}w=w||ta}w?(w!==N[0]&&N.unshift(w),n=n[w]):n=void 0}else n=b;if(200<=a&&300>a||304===a){if(e.ifModified){if(v=
A.getResponseHeader("Last-Modified"))h.lastModified[y]=v;if(v=A.getResponseHeader("Etag"))h.etag[y]=v}if(304===a)c="notmodified",H=!0;else try{v=e;v.dataFilter&&(n=v.dataFilter(n,v.dataType));var ra=v.dataTypes;B={};var oa,z,F=ra.length,C,na=ra[0],Z,Ia,K,qa,ua;for(oa=1;oa<F;oa++){if(1===oa)for(z in v.converters)"string"===typeof z&&(B[z.toLowerCase()]=v.converters[z]);Z=na;na=ra[oa];if("*"===na)na=Z;else if("*"!==Z&&Z!==na){Ia=Z+" "+na;K=B[Ia]||B["* "+na];if(!K)for(qa in ua=b,B)if(C=qa.split(" "),
C[0]===Z||"*"===C[0])if(ua=B[C[1]+" "+na]){qa=B[qa];!0===qa?K=ua:!0===ua&&(K=qa);break}K||ua||h.error("No conversion from "+Ia.replace(" "," to "));!0!==K&&(n=K?K(n):ua(qa(n)))}}D=n;c="success";H=!0}catch(Ya){c="parsererror",x=Ya}}else if(x=c,!c||a)c="error",0>a&&(a=0);A.status=a;A.statusText=c;H?k.resolveWith(f,[D,c,A]):k.rejectWith(f,[A,c,x]);A.statusCode(m);m=b;ga&&g.trigger("ajax"+(H?"Success":"Error"),[A,e,H?D:x]);l.resolveWith(f,[A,c]);ga&&(g.trigger("ajaxComplete",[A,e]),--h.active||h.event.trigger("ajaxStop"))}}
"object"===typeof a&&(c=a,a=b);c=c||{};var e=h.ajaxSetup({},c),f=e.context||e,g=f!==e&&(f.nodeType||f instanceof h)?h(f):h.event,k=h.Deferred(),l=h._Deferred(),m=e.statusCode||{},y,n={},p={},E,H,u,r,x,q=0,ga,t,A={readyState:0,setRequestHeader:function(a,b){if(!q){var c=a.toLowerCase();a=p[c]=p[c]||a;n[a]=b}return this},getAllResponseHeaders:function(){return 2===q?E:null},getResponseHeader:function(a){var c;if(2===q){if(!H)for(H={};c=wb.exec(E);)H[c[1].toLowerCase()]=c[2];c=H[a.toLowerCase()]}return c===
b?null:c},overrideMimeType:function(a){q||(e.mimeType=a);return this},abort:function(a){a=a||"abort";u&&u.abort(a);d(0,a);return this}};k.promise(A);A.success=A.done;A.error=A.fail;A.complete=l.done;A.statusCode=function(a){if(a){var b;if(2>q)for(b in a)m[b]=[m[b],a[b]];else b=a[A.status],A.then(b,b)}return this};e.url=((a||e.url)+"").replace(vb,"").replace(zb,wa[1]+"//");e.dataTypes=h.trim(e.dataType||"*").toLowerCase().split(gb);null==e.crossDomain&&(x=nb.exec(e.url.toLowerCase()),e.crossDomain=
!(!x||x[1]==wa[1]&&x[2]==wa[2]&&(x[3]||("http:"===x[1]?80:443))==(wa[3]||("http:"===wa[1]?80:443))));e.data&&e.processData&&"string"!==typeof e.data&&(e.data=h.param(e.data,e.traditional));F(Za,e,c,A);if(2===q)return!1;ga=e.global;e.type=e.type.toUpperCase();e.hasContent=!yb.test(e.type);ga&&0===h.active++&&h.event.trigger("ajaxStart");if(!e.hasContent&&(e.data&&(e.url+=(mb.test(e.url)?"&":"?")+e.data),y=e.url,!1===e.cache)){x=h.now();var N=e.url.replace(Cb,"$1_="+x);e.url=N+(N===e.url?(mb.test(e.url)?
"&":"?")+"_="+x:"")}(e.data&&e.hasContent&&!1!==e.contentType||c.contentType)&&A.setRequestHeader("Content-Type",e.contentType);e.ifModified&&(y=y||e.url,h.lastModified[y]&&A.setRequestHeader("If-Modified-Since",h.lastModified[y]),h.etag[y]&&A.setRequestHeader("If-None-Match",h.etag[y]));A.setRequestHeader("Accept",e.dataTypes[0]&&e.accepts[e.dataTypes[0]]?e.accepts[e.dataTypes[0]]+("*"!==e.dataTypes[0]?", */*; q=0.01":""):e.accepts["*"]);for(t in e.headers)A.setRequestHeader(t,e.headers[t]);if(e.beforeSend&&
(!1===e.beforeSend.call(f,A,e)||2===q))return A.abort(),!1;for(t in{success:1,error:1,complete:1})A[t](e[t]);if(u=F(pb,e,c,A)){A.readyState=1;ga&&g.trigger("ajaxSend",[A,e]);e.async&&0<e.timeout&&(r=setTimeout(function(){A.abort("timeout")},e.timeout));try{q=1,u.send(n,d)}catch(v){2>status?d(-1,v):h.error(v)}}else d(-1,"No Transport");return A},param:function(a,c){var d=[],e=function(a,b){b=h.isFunction(b)?b():b;d[d.length]=encodeURIComponent(a)+"="+encodeURIComponent(b)};c===b&&(c=h.ajaxSettings.traditional);
if(h.isArray(a)||a.jquery&&!h.isPlainObject(a))h.each(a,function(){e(this.name,this.value)});else for(var f in a)C(f,a[f],c,e);return d.join("&").replace(ub,"+")}});h.extend({active:0,lastModified:{},etag:{}});var Db=h.now(),Ua=/(\=)\?(&|$)|\?\?/i;h.ajaxSetup({jsonp:"callback",jsonpCallback:function(){return h.expando+"_"+Db++}});h.ajaxPrefilter("json jsonp",function(b,c,d){c="application/x-www-form-urlencoded"===b.contentType&&"string"===typeof b.data;if("jsonp"===b.dataTypes[0]||!1!==b.jsonp&&(Ua.test(b.url)||
c&&Ua.test(b.data))){var e,f=b.jsonpCallback=h.isFunction(b.jsonpCallback)?b.jsonpCallback():b.jsonpCallback,g=a[f],k=b.url,l=b.data,m="$1"+f+"$2";!1!==b.jsonp&&(k=k.replace(Ua,m),b.url===k&&(c&&(l=l.replace(Ua,m)),b.data===l&&(k+=(/\?/.test(k)?"&":"?")+b.jsonp+"="+f)));b.url=k;b.data=l;a[f]=function(a){e=[a]};d.always(function(){a[f]=g;if(e&&h.isFunction(g))a[f](e[0])});b.converters["script json"]=function(){e||h.error(f+" was not called");return e[0]};b.dataTypes[0]="json";return"script"}});h.ajaxSetup({accepts:{script:"text/javascript, application/javascript, application/ecmascript, application/x-ecmascript"},
...
e[l])}catch(m){}g.send(c.hasContent&&c.data||null);d=function(a,e){var l,m,y,n,p;try{if(d&&(e||4===g.readyState))if(d=b,k&&(g.onreadystatechange=h.noop,eb&&delete Ba[k]),e)4!==g.readyState&&g.abort();else{l=g.status;y=g.getAllResponseHeaders();n={};(p=g.responseXML)&&p.documentElement&&(n.xml=p);n.text=g.responseText;try{m=g.statusText}catch(E){m=""}l||!c.isLocal||c.crossDomain?1223===l&&(l=204):l=n.text?200:404}}catch(E){e||f(-1,E)}n&&f(l,m,n,y)};c.async&&4!==g.readyState?(k=++Eb,eb&&(Ba||(Ba={},
h(a).unload(eb)),Ba[k]=d),g.onreadystatechange=d):d()},abort:function(){d&&d(0,1)}}}});var $a={},ka,ya,Fb=/^(?:toggle|show|hide)$/,Gb=/^([+\-]=)?([\d+.\-]+)([a-z%]*)$/i,Ca,hb=[["height","marginTop","marginBottom","paddingTop","paddingBottom"],["width","marginLeft","marginRight","paddingLeft","paddingRight"],["opacity"]],La,fb=a.webkitRequestAnimationFrame||a.mozRequestAnimationFrame||a.oRequestAnimationFrame;h.fn.extend({show:function(a,b,c){if(a||0===a)return this.animate(O("show",3),a,b,c);c=0;
for(var d=this.length;c<d;c++)a=this[c],a.style&&(b=a.style.display,h._data(a,"olddisplay")||"none"!==b||(b=a.style.display=""),""===b&&"none"===h.css(a,"display")&&h._data(a,"olddisplay",pa(a.nodeName)));for(c=0;c<d;c++)if(a=this[c],a.style&&(b=a.style.display,""===b||"none"===b))a.style.display=h._data(a,"olddisplay")||"";return this},hide:function(a,b,c){if(a||0===a)return this.animate(O("hide",3),a,b,c);a=0;for(b=this.length;a<b;a++)this[a].style&&(c=h.css(this[a],"display"),"none"===c||h._data(this[a],
...
0,k=parseFloat(k)||0);h.isFunction(b)&&(b=b.call(a,c,f));null!=b.top&&(l.top=b.top-f.top+d);null!=b.left&&(l.left=b.left-f.left+k);"using"in b?b.using.call(a,l):e.css(l)}};h.fn.extend({position:function(){if(!this[0])return null;var a=this[0],b=this.offsetParent(),c=this.offset(),d=qb.test(b[0].nodeName)?{top:0,left:0}:b.offset();c.top-=parseFloat(h.css(a,"marginTop"))||0;c.left-=parseFloat(h.css(a,"marginLeft"))||0;d.top+=parseFloat(h.css(b[0],"borderTopWidth"))||0;d.left+=parseFloat(h.css(b[0],
"borderLeftWidth"))||0;return{top:c.top-d.top,left:c.left-d.left}},offsetParent:function(){return this.map(function(){for(var a=this.offsetParent||w.body;a&&!qb.test(a.nodeName)&&"static"===h.css(a,"position");)a=a.offsetParent;return a})}});h.each(["Left","Top"],function(a,c){var d="scroll"+c;h.fn[d]=function(c){var e,f;return c===b?(e=this[0],e?(f=ea(e))?f[a?"pageYOffset":"pageXOffset"]||h.support.boxModel&&f.document.documentElement[d]||f.document.body[d]:e[d]:null):this.each(function(){(f=ea(this))?
...
(function(a){function b(a,b,c,d){var e,f,g,k,l,m=b&&b.ownerDocument,n=b?b.nodeType:9;c=c||[];if("string"!==typeof a||!a||1!==n&&9!==n&&11!==n)return c;if(!d&&((b?b.ownerDocument||b:P)!==h&&U(b),b=b||h,M)){if(11!==n&&(k=db.exec(a)))if(e=k[1])if(9===n)if(f=b.getElementById(e)){if(f.id===e)return c.push(f),c}else return c;else{if(m&&(f=m.getElementById(e))&&Q(b,f)&&f.id===e)return c.push(f),c}else{if(k[2])return ja.apply(c,b.getElementsByTagName(a)),c;if((e=k[3])&&F.getElementsByClassName&&b.getElementsByClassName)return ja.apply(c,
b.getElementsByClassName(e)),c}if(!(!F.qsa||ca[a+" "]||I&&I.test(a))){if(1!==n)m=b,l=a;else if("object"!==b.nodeName.toLowerCase()){(g=b.getAttribute("id"))?g=g.replace(Ha,Qa):b.setAttribute("id",g=G);f=da(a);for(e=f.length;e--;)f[e]="#"+g+" "+r(f[e]);l=f.join(",");m=Ga.test(a)&&q(b.parentNode)||b}if(l)try{if(!bowser.msie&&!bowser.msedge||!/:nth-of-type\(\d/i.test(l))return ja.apply(c,m.querySelectorAll(l)),c}catch(p){}finally{g===G&&b.removeAttribute("id")}}}return pa(a.replace(ma,"$1"),b,c,d)}function c(){function a(c,
...
b.nodeName.toLowerCase()&&b.type===a}}function l(a){return function(b){var c=b.nodeName.toLowerCase();return("input"===c||"button"===c)&&b.type===a}}function m(a){return function(b){return"form"in b?b.parentNode&&!1===b.disabled?"label"in b?"label"in b.parentNode?b.parentNode.disabled===a:b.disabled===a:b.isDisabled===a||b.isDisabled!==!a&&Sa(b)===a:b.disabled===a:"label"in b?b.disabled===a:!1}}function n(a){return d(function(b){b=+b;return d(function(c,d){for(var e,f=a([],c.length,b),g=f.length;g--;)c[e=
f[g]]&&(c[e]=!(d[e]=c[e]))})})}function q(a){return a&&"undefined"!==typeof a.getElementsByTagName&&a}function p(){}function r(a){for(var b=0,c=a.length,d="";b<c;b++)d+=a[b].value;return d}function t(a,b,c){var d=b.dir,e=b.next,f=e||d,g=c&&"parentNode"===f,k=L++;return b.first?function(b,c,e){for(;b=b[d];)if(1===b.nodeType||g)return a(b,c,e);return!1}:function(b,c,h){var l,m,n=[X,k];if(h)for(;b=b[d];){if((1===b.nodeType||g)&&a(b,c,h))return!0}else for(;b=b[d];)if(1===b.nodeType||g)if(m=b[G]||(b[G]=
{}),m=m[b.uniqueID]||(m[b.uniqueID]={}),e&&e===b.nodeName.toLowerCase())b=b[d]||b;else{if((l=m[f])&&l[0]===X&&l[1]===k)return n[2]=l[2];m[f]=n;if(n[2]=a(b,c,h))return!0}return!1}}function v(a){return 1<a.length?function(b,c,d){for(var e=a.length;e--;)if(!a[e](b,c,d))return!1;return!0}:a[0]}function z(a,b,c,d,e){for(var f,g=[],k=0,h=a.length,l=null!=b;k<h;k++)if(f=a[k])if(!c||c(f,d,e))g.push(f),l&&b.push(k);return g}function x(a,c,e,f,g,k){f&&!f[G]&&(f=x(f));g&&!g[G]&&(g=x(g,k));return d(function(d,
k,h,l){var m,n,p=[],u=[],x=k.length,r;if(!(r=d)){r=c||"*";for(var q=h.nodeType?[h]:h,A=[],t=0,v=q.length;t<v;t++)b(r,q[t],A);r=A}r=!a||!d&&c?r:z(r,p,a,h,l);q=e?g||(d?a:x||f)?[]:k:r;e&&e(r,q,h,l);if(f)for(m=z(q,u),f(m,[],h,l),h=m.length;h--;)if(n=m[h])q[u[h]]=!(r[u[h]]=n);if(d){if(g||a){if(g){m=[];for(h=q.length;h--;)(n=q[h])&&m.push(r[h]=n);g(null,q=[],m,l)}for(h=q.length;h--;)(n=q[h])&&-1<(m=g?la(d,n):p[h])&&(d[m]=!(k[m]=n))}}else q=z(q===k?q.splice(x,q.length):q),g?g(null,k,q,l):ja.apply(k,q)})}
function u(a){var b,c,d,e=a.length,f=C.relative[a[0].type];c=f||C.relative[" "];for(var g=f?1:0,k=t(function(a){return a===b},c,!0),h=t(function(a){return-1<la(b,a)},c,!0),l=[function(a,c,d){a=!f&&(d||c!==ea)||((b=c).nodeType?k(a,c,d):h(a,c,d));b=null;return a}];g<e;g++)if(c=C.relative[a[g].type])l=[t(v(l),c)];else{c=C.filter[a[g].type].apply(null,a[g].matches);if(c[G]){for(d=++g;d<e&&!C.relative[a[d].type];d++);return x(1<g&&v(l),1<g&&r(a.slice(0,g-1).concat({value:" "===a[g-2].type?"*":""})).replace(ma,
"$1"),c,g<d&&u(a.slice(g,d)),d<e&&u(a=a.slice(d)),d<e&&r(a))}l.push(c)}return v(l)}function A(a,c){var e=0<c.length,f=0<a.length,g=function(d,g,k,l,m){var n,p,u,r=0,q="0",x=d&&[],A=[],t=ea,v=d||f&&C.find.TAG("*",m),B=X+=null==t?1:Math.random()||.1,w=v.length;for(m&&(ea=g===h||g||m);q!==w&&null!=(n=v[q]);q++){if(f&&n){p=0;g||n.ownerDocument===h||(U(n),k=!M);for(;u=a[p++];)if(u(n,g||h,k)){l.push(n);break}m&&(X=B)}e&&((n=!u&&n)&&r--,d&&x.push(n))}r+=q;if(e&&q!==r){for(p=0;u=c[p++];)u(x,A,g,k);if(d){if(0<
r)for(;q--;)x[q]||A[q]||(A[q]=Va.call(l));A=z(A)}ja.apply(l,A);m&&!d&&0<A.length&&1<r+c.length&&b.uniqueSort(l)}m&&(X=B,ea=t);return x};return e?d(g):g}var B,F,C,K,ba,da,O,pa,ea,w,W,U,h,J,M,I,R,V,Q,G="sizzle"+1*new Date,P=a.document,X=0,L=0,Da=c(),Ja=c(),ca=c(),xa=function(a,b){a===b&&(W=!0);return 0},Ea={}.hasOwnProperty,ha=[],Va=ha.pop,Wa=ha.push,ja=ha.push,Ka=ha.slice,la=function(a,b){for(var c=0,d=a.length;c<d;c++)if(a[c]===b)return c;return-1},Oa=RegExp("[\\x20\\t\\r\\n\\f]+","g"),ma=RegExp("^[\\x20\\t\\r\\n\\f]+|((?:^|[^\\\\])(?:\\\\.)*)[\\x20\\t\\r\\n\\f]+$",
"g"),Pa=/^[\x20\t\r\n\f]*,[\x20\t\r\n\f]*/,za=/^[\x20\t\r\n\f]*([>+~]|[\x20\t\r\n\f])[\x20\t\r\n\f]*/,Fa=RegExp("=[\\x20\\t\\r\\n\\f]*([^\\]'\"]*?)[\\x20\\t\\r\\n\\f]*\\]","g"),ab=/:((?:\\.|[\w-]|[^\x00-\xa0])+)(?:\((('((?:\\.|[^\\'])*)'|"((?:\\.|[^\\"])*)")|((?:\\.|[^\\()[\]]|\[[\x20\t\r\n\f]*((?:\\.|[\w-]|[^\x00-\xa0])+)(?:[\x20\t\r\n\f]*([*^$|!~]?=)[\x20\t\r\n\f]*(?:'((?:\\.|[^\\'])*)'|"((?:\\.|[^\\"])*)"|((?:\\.|[\w-]|[^\x00-\xa0])+))|)[\x20\t\r\n\f]*\])*)|.*)\)|)/,bb=/^(?:\\.|[\w-]|[^\x00-\xa0])+$/,
Aa={ID:/^#((?:\\.|[\w-]|[^\x00-\xa0])+)/,CLASS:/^\.((?:\\.|[\w-]|[^\x00-\xa0])+)/,TAG:/^((?:\\.|[\w-]|[^\x00-\xa0])+|[*])/,ATTR:/^\[[\x20\t\r\n\f]*((?:\\.|[\w-]|[^\x00-\xa0])+)(?:[\x20\t\r\n\f]*([*^$|!~]?=)[\x20\t\r\n\f]*(?:'((?:\\.|[^\\'])*)'|"((?:\\.|[^\\"])*)"|((?:\\.|[\w-]|[^\x00-\xa0])+))|)[\x20\t\r\n\f]*\]/,PSEUDO:/^:((?:\\.|[\w-]|[^\x00-\xa0])+)(?:\((('((?:\\.|[^\\'])*)'|"((?:\\.|[^\\"])*)")|((?:\\.|[^\\()[\]]|\[[\x20\t\r\n\f]*((?:\\.|[\w-]|[^\x00-\xa0])+)(?:[\x20\t\r\n\f]*([*^$|!~]?=)[\x20\t\r\n\f]*(?:'((?:\\.|[^\\'])*)'|"((?:\\.|[^\\"])*)"|((?:\\.|[\w-]|[^\x00-\xa0])+))|)[\x20\t\r\n\f]*\])*)|.*)\)|)/,
CHILD:/^:(only|first|last|nth|nth-last)-(child|of-type)(?:\([\x20\t\r\n\f]*(even|odd|(([+-]|)(\d*)n|)[\x20\t\r\n\f]*(?:([+-]|)[\x20\t\r\n\f]*(\d+)|))[\x20\t\r\n\f]*\)|)/i,bool:/^(?:checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped)$/i,needsContext:/^[\x20\t\r\n\f]*[>+~]|:(even|odd|eq|gt|lt|nth|first|last)(?:\([\x20\t\r\n\f]*((?:-\d)?\d*)[\x20\t\r\n\f]*\)|)(?=[^-]|$)/i},Xa=/^(?:input|select|textarea|button)$/i,cb=/^h\d$/i,sa=
/^[^{]+\{\s*\[native \w/,db=/^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/,Ga=/[+~]/,S=RegExp("\\\\([\\da-f]{1,6}[\\x20\\t\\r\\n\\f]?|([\\x20\\t\\r\\n\\f])|.)","ig"),aa=function(a,b,c){a="0x"+b-65536;return a!==a||c?b:0>a?String.fromCharCode(a+65536):String.fromCharCode(a>>10|55296,a&1023|56320)},Ha=/([\0-\x1f\x7f]|^-?\d)|^-$|[^\0-\x1f\x7f-\uFFFF\w-]/g,Qa=function(a,b){return b?"\x00"===a?"\ufffd":a.slice(0,-1)+"\\"+a.charCodeAt(a.length-1).toString(16)+" ":"\\"+a},Ra=function(){U()},Sa=t(function(a){return!0===
a.disabled&&"fieldset"===a.nodeName.toLowerCase()},{dir:"parentNode",next:"legend"});try{ja.apply(ha=Ka.call(P.childNodes),P.childNodes),ha[P.childNodes.length].nodeType}catch(y){ja={apply:ha.length?function(a,b){Wa.apply(a,Ka.call(b))}:function(a,b){for(var c=a.length,d=0;a[c++]=b[d++];);a.length=c-1}}}F=b.support={};ba=b.isXML=function(a){return(a=a&&(a.ownerDocument||a).documentElement)?"HTML"!==a.nodeName:!1};U=b.setDocument=function(a){var b;a=a?a.ownerDocument||a:P;if(a===h||9!==a.nodeType||
!a.documentElement)return h;h=a;J=h.documentElement;M=!ba(h);P!==h&&(b=h.defaultView)&&b.top!==b&&(b.addEventListener?b.addEventListener("unload",Ra,!1):b.attachEvent&&b.attachEvent("onunload",Ra));F.attributes=e(function(a){a.className="i";return!a.getAttribute("className")});F.getElementsByTagName=e(function(a){a.appendChild(h.createComment(""));return!a.getElementsByTagName("*").length});F.getElementsByClassName=sa.test(h.getElementsByClassName);F.getById=e(function(a){J.appendChild(a).id=G;return!h.getElementsByName||
!h.getElementsByName(G).length});F.getById?(C.filter.ID=function(a){var b=a.replace(S,aa);return function(a){return a.getAttribute("id")===b}},C.find.ID=function(a,b){if("undefined"!==typeof b.getElementById&&M){var c=b.getElementById(a);return c?[c]:[]}}):(C.filter.ID=function(a){var b=a.replace(S,aa);return function(a){return(a="undefined"!==typeof a.getAttributeNode&&a.getAttributeNode("id"))&&a.value===b}},C.find.ID=function(a,b){if("undefined"!==typeof b.getElementById&&M){var c,d,e,f=b.getElementById(a);
...
function(a,b){if("undefined"!==typeof b.getElementsByClassName&&M)return b.getElementsByClassName(a)};R=[];I=[];if(F.qsa=sa.test(h.querySelectorAll))e(function(a){J.appendChild(a).innerHTML="<a id='"+G+"'></a><select id='"+G+"-\r\\' msallowcapture=''><option selected=''></option></select>";a.querySelectorAll("[msallowcapture^='']").length&&I.push("[*^$]=[\\x20\\t\\r\\n\\f]*(?:''|\"\")");a.querySelectorAll("[selected]").length||I.push("\\[[\\x20\\t\\r\\n\\f]*(?:value|checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped)");
...
I.push(":enabled",":disabled");J.appendChild(a).disabled=!0;2!==a.querySelectorAll(":disabled").length&&I.push(":enabled",":disabled");a.querySelectorAll("*,:x");I.push(",.*:")});(F.matchesSelector=sa.test(V=J.matches||J.webkitMatchesSelector||J.mozMatchesSelector||J.oMatchesSelector||J.msMatchesSelector))&&e(function(a){F.disconnectedMatch=V.call(a,"*");V.call(a,"[s!='']:x");R.push("!=",":((?:\\\\.|[\\w-]|[^\x00-\\xa0])+)(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|\\[[\\x20\\t\\r\\n\\f]*((?:\\\\.|[\\w-]|[^\x00-\\xa0])+)(?:[\\x20\\t\\r\\n\\f]*([*^$|!~]?=)[\\x20\\t\\r\\n\\f]*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|((?:\\\\.|[\\w-]|[^\x00-\\xa0])+))|)[\\x20\\t\\r\\n\\f]*\\])*)|.*)\\)|)")});
I=I.length&&new RegExp(I.join("|"));R=R.length&&new RegExp(R.join("|"));Q=(b=sa.test(J.compareDocumentPosition))||sa.test(J.contains)?function(a,b){var c=9===a.nodeType?a.documentElement:a,d=b&&b.parentNode;return a===d||!!(d&&1===d.nodeType&&(c.contains?c.contains(d):a.compareDocumentPosition&&a.compareDocumentPosition(d)&16))}:function(a,b){if(b)for(;b=b.parentNode;)if(b===a)return!0;return!1};xa=b?function(a,b){if(a===b)return W=!0,0;var c=!a.compareDocumentPosition-!b.compareDocumentPosition;
if(c)return c;c=(a.ownerDocument||a)===(b.ownerDocument||b)?a.compareDocumentPosition(b):1;return c&1||!F.sortDetached&&b.compareDocumentPosition(a)===c?a===h||a.ownerDocument===P&&Q(P,a)?-1:b===h||b.ownerDocument===P&&Q(P,b)?1:w?la(w,a)-la(w,b):0:c&4?-1:1}:function(a,b){if(a===b)return W=!0,0;var c,d=0;c=a.parentNode;var e=b.parentNode,f=[a],k=[b];if(!c||!e)return a===h?-1:b===h?1:c?-1:e?1:w?la(w,a)-la(w,b):0;if(c===e)return g(a,b);for(c=a;c=c.parentNode;)f.unshift(c);for(c=b;c=c.parentNode;)k.unshift(c);
for(;f[d]===k[d];)d++;return d?g(f[d],k[d]):f[d]===P?-1:k[d]===P?1:0};return h};b.matches=function(a,c){return b(a,null,null,c)};b.matchesSelector=function(a,c){(a.ownerDocument||a)!==h&&U(a);c=c.replace(Fa,"='$1']");if(!(!F.matchesSelector||!M||ca[c+" "]||R&&R.test(c)||I&&I.test(c)))try{var d=V.call(a,c);if(d||F.disconnectedMatch||a.document&&11!==a.document.nodeType)return d}catch(e){}return 0<b(c,h,null,[a]).length};b.contains=function(a,b){(a.ownerDocument||a)!==h&&U(a);return Q(a,b)};b.attr=
function(a,b){(a.ownerDocument||a)!==h&&U(a);var c=C.attrHandle[b.toLowerCase()],c=c&&Ea.call(C.attrHandle,b.toLowerCase())?c(a,b,!M):void 0;return void 0!==c?c:F.attributes||!M?a.getAttribute(b):(c=a.getAttributeNode(b))&&c.specified?c.value:null};b.escape=function(a){return(a+"").replace(Ha,Qa)};b.unescape=function(a){return(a+"").replace(S,aa)};b.error=function(a){throw Error("Syntax error, unrecognized expression: "+a);};b.uniqueSort=function(a){var b,c=[],d=0,e=0;W=!F.detectDuplicates;w=!F.sortStable&&
a.slice(0);a.sort(xa);if(W){for(;b=a[e++];)b===a[e]&&(d=c.push(e));for(;d--;)a.splice(c[d],1)}w=null;return a};K=b.getText=function(a){var b,c="",d=0;b=a.nodeType;if(!b)for(;b=a[d++];)c+=K(b);else if(1===b||9===b||11===b){if("string"===typeof a.textContent)return a.textContent;for(a=a.firstChild;a;a=a.nextSibling)c+=K(a)}else if(3===b||4===b)return a.nodeValue;return c};C=b.selectors={cacheLength:50,createPseudo:d,match:Aa,attrHandle:{},find:{},relative:{">":{dir:"parentNode",first:!0}," ":{dir:"parentNode"},
"+":{dir:"previousSibling",first:!0},"~":{dir:"previousSibling"}},preFilter:{ATTR:function(a){a[1]=a[1].replace(S,aa);a[3]=(a[3]||a[4]||a[5]||"").replace(S,aa);"~="===a[2]&&(a[3]=" "+a[3]+" ");return a.slice(0,4)},CHILD:function(a){a[1]=a[1].toLowerCase();"nth"===a[1].slice(0,3)?(a[3]||b.error(a[0]),a[4]=+(a[4]?a[5]+(a[6]||1):2*("even"===a[3]||"odd"===a[3])),a[5]=+(a[7]+a[8]||"odd"===a[3])):a[3]&&b.error(a[0]);return a},PSEUDO:function(a){var b,c=!a[6]&&a[2];if(Aa.CHILD.test(a[0]))return null;a[3]?
a[2]=a[4]||a[5]||"":c&&ab.test(c)&&(b=da(c,!0))&&(b=c.indexOf(")",c.length-b)-c.length)&&(a[0]=a[0].slice(0,b),a[2]=c.slice(0,b));return a.slice(0,3)}},filter:{TAG:function(a){var b=a.replace(S,aa).toLowerCase();return"*"===a?function(){return!0}:function(a){return a.nodeName&&a.nodeName.toLowerCase()===b}},CLASS:function(a){var b=Da[a+" "];return b||(b=new RegExp("(^|[\\x20\\t\\r\\n\\f])"+a+"([\\x20\\t\\r\\n\\f]|$)"),Da(a,function(a){return b.test("string"===typeof a.className&&a.className||"undefined"!==
...
function(b,c,h){var l,m,n,p,u;c=f!==g?"nextSibling":"previousSibling";var q=b.parentNode,r=k&&b.nodeName.toLowerCase();h=!h&&!k;l=!1;if(q){if(f){for(;c;){for(n=b;n=n[c];)if(k?n.nodeName.toLowerCase()===r:1===n.nodeType)return!1;u=c="only"===a&&!u&&"nextSibling"}return!0}u=[g?q.firstChild:q.lastChild];if(g&&h)for(n=q,m=n[G]||(n[G]={}),m=m[n.uniqueID]||(m[n.uniqueID]={}),l=m[a]||[],l=(p=l[0]===X&&l[1])&&l[2],n=p&&q.childNodes[p];n=++p&&n&&n[c]||(l=p=0)||u.pop();){if(1===n.nodeType&&++l&&n===b){m[a]=
[X,p,l];break}}else if(h&&(n=b,m=n[G]||(n[G]={}),m=m[n.uniqueID]||(m[n.uniqueID]={}),l=m[a]||[],l=p=l[0]===X&&l[1]),!1===l)for(;(n=++p&&n&&n[c]||(l=p=0)||u.pop())&&((k?n.nodeName.toLowerCase()!==r:1!==n.nodeType)||!++l||(h&&(m=n[G]||(n[G]={}),m=m[n.uniqueID]||(m[n.uniqueID]={}),m[a]=[X,l]),n!==b)););l-=e;return l===d||0===l%d&&0<=l/d}}},PSEUDO:function(a,c){var e,f=C.pseudos[a]||C.setFilters[a.toLowerCase()]||b.error("unsupported pseudo: "+a);return f[G]?f(c):1<f.length?(e=[a,a,"",c],C.setFilters.hasOwnProperty(a.toLowerCase())?
d(function(a,b){for(var d,e=f(a,c),g=e.length;g--;)d=la(a,e[g]),a[d]=!(b[d]=e[g])}):function(a){return f(a,0,e)}):f}},pseudos:{not:d(function(a){var b=[],c=[],e=O(a.replace(ma,"$1"));return e[G]?d(function(a,b,c,d){d=e(a,null,d,[]);for(var f=a.length;f--;)if(c=d[f])a[f]=!(b[f]=c)}):function(a,d,f){b[0]=a;e(b,null,f,c);b[0]=null;return!c.pop()}}),has:d(function(a){return function(c){return 0<b(a,c).length}}),contains:d(function(a){a=a.replace(S,aa);return function(b){return-1<(b.textContent||b.innerText||
K(b)).indexOf(a)}}),lang:d(function(a){bb.test(a||"")||b.error("unsupported lang: "+a);a=a.replace(S,aa).toLowerCase();return function(b){var c;do if(c=M?b.lang:b.getAttribute("xml:lang")||b.getAttribute("lang"))return c=c.toLowerCase(),c===a||0===c.indexOf(a+"-");while((b=b.parentNode)&&1===b.nodeType);return!1}}),target:function(b){var c=a.location&&a.location.hash;return c&&c.slice(1)===b.id},root:function(a){return a===J},focus:function(a){return a===h.activeElement&&(!h.hasFocus||h.hasFocus())&&
!!(a.type||a.href||~a.tabIndex)},enabled:m(!1),disabled:m(!0),checked:function(a){var b=a.nodeName.toLowerCase();return"input"===b&&!!a.checked||"option"===b&&!!a.selected},selected:function(a){a.parentNode&&a.parentNode.selectedIndex;return!0===a.selected},empty:function(a){for(a=a.firstChild;a;a=a.nextSibling)if(6>a.nodeType)return!1;return!0},parent:function(a){return!C.pseudos.empty(a)},header:function(a){return cb.test(a.nodeName)},input:function(a){return Xa.test(a.nodeName)},button:function(a){var b=
...
q.forEach(function(a,d){var e=z.indexOf(a);0<=e?(m(b[a],c[a],n,p,v,a,t),z=k(z,e)):n(new f(v,a))});z.forEach(function(a){n(new e(v,c[a]))})}--t.length}}else b!==c&&("number"===q&&isNaN(b)&&isNaN(c)||n(new d(v,b,c)))}function n(b,c,d,e){e=e||[];m(b,c,function(a){a&&e.push(a)},d);return e.length?e:a}function q(a,b,c){if(c.path&&c.path.length){b=a[b];var d,e=c.path.length-1;for(d=0;d<e;d++)b=b[c.path[d]];switch(c.kind){case "A":q(b[c.path[d]],c.index,c.item);break;case "D":delete b[c.path[d]];break;case "E":case "N":b[c.path[d]]=
c.rhs}}else switch(c.kind){case "A":q(a[b],c.index,c.item);break;case "D":a=k(a,b);break;case "E":case "N":a[b]=c.rhs}return a}function p(a,b,c){if(a&&b&&c&&c.kind){b=-1;for(var d=c.path?c.path.length-1:0;++b<d;)"undefined"===typeof a[c.path[b]]&&(a[c.path[b]]="number"===typeof c.path[b]?[]:{}),a=a[c.path[b]];switch(c.kind){case "A":q(c.path?a[c.path[b]]:a,c.index,c.item);break;case "D":delete a[c.path[b]];break;case "E":case "N":a[c.path[b]]=c.rhs}}}function r(a,b,c){if(c.path&&c.path.length){b=
a[b];var d,e=c.path.length-1;for(d=0;d<e;d++)b=b[c.path[d]];switch(c.kind){case "A":r(b[c.path[d]],c.index,c.item);break;case "D":b[c.path[d]]=c.lhs;break;case "E":b[c.path[d]]=c.lhs;break;case "N":delete b[c.path[d]]}}else switch(c.kind){case "A":r(a[b],c.index,c.item);break;case "D":a[b]=c.lhs;break;case "E":a[b]=c.lhs;break;case "N":a=k(a,b)}return a}var t,v,z=[];t="object"===typeof global&&global?global:"undefined"!==typeof window?window:{};(v=t.DeepDiff)&&z.push(function(){"undefined"!==typeof v&&
t.DeepDiff===n&&(t.DeepDiff=v,v=a)});b(d,c);b(e,c);b(f,c);b(g,c);Object.defineProperties(n,{diff:{value:n,enumerable:!0},observableDiff:{value:m,enumerable:!0},applyDiff:{value:function(a,b,c){a&&b&&m(a,b,function(d){c&&!c(a,b,d)||p(a,b,d)})},enumerable:!0},applyChange:{value:p,enumerable:!0},revertChange:{value:function(a,b,c){if(a&&b&&c&&c.kind){var d;d=c.path.length-1;for(b=0;b<d;b++)"undefined"===typeof a[c.path[b]]&&(a[c.path[b]]={}),a=a[c.path[b]];switch(c.kind){case "A":r(a[c.path[b]],c.index,
...
(function(a){var b={vertical:{x:!1,y:!0},horizontal:{x:!0,y:!1},both:{x:!0,y:!0},x:{x:!0,y:!1},y:{x:!1,y:!0}},c={duration:"fast",direction:"both"},d=/^(?:html)$/i,e=function(b){var c=a(window),e=d.test(b[0].nodeName),f;if(e)f={top:0,left:0,bottom:0,right:0};else{var n=b[0],q;q=document.defaultView&&document.defaultView.getComputedStyle?document.defaultView.getComputedStyle(n,null):n.currentStyle;var p=document.defaultView&&document.defaultView.getComputedStyle?!0:!1;f=parseFloat(p?q.borderTopWidth:
a.css(n,"borderTopWidth"))||0;var r=parseFloat(p?q.borderLeftWidth:a.css(n,"borderLeftWidth"))||0,t=parseFloat(p?q.borderBottomWidth:a.css(n,"borderBottomWidth"))||0,n=parseFloat(p?q.borderRightWidth:a.css(n,"borderRightWidth"))||0;f={top:f,left:r,bottom:t,right:n,vertical:f+t,horizontal:r+n}}c={top:(e?c:b).scrollTop(),left:(e?c:b).scrollLeft()};r={right:e?0:b.innerWidth()-b[0].clientWidth,bottom:e?0:b.innerHeight()-b[0].clientHeight};t=b[0].getBoundingClientRect();return{border:f,scroll:c,scrollbar:r,
rect:{top:e?0:t.top,left:e?0:t.left,bottom:e?b[0].clientHeight:t.bottom,right:e?b[0].clientWidth:t.right}}};a.fn.extend({scrollintoview:function(f){f=a.extend({},c,f);f.direction=b["string"===typeof f.direction&&f.direction.toLowerCase()]||b.both;var k="";!0===f.direction.x&&(k="horizontal");!0===f.direction.y&&(k=k?"both":"vertical");var l=this.eq(0),m=l.closest(":scrollable("+k+")");if(0<m.length){var m=m.eq(0),n=e(l),k=e(m),l=n.rect.top-(k.rect.top+k.border.top),q=k.rect.bottom-k.border.bottom-
k.scrollbar.bottom-n.rect.bottom,p=n.rect.left-(k.rect.left+k.border.left),n=k.rect.right-k.border.right-k.scrollbar.right-n.rect.right,r={};!0===f.direction.y&&(0>l?r.scrollTop=k.scroll.top+l:0<l&&0>q&&(r.scrollTop=k.scroll.top+Math.min(l,-q)));!0===f.direction.x&&(0>p?r.scrollLeft=k.scroll.left+p:0<p&&0>n&&(r.scrollLeft=k.scroll.left+Math.min(p,-n)));a.isEmptyObject(r)?a.isFunction(f.complete)&&f.complete.call(m[0]):(d.test(m[0].nodeName)&&(m=a("html,body")),m.animate(r,f.duration).eq(0).queue(function(b){a.isFunction(f.complete)&&
f.complete.call(m[0]);b()}))}return this}});var f={auto:!0,scroll:!0,visible:!1,hidden:!1};a.extend(a.expr[":"],{scrollable:function(a,c,e,m){c=b["string"===typeof e[3]&&e[3].toLowerCase()]||b.both;e=document.defaultView&&document.defaultView.getComputedStyle?document.defaultView.getComputedStyle(a,null):a.currentStyle;var n=f[e.overflowX.toLowerCase()]||!1,q=f[e.overflowY.toLowerCase()]||!1,p=d.test(a.nodeName);if(!n&&!q&&!p)return!1;a={height:{scroll:a.scrollHeight,client:a.clientHeight},width:{scroll:a.scrollWidth,
client:a.clientWidth},scrollableX:function(){return(n||p)&&this.width.scroll>this.width.client},scrollableY:function(){return(q||p)&&this.height.scroll>this.height.client}};return c.y&&a.scrollableY()||c.x&&a.scrollableX()}})})(jQuery);
"undefined"==typeof JooseX||JooseX.SimpleRequest||Class("JooseX.SimpleRequest",{have:{req:null},methods:{initialize:function(){this.req=window.XMLHttpRequest?new XMLHttpRequest:new ActiveXObject("Microsoft.XMLHTTP")},getText:function(a,b,c,d){var e=this.req,f,g;"string"!=typeof a?(f=a.headers,g=a.url,b=b||a.async,c=c||a.callback,d=d||a.scope):g=a;e.open("GET",g,b||!1);f&&Joose.O.eachOwn(f,function(a,b){e.setRequestHeader(b,a)});try{e.onreadystatechange=function(a){b&&4==e.readyState&&(200==e.status||
...
Role("Siesta.Util.Role.CanInstallCQRootPseudo",{methods:{installRootPseudoCQ:function(a){if(a){var b=a.ComponentQuery;if(b){var c=b.pseudos;if(!c.root||!c.root.__IS_ROOT_PSEUDO_OVERRIDE__){var d=function(a,b){var c=0,d=a.length,e,n=[],q=void 0===b;for(q||(b=Number(b)-1);c<d;c++)(e=a[c].up())&&e.contains&&e.contains(a[c])||n.push(a[c]);q||(n=n[b]?[n[b]]:[]);return n};d.__IS_ROOT_PSEUDO_OVERRIDE__=!0;c.root=d}c["ariadne-nth-child"]||(c["ariadne-nth-child"]=function(a,b){for(var c=[],d=Number(b)-1,e=
a.length,n=0;n<e;n++){var q=a[n],p=q.getRefOwner&&q.getRefOwner()||q.ownerCt,r=p&&p.items;if(r&&r.getCount){var t=r.getCount();d<t?r.getAt(d)===q&&c.push(q):p.getRefItems()[d]===q&&c.push(q)}}return c});if((c=a.getVersion&&a.getVersion("ext"))&&4==c.major&&!b.__CQ4_PATCHED__){a.dom.Query.operators["="]=function(a,b){return a==Siesta.Sizzle.unescape(b)};var e=b.query;b.query=function(a,b){return/\\,/.test(a)?e.call(this,{split:function(){return[a]}},b):e.call(this,a,b)};b.__CQ4_PATCHED__=!0}}}}}});
...
t=Math.min(m-l,e)||1;l<=m;l+=t){var v=g[l],z=b.elementFromPoint(v[0],v[1],!1,null,!0),x=z.el;if(x){var u=z.localXY[0],A=z.localXY[1];x!==d&&(b.onElementAtCursorChanged(x,d,u,A,f),d=x);a.onPointerMove(x,$.extend({clientX:u,clientY:A},f),l<m)}}if(v&&(z=b.elementFromPoint(v[0],v[1],!1,null,!0),z.el&&z.el!==d))b.onElementAtCursorChanged(z.el,d,u,A,f)}}),l=g.length;if(l<=c&&e>=c)k.addStep({sourceIndex:0,targetIndex:Math.min(1,l-1)}),3<=l&&k.addStep({sourceIndex:l-2,targetIndex:l-1});else for(var m=0;m<
...
!1,a.el),n=m.parentNode,q=!1,p=new Siesta.Util.Queue({deferer:this.test.originalSetTimeout,deferClearer:this.test.originalClearTimeout,interval:10,callbackDelay:d.afterActionDelay,observeTest:this.test,processor:function(a){if(!d.lastPointerDownPrevented||!/mouse/i.test(a.event)){var c=k.body?d.getPageScrollY()-l:0,p=g?m:d.elementFromPoint(e,f-c,!1,m),z=p;!g&&a.recaptureTarget&&(m=p,q=!1);g||p===m||$.contains(p,m)||$.contains(m,p)||(q=!0);if(!g&&"click"===a.event){if(p===m&&p.parentNode!==n||d.nodeIsOrphan(m)||
d.lastMouseDownEl&&d.nodeIsOrphan(d.lastMouseDownEl))return;var x;!d.lastMouseDownEl||p===d.lastMouseDownEl||$.contains(p,d.lastMouseDownEl)||$.contains(d.lastMouseDownEl,p)?d.lastMouseUpEl&&d.lastMouseUpEl!==p&&!$.contains(p,d.lastMouseUpEl)&&(x=!0,z=d.getCommonAncestor(p,d.lastMouseUpEl)):(x=!0,z=d.getCommonAncestor(p,d.lastMouseDownEl));if(x&&(d.bowser.gecko||d.bowser.safari||!z))return}if(!q||!a.cancelIfTargetChanged)if(z=d.simulateEvent(z,a.event,b),!d.lastPointerDownPrevented&&a.focus&&d.mimicFocusOnMouseDown(p,
...
l?b:f[g]||"";c.code=f[g];var f=this.isTextInput(a),n=this.isEditableNode(a),q=f||n,p="value"in a?"value":"innerHTML",r=a[p].length,t=this.simulateEvent(a,"keydown",Joose.O.extend({charCode:0,keyCode:g},c)),v=this.isEventPrevented(t);if(!q||!this.mimicTextSelection(t,a)){var z=!1,t=Siesta.Project.Browser.FeatureSupport().supports;a=this.activeElement(!0,a,a);d||v||(m=this.simulateEvent(a,"keypress",Joose.O.extend({charCode:m,keyCode:l?0:g},c)),(z=this.isEventPrevented(m))||g!==e.TAB||(a=this.emulateTab(a,
c.shiftKey?-1:1)||a));!v&&q&&g!=e.TAB&&(!l||d||z?this.mimicCaretMovement(a,g):(n&&bowser.msie&&(d=a.innerHTML,0===d.indexOf("&nbsp;")?(a.innerHTML=d.substring(6),r=a.innerHTML.length):0===d.indexOf("<br>")&&(a.innerHTML=d.substring(4),r=a.innerHTML.length)),n&&!bowser.msie?(d=a.innerHTML,8203===d.charCodeAt(d.length-1)&&(a.innerHTML=d.substring(0,d.length-1)),a.ownerDocument.execCommand("insertText",!1,c.readableKey)):this.simulateEvent(a,bowser.msie?"textinput":"textInput",{text:c.readableKey}),
this.mimicCharacterInsertion(a,b,c,r)),(g===e.BACKSPACE||g===e.DELETE)&&!t.canSimulateBackspace&&0<a[p].length&&this.mimicCharacterDeletion(a,g,c),"value"!==p||g!==e.ENTER||z||(f&&this.maybeMimicChangeEvent(k),t.enterSubmitsForm||this.mimicFormSubmit(a)))}this.mimicClickOnEnter(a,g);this.simulateEvent(a,"keyup",$.extend({charCode:0,keyCode:g},c));return Promise.resolve()},mimicCharacterInsertion:function(a,b,c,d){var e="value"in a?"value":"innerHTML",f=a.getAttribute("maxlength")||Infinity,g=this.isTextInput(a),
...
interval:30,observeTest:this.test}),e,f,g=a.localXY[0]-b.localXY[0],k=a.localXY[1]-b.localXY[1],l=Math.sqrt(g*g+k*k);1>l&&(l=1);var l=(l*scale-l)/2,g=Math.atan(k/g),m=Math.round(a.localXY[0]-l*Math.cos(g)),n=Math.round(a.localXY[1]-l*Math.sin(g)),q=Math.round(b.localXY[0]+l*Math.cos(g)),p=Math.round(b.localXY[1]+l*Math.sin(g)),r=Joose.O.extend({},c);d.addStep({processor:function(){e=me.touchStart(null,null,c,a);f=me.touchStart(null,null,r,b)}});d.addAsyncStep({processor:function(a){var b=!1,d=!1;
me.touchMove(e,m,n,function(){(b=!0,d)&&a.next()},null,c);me.touchMove(f,q,p,function(){d=!0;b&&d&&a.next()},null,r)}});d.addStep({processor:function(){me.touchEnd(e,c);me.touchEnd(f,r)}});return new Promise(function(a,b){d.run(a)})},simulateTouchDrag:function(a,b,c,d){var e=this;c=c||{};e.elementFromPoint(a[0],a[1],!0);e.elementFromPoint(b[0],b[1],!0);var f=new Siesta.Util.Queue({deferer:this.test.originalSetTimeout,deferClearer:this.test.originalClearTimeout,interval:e.dragDelay,callbackDelay:e.afterActionDelay,
...
!1,!0);this.suppressPassedWaitForAssertion=!0;"function"===typeof b?(d=b,e=c,c=""):"function"===typeof c&&(d=c,c="");b="number"===typeof b?b:30;var g=this.global,k=a==g.document.body,l=this,m=l.$(a).offset(),n=m.left+l.$(k?g:a).width(),q=m.top+l.$(k?g:a).height(),p=[],r=Siesta.Resource("Siesta.Test.Element"),t=new Siesta.Util.Queue({deferer:l.originalSetTimeout,deferClearer:l.originalClearTimeout,interval:50,observeTest:this,processor:function(a){if(l.nbrExceptions||l.failed)x(),t.abort();else{var b=
l.beginAsync(null,function(a){a.fail(c||r.get("monkeyNoExceptions"),r.get("monkeyActionLog")+":"+JSON.stringify(p));return!0}),d=a.next;a.next=function(){f&&f(a);l.endAsync(b);d()};a.action(a)}}});a=[];a.length=b;var v=function(a,b){var c=l.normalizeElement(a.dragFrom||a.xy),d=a.dragTo&&l.normalizeElement(a.dragTo);return c&&("a"==c.tagName.toLowerCase()||0<$(c).closest("a").length)||d&&("a"==d.tagName.toLowerCase()||0<$(d).closest("a").length)?(a.next(),!0):!1};Joose.A.each(a,function(a,b){t.addAsyncStep({action:function(a){l.waitForSelector("body",
a.next)}});var c=[l.randomBetween(m.left,n),l.randomBetween(m.top,q)];switch(l.randomBetween(0,4)){case 0:t.addAsyncStep({action:function(a){v(a)||(p.push({click:c}),l.click(a.xy,a.next))},xy:c});break;case 1:t.addAsyncStep({action:function(a){v(a)||(p.push({doubleclick:c}),l.doubleClick(a.xy,a.next))},xy:c});break;case 2:t.addAsyncStep({action:function(a){"native"!=l.simulator.type&&"oncontextmenu"in window?(p.push({rightclick:c}),l.rightClick(a.xy,a.next)):v(a)||(p.push({click:c}),l.click(a.xy,
a.next))},xy:c});break;case 3:var d=[l.randomBetween(m.left,n),l.randomBetween(m.top,q)];t.addAsyncStep({action:function(a){v(a)||(p.push({action:"drag",target:c,to:d}),l.dragTo(a.dragFrom,a.dragTo,a.next))},dragFrom:c,dragTo:d});break;case 4:var e=l.getRandomTypeString(15);t.addAsyncStep({action:function(a){v(a)||(p.push({click:c}),l.click(a.xy,function(){l.waitForSelector("body",function(){p.push({type:e.replace("'","\\'")});l.type(null,e,a.next)})}))},xy:c})}});var z=!1,x=function(){z=!0;l.nbrExceptions||
l.failed?l.fail(c||r.get("monkeyNoExceptions"),r.get("monkeyActionLog")+":"+JSON.stringify(p)):l.pass(c||r.get("monkeyNoExceptions"))};this.on("beforetestfinalizeearly",x);t.run(function(){z||(l.un("beforetestfinalizeearly",x),x());this.suppressPassedWaitForAssertion=!1;l.processCallbackFromTest(d,[p],e||l)})},hasCls:function(a,b,c){var d=Siesta.Resource("Siesta.Test.Element");a=this.normalizeElement(a);this.$(a).hasClass(b)?this.pass(c,{descTpl:d.get("elementHasClass")+" {cls}",cls:b}):this.fail(c,
...
firesOk:function(a,b,c,d,e,f,g){var k=this,l=k.getSourceLine(),m=Siesta.Resource("Siesta.Test.Browser"),n=arguments.length,q;if(1==n)q=a.observable,b=a.events,n=a.during,f=a.desc||a.description,g=a.callback,d="Number"==this.typeOf(n)?n:null,e="Function"==this.typeOf(n)?n:null;else if(5<=n)q=a,"String"==this.typeOf(b)&&(n={},n[b]=c,b=n);else if(3>=n&&"Object"==this.typeOf(b))q=a,f=c;else if(4>=n&&"String"==this.typeOf(b))q=a,n={},n[b]=c,b=n,f=d,d=null;else throw Error(m.get("unrecognizedSignature"));
var p={},r={};Joose.O.each(b,function(a,b){p[b]=0;var c=r[b]=function(){p[b]++};k.addListenerToObservable(q,b,c)});var t=function(){Joose.O.each(b,function(a,b){k.removeListenerFromObservable(q,b,r[b]);var c=p[b];k.verifyExpectedNumber(c,a)?k.pass(f,{descTpl:m.get("observableFired")+" "+c+" `"+b+"` "+m.get("events")}):k.fail(f,{assertionName:"firesOk",sourceLine:l,descTpl:m.get("observableFiredOk")+" `"+b+"` "+m.get("events"),got:c,gotDesc:m.get("actualNbrEvents"),need:a,needDesc:m.get("expectedNbrEvents")})})};
...
("function"==typeof g||d.isPrimitive(g))){var z;a:{for(var x=c+"."+f,u=0;u<k.length;u++)if(k[u].test(x)){z=!0;break a}z=!1}z||e.push(c+"."+f)}}}catch(A){}return e};c.waitFor(function(){return f.Ext&&f.Ext.isReady},function(){var b=c.global,k=[];d.iterate(d.ClassManager.classes,function(a){if(a.match(/^Ext\./)){var c=g(f,a),d=g(b,a);if(c&&"undefined"!==typeof d){var e=l(c,d,a);k.push.apply(k,e);d.prototype&&(a=l(c.prototype,d.prototype,a+".prototype"),k.push.apply(k,a))}}});c.globalExtOverrides=k;
...
b,c,d){var e=this,f=function(d,l,m,n,q){var p=d.items;if(!p.length||c.needToStop)g(a);else{var r=p.shift(),p=0<p.length;l?e.processURL(r,r.index,b,c,function(a){f(d,!1,e.scopesByURL[r.url],r,a)},p,d):e.processUrlShared(r,r.index,b,c,function(){f(d,!1,m,n,q)},p,d,m,n,q)}},g=function(a){!a.length||c.needToStop?d():(a=a.shift(),f(a,!0))};g(a)},processUrlShared:function(a,b,c,d,e,f,g,k,l,m){function n(){function b(){q.launchTest({testHolder:m,desc:a,scopeProvider:k,contentManager:c,launchState:d,preloadErrors:p,
startTestAnchor:k.scope.StartTest,noCleanup:f,cleanupUrl:l.url,reusingSandbox:!0},e)}if(k.scope){var n=q.getDescriptorConfig(a,"testClass");"String"==q.typeOf(n)&&(n=Joose.S.strToClass(n));var v=q.getNewTestConfiguration(a,k,c,d,g);(m.test=new n(v)).earlySetup(function(){b()},function(a){p.push({isException:!1,message:a});b()})}else e()}var q=this;if(a.isMissing)e();else{var p=[];this.getDescriptorConfig(a,"transparentEx");delete k.scope.describe.called;a.testCode||this.cachePreload&&c.hasContentOf(a.url)?
...
css:"keyword"}];this.forHtmlScript(a.scriptScriptTags)}a.prototype=new SyntaxHighlighter.Highlighter;a.aliases=["js","jscript","javascript"];SyntaxHighlighter.brushes.JScript=a;"undefined"!=typeof exports?exports.Brush=a:null})();$jscomp={scope:{}};$jscomp.defineProperty="function"==typeof Object.defineProperties?Object.defineProperty:function(a,b,c){if(c.get||c.set)throw new TypeError("ES3 does not support getters and setters.");a!=Array.prototype&&a!=Object.prototype&&(a[b]=c.value)};
...
$jscomp.polyfill("Math.hypot",function(a){return a?a:function(a,c,d){a=Number(a);c=Number(c);var e,f,g,k=Math.max(Math.abs(a),Math.abs(c));for(e=2;e<arguments.length;e++)k=Math.max(k,Math.abs(arguments[e]));if(1E100<k||1E-100>k){a/=k;c/=k;g=a*a+c*c;for(e=2;e<arguments.length;e++)f=Number(arguments[e])/k,g+=f*f;return Math.sqrt(g)*k}g=a*a+c*c;for(e=2;e<arguments.length;e++)f=Number(arguments[e]),g+=f*f;return Math.sqrt(g)}},"es6-impl","es3");
...
a[b]=null;this.onSettledCallbacks_=null}};var e=new b;d.prototype.settleSameAsPromise_=function(a){var b=this.createResolveAndReject_();a.callWhenSettled_(b.resolve,b.reject)};d.prototype.settleSameAsThenable_=function(a,b){var c=this.createResolveAndReject_();try{a.call(b,c.resolve,c.reject)}catch(d){c.reject(d)}};d.prototype.then=function(a,b){function c(a,b){return"function"==typeof a?function(b){try{e(a(b))}catch(c){m(c)}}:b}var e,m,n=new d(function(a,b){e=a;m=b});this.callWhenSettled_(c(a,e),
c(b,m));return n};d.prototype["catch"]=function(a){return this.then(void 0,a)};d.prototype.callWhenSettled_=function(a,b){function c(){switch(d.state_){case 1:a(d.result_);break;case 2:b(d.result_);break;default:throw Error("Unexpected state: "+d.state_);}}var d=this;null==this.onSettledCallbacks_?e.asyncExecute(c):this.onSettledCallbacks_.push(function(){e.asyncExecute(c)})};d.resolve=function(a){return a instanceof d?a:new d(function(b,c){b(a)})};d.reject=function(a){return new d(function(b,c){c(a)})};
d.race=function(a){return new d(function(b,c){for(var e=$jscomp.makeIterator(a),m=e.next();!m.done;m=e.next())d.resolve(m.value).callWhenSettled_(b,c)})};d.all=function(a){var b=$jscomp.makeIterator(a),c=b.next();return c.done?d.resolve([]):new d(function(a,e){function f(b){return function(c){q[b]=c;p--;0==p&&a(q)}}var q=[],p=0;do q.push(void 0),p++,d.resolve(c.value).callWhenSettled_(f(q.length-1),e),c=b.next();while(!c.done)})};$jscomp.EXPOSE_ASYNC_EXECUTOR&&(d.$jscomp$new$AsyncExecutor=function(){return new b});
...
function(a){return this.map_.has(a)};b.prototype["delete"]=function(a){return this.map_["delete"](a)};return b},"es6-impl","es3");try{-1==Array.prototype.values.toString().indexOf("[native code]")&&delete Array.prototype.values}catch(a){}
...
Ext.define("Siesta.Project.Browser.UI.CanCopyToClipboard",{copyToClipboard:function(a){var b=this.getCopyToClipboardTextarea();b.value=a;b.focus();b.select();try{var c=document.execCommand("copy")}catch(d){}return c},getCopyToClipboardTextarea:function(){var a=document.getElementById("fa-copy-to-clipboard");a||(a=document.createElement("textarea"),a.id="fa-copy-to-clipboard",a.style.position="absolute",a.style.left="-10000px",a.style.top="-10000px",document.body.appendChild(a));return a}});
Ext.define("Siesta.Project.Browser.UI.ComponentInspector",{extend:Ext.util.Observable,inspectedComponent:null,inspectedComponentXType:null,boxIndicatorEl:null,active:!1,window:null,trackMouse:!0,showSelectorText:!0,bufferTime:30,injectIntoTestFrame:!1,getIndicatorEl:function(){return this.boxIndicatorEl},getExt:function(){return this.window.Ext},start:function(a,b){a=a||this.window;if(!a)throw"Must provide a window context for the inspector";this.window=a;var c=this.getExt(),d=this.injectIntoTestFrame?
a.document.body:b||a.document.body;this.boxIndicatorEl=this.boxIndicatorEl||Ext.fly(d).createChild({cls:"target-inspector-box",style:"position : absolute;left:0;top:0;pointer-events : none;z-index : 100001; border : 2px solid red;transition-property : transform,border-color;transition-duration : 0.3s;",children:[{tag:"div",style:"border:1px solid;border-color:inherit;width : 13px; height : 13px;position : absolute;margin-top : -8px;margin-left : -8px;border-radius:19px;transition-property : transform;transition-duration : 0.3s;box-sizing: border-box;-moz-box-sizing: border-box;-ms-box-sizing: border-box;-webkit-box-sizing: border-box;",
cls:"target-inspector-coordinate",html:'<div style="border-left: 1px solid;border-color:inherit;position: absolute;top: -3px;left: 5px;height: 6px;box-sizing: border-box;-moz-box-sizing: border-box;-ms-box-sizing: border-box;-webkit-box-sizing: border-box;"></div><div style="border-left: 1px solid;border-color:inherit;position: absolute;bottom: -3px;left: 5px;height: 6px;box-sizing: border-box;-moz-box-sizing: border-box;-ms-box-sizing: border-box;-webkit-box-sizing: border-box;"></div><div style="border-top: 1px solid;border-color:inherit;position: absolute;top: 5px;left: -3px;width: 6px;box-sizing: border-box;-moz-box-sizing: border-box;-ms-box-sizing: border-box;-webkit-box-sizing: border-box;"></div><div style="border-top: 1px solid;border-color:inherit;position: absolute;top: 5px;right: -3px;width: 6px;box-sizing: border-box;-moz-box-sizing: border-box;-ms-box-sizing: border-box;-webkit-box-sizing: border-box;"></div>'}].concat(this.showSelectorText?
...
d=this.filterField,e,f,g=this.filterGroups;if(g)e=c.splitTermByPipe(b);else{var k=c.parseFilterValue(b);e=k.testFilterRegexps;f=k.groupFilterRegexps}var l=this.andChecker,m=this.andCheckerScope||this,n=function(a){return a.get(d)};this.store.filterTreeBy({filter:function(a){return l&&!l.call(m,a)?!1:c.checkCommonFilter(a,n,e,f)},fullMatchingParents:g})}else this.store.clearTreeFilter()}});
...
Ext.define("Siesta.Project.Browser.UI.DomContainer",{extend:Ext.Panel,alias:"widget.domcontainer",cls:"siesta-domcontainer",header:!1,collapsible:!0,animCollapse:!1,padding:10,test:null,testListeners:null,scaleToFit:!0,scaleToFitMode:"full",maintainViewportSize:!0,canManageDOM:!0,suspendAfterLayoutAlign:!1,inspector:null,inspectorConfig:null,enableConsole:!0,trackMouse:!0,initComponent:function(){this.testListeners=[];this.title=Siesta.Resource("Siesta.Project.Browser.UI.DomContainer","title");this.enableConsole&&
Ext.apply(this,{dockedItems:this.consoleCt={xtype:"component",dock:"bottom",hidden:!0,height:20,cls:"domcontainer-console",renderTpl:'<div><input type="text" /></div>'}});this.callParent();this.on({afterlayout:this.onAfterLayout,expand:this.onExpand,collapse:this.onCollapse,scope:this});this.inspector=new Siesta.Project.Browser.UI.ComponentInspector(this.inspectorConfig);if(this.trackMouse)this.inspector.on({start:this.onInspectionStart,stop:this.onInspectionStop,scope:this});this.relayEvents(this.inspector,
["start","stop"],"inspection");this.enableBubble("statechange")},afterRender:function(){this.callParent(arguments);if(this.enableConsole){var a=this.consoleInput=this.el.down(".domcontainer-console input");this.inspector.on("targethover",function(b,c){a.dom.value='Ext.getCmp("'+c.id+'").'});this.inspector.on("targetselected",function(b,c){a.focus(!0)});a.on({keyup:function(b,c){var d=a.dom.value;if(b.getKey()===b.ENTER&&d){var e=this.getIFrame();try{var f=e.contentWindow.eval(d);window.console&&console.log(f)}catch(g){window.console&&
console.log(g.message)}}},scope:this})}},setScaleToFit:function(a,b){if(this.scaleToFit!=a||b&&this.scaleToFitMode!=b)this.scaleToFit=a,b&&(this.scaleToFitMode=b),a?this.doScaleToFit():this.undoScaleToFit(),this.fireEvent("statechange")},doScaleToFit:function(a){var b=this.getIFrame();if(b){var c=this.scaleToFitMode,d=Ext.getScrollbarSize(),e=b.parentNode,f=e.parentNode,g=f.parentNode,k=this.body.dom.offsetWidth-("width"===c?d.width:0),l=this.body.dom.offsetHeight-("height"===c?d.height:0),d=b.offsetWidth,
b=b.offsetHeight,m=k/d,n=l/b,m="width"===c?m:"height"===c?n:Math.min(m,n),k=Math.max(0,(k-m*d)/2),l=Math.max(0,(l-m*b)/2);e.style.transition=a?"none":"transform 0.3s";e.style.transform="translate("+k+"px, "+l+"px) scale("+m+") ";f.style.width=m*d+"px";f.style.height=m*b+"px";this.removeScaleToFitClasses(g);Ext.fly(g).addCls("scaleToFit"+Joose.S.uppercaseFirst(c));this.scrollTo(0,0);a=this.test.scopeProvider.minViewportSize;e.style.width=a.width+"px";e.style.height=a.height+"px"}},removeScaleToFitClasses:function(a){Ext.fly(a).removeCls("scaleToFitFull");
Ext.fly(a).removeCls("scaleToFitWidth");Ext.fly(a).removeCls("scaleToFitHeight")},undoScaleToFit:function(){var a=this.getIFrame();if(a){var b=a.parentNode,c=b.parentNode;this.removeScaleToFitClasses(c.parentNode);b.style.transform="";b.style.width=a.style.width;b.style.height=a.style.height;b.style.left="";b.style.top="";c.style.width=a.style.width;c.style.height=a.style.height}},setCanManageDOM:function(a){(this.canManageDOM=a)&&!this.hidden&&this.alignIFrame()},getIFrameWrapper:function(a){var b=
this.test;return b?(this.canManageDOM||a)&&b.scopeProvider&&b.scopeProvider.wrapper||null:null},getIFrame:function(a){var b=this.test;return b?(this.canManageDOM||a)&&b.scopeProvider&&b.scopeProvider.iframe||null:null},onAfterLayout:function(){this.suspendAfterLayoutAlign||this.alignIFrame()},alignIFrame:function(a,b){var c=this.getIFrameWrapper(a);if(this.isFrameVisible()&&c){Ext.fly(c).removeCls("tr-iframe-hidden");Ext.fly(c).removeCls("tr-iframe-forced");var d=this.body.getBox();Ext.fly(c).setBox(d);
this.maintainViewportSize||Ext.fly(this.getIFrame(a)).setSize(this.body.getSize());this.scaleToFit?this.doScaleToFit(b):this.undoScaleToFit();(c=this.test)&&c.fireEvent("testframeshow")}},onCollapse:function(){this.hideIFrame()},onExpand:function(){this.alignIFrame()},hideIFrame:function(){var a=this.getIFrameWrapper();a&&Ext.fly(a).setStyle({left:"-10000px",top:"-10000px"});(a=this.test)&&a.fireEvent("testframehide")},isFrameVisible:function(){return!(this.hidden||this.collapsed)},showTest:function(a){this.stopInspection();
this.test&&(Joose.A.each(this.testListeners,function(a){a.remove()}),this.testListeners=[],this.hideIFrame());this.test=a;this.testListeners=[a.on("testfinalize",this.onTestFinalize,this)];this.setCanManageDOM(!a.hasForcedIframe());this.alignIFrame(!1,!0)},onTestFinalize:function(a,b){this.setCanManageDOM(!0);this.isFrameVisible()&&(b.forceDOMVisible=!1,b.isDOMForced=!1)},destroy:function(){Ext.destroy(this.boxIndicator);this.boxIndicator=null;this.hideIFrame();Joose.A.each(this.testListeners,function(a){a.remove()});
this.test=null;this.callParent(arguments)},inspectedComponent:null,inspectedComponentXType:null,boxIndicator:null,inspecting:!1,toggleInspectionMode:function(a){this.test&&(a?this.startInspection():this.stopInspection())},startInspection:function(a){if(this.test&&this.test.global){var b=Ext.get(this.getIFrameWrapper());this.inspector.start(this.test.global,b.down(".tr-iframe-wrapper-inner",!0));this.trackMouse&&(b.un("mouseout",this.onMouseLeave,this),b.on("mouseout",this.onMouseLeave,this));this.enableConsole&&
!1!==a&&(this.consoleCt instanceof Ext.Component||(this.consoleCt=Ext.widget(this.consoleCt)),this.consoleCt.show());this.addCls("inspection-mode")}},stopInspection:function(){this.inspector.stop();this.removeCls("inspection-mode");this.enableConsole&&this.consoleCt.rendered&&this.consoleCt.hide()},onMouseLeave:function(a,b){this.el.contains(a.relatedTarget)||Ext.fly(this.getIFrameWrapper()).contains(a.relatedTarget)||this.stopInspection()},onInspectionStart:function(){var a=Ext.get(this.getIFrameWrapper());
if(a)a.on("mouseout",this.onMouseLeave,this)},onInspectionStop:function(){var a=Ext.get(this.getIFrameWrapper());a&&a.un("mouseout",this.onMouseLeave,this)},clearHighlight:function(){this.stopInspection()},highlightTarget:function(a,b,c){var d=a instanceof Array;this.inspector.active||this.startInspection();d?(c=a,a=null):(a=this.test.normalizeElement(a,!0,!0,!1))&&(a.offsetWidth||a.offsetHeight?c&&(c=this.test.normalizeOffset(c,$(a))):a=c=null);this.inspector.highlightTarget(a,b,c)}});Ext.XTemplate.override({strict:!0});
...
this.sourceButton&&this.sourceButton.enable();var d=a.url;Ext.suspendLayouts();this.slots.grid.showTest(a,b);this.slots.domContainer.showTest(a,b);!c||c.test&&a.url===c.test.url||(c.stop(),c.attachTo(a));this.setTestTitle("/"===d?c.getRecordingName():d);Ext.resumeLayouts();this.test=a},setTestTitle:function(a){this.testTitle.setText(a)},onAssertionFilterClick:function(a){var b=this.slots.grid,c=b.store;c.filterTreeBy&&(a.pressed?(b.addCls("assertiongrid-filtered"),c.filterTreeBy(function(a){a=a.getResult();
return!1===a.passed&&!a.isTodo})):(b.removeCls("assertiongrid-filtered"),c.clearTreeFilter()))},alignIFrame:function(){this.slots.domContainer.alignIFrame()},hideIFrame:function(){this.slots.domContainer.hideIFrame()},setInitializing:function(a){this.slots.grid.setInitializing(a)},onAssertionDoubleClick:function(a,b){var c=b.getResult();c instanceof Siesta.Result.Assertion&&!c.isPassed(!0)&&this.showSource(c.sourceLine)},toggleComponentInspectionMode:function(a){this.slots.domContainer.toggleInspectionMode(a.pressed)},
onRecorderClick:function(){var a=this.slots.cardContainer;this.recorderPanel||(this.recorderPanel=Ext.create(this.recorderPanelClass,{slot:"recorderPanel",project:this.project,domContainer:this.slots.domContainer,recorderConfig:this.recorderConfig,closeButton:{text:Siesta.Resource("Siesta.Project.Browser.UI.ResultPanel","closeText"),cls:"recorder-tool",handler:function(){a.layout.setActiveItem(0)}},listeners:{startrecord:function(a,c){this.fireEvent("startrecord",a,c);this.showTest(c)},show:function(){this.recorderButton.toggle(!0)},
play:function(a,c){this.showTest(c)},hide:function(){this.recorderButton.toggle(!1)},scope:this}}),this.slots.cardContainer.add(this.recorderPanel),this.relayEvents(this.recorderPanel,["startrecord","play"],"recorder"),this.test&&this.slots.recorderPanel.attachTo(this.test));a.layout.getActiveItem()===this.recorderPanel?a.layout.setActiveItem(this.slots.grid):a.layout.setActiveItem(this.recorderPanel)},afterRender:function(){this.callParent(arguments);var a=this.child("bordersplitter");this.testTitle=
this.down("#resultpanel-testtitle");a&&(a.tracker.tolerance=0)}});
Ext.define("Siesta.Project.Browser.UI.TestGridController",{extend:Ext.app.ViewController,alias:"controller.testgrid",control:{"#tool-menu [option]":{click:"onMenuItemClick"},"[actionName^=run]":{click:"onRunBtnClicked"},"#aboutSiesta":{click:"onAboutSiesta"}},onRunBtnClicked:function(a){this.getView().fireEvent("buttonclick",this,a,a.actionName)},onMenuItemClick:function(a){this.getView().fireEvent("optionchange",this,a.option,a.checked)},onAboutSiesta:function(){(new Siesta.Project.Browser.UI.AboutWindow).show()}});
Ext.define("Siesta.Project.Browser.UI.TestNameColumn",{extend:Ext.tree.Column,xtype:"testnamecolumn",dataIndex:"title",sortable:!1,menuDisabled:!0,flex:1,tdCls:"test-name-cell",scope:this,project:null,filterGroups:null,store:null,initComponent:function(){var a=Siesta.Resource("Siesta.Project.Browser.UI.TestGrid");Ext.apply(this,{items:[{xtype:"treefilter",emptyText:a.get("filterTestsText"),margins:"0 0 0 10",itemId:"trigger",filterGroups:this.filterGroups,filterField:"title",store:this.store,tipText:a.get("filterFieldTooltip")}]});
this.callParent(arguments)},treeRenderer:function(a,b,c){b.tdCls="test-name-cell-"+(c.data.leaf?"leaf":"parent");var d;c.isLeaf()?d=(d=c.get("test"))?c.get("isFailed")?"siesta-test-failed fa-flag":c.get("isRunning")&&!d.isFinished()?"fa-flash siesta-running-not-finished":d.isFinished()?d.isPassed()?"fa-check siesta-test-passed":"fa-bug siesta-test-failed":"fa-hourglass-o siesta-test-starting":c.get("isMissing")?"fa-close siesta-test-file-missing":c.get("isStarting")?"fa-hourglass-o siesta-test-starting":
this.getTestIcon(c)+" siesta-test-file":(d=c.get("folderStatus"),d="working"==d?" fa-hourglass-o siesta-folder-running":"green"==d?" fa-check siesta-folder-pass":"red"==d?" fa-bug siesta-folder-fail":"");c.data.iconCls=d;c.isLeaf()&&(d=c.get("tooltip")||a,b.tdAttr='title="'+d+'"');return this.callParent(arguments)},getTestIcon:function(a){return this.project.getDescriptorConfig(a.get("descriptor"),"pageUrl")?"fa-desktop":"fa-file-o"},renderer:function(a,b,c){return a+(c.get("descriptor").referenceUrl?
'<span style="padding-left: 3px; vertical-align: super; font-size: xx-small" class="fa fa-external-link" aria-hidden="true"></span>':"")}});
Ext.define("Siesta.Project.Browser.UI.TestGrid",{extend:Ext.tree.Panel,alias:"widget.testgrid",controller:"testgrid",stateful:!0,rootVisible:!1,header:!1,rowLines:!1,useArrows:!0,border:!1,cls:"tr-testgrid",iconCls:"tr-status-neutral-small",width:340,collapsible:!0,expanded:!0,viewType:"filterabletreeview",enableColumnMove:!1,project:null,lines:!1,filter:null,filterGroups:!1,resultSummary:null,stateConfig:null,showSizeControls:!1,isReadOnlyReport:!1,menuHideTimeout:!1,viewConfig:{enableTextSelection:!0,
...
Siesta.Resource("Siesta.Project.Browser.UI.TestGrid"),c=this.stateConfig;Ext.apply(this,{title:b.get("title"),columns:{createFocusableContainerKeyNav:Ext.emptyFn,items:[{xtype:"testnamecolumn",store:this.store,project:this.project},{header:b.get("passText"),width:35,sortable:!1,tdCls:"x-unselectable result-cell",menuDisabled:!0,dataIndex:"passCount",align:"center",renderer:this.passedColumnRenderer,scope:this},{header:b.get("failText"),width:35,sortable:!1,tdCls:"x-unselectable result-cell",menuDisabled:!0,
dataIndex:"failCount",align:"center",renderer:this.failedColumnRenderer,scope:this},{header:"Time",width:50,sortable:!1,dataIndex:"time",align:"center",renderer:function(a,b,c){return c.isLeaf()?a+"ms":""},hidden:!(this.project.showTestDurationColumn||this.isReadOnlyReport)}]},bbar:{xtype:"toolbar",cls:"main-bbar siesta-toolbar",border:!1,height:45,defaults:{scale:"large",width:30,tooltipType:"title"},items:this.getBottomBarItems(c,b)},dockedItems:this.showSizeControls?[{xtype:"toolbar",cls:"size-toolbar",
border:!0,dock:"bottom",items:[{xtype:"slider",itemId:"framesizeSlider",width:130,value:3,increment:1,minValue:0,maxValue:this.viewportSizes.length-1,listeners:{change:this.onDimensionOrOrientationChange,scope:this}},{xtype:"label",cls:"size-label",itemId:"sizeLabel",width:65},{boxLabel:b.get("landscape"),itemId:"orientationCheckbox",xtype:"checkbox",checked:!0,listeners:{change:this.onDimensionOrOrientationChange,scope:this}}]}]:[]});this.callParent(arguments);this.getView().on("beforerefresh",function(){var b=
a.down("#trigger");a.filterGroups&&b.setFilterGroups(a.filterGroups);a.filter&&b.setValue(a.filter);return!a.filter},null,{single:!0});this.on("viewready",this.onMyViewReady,this,{delay:10})},getBottomBarItems:function(a,b){var c=[];this.isReadOnlyReport||c.push({glyph:61515,cls:"run-checked",text:'<span class="subicon fa-check"></span>',tooltip:b.get("runCheckedText"),actionName:"run-checked"},{glyph:61518,cls:"run-all",tooltip:b.get("runAllText"),actionName:"run-all"},{glyph:61515,cls:"run-failed",
text:'<span class="subicon fa-bug"></span>',tooltip:b.get("runFailedText"),actionName:"run-failed"},{glyph:61459,tooltip:b.get("optionsText"),cls:"options",action:"options",listeners:{mouseover:this.onOptionsButtonMouseOver,mouseout:this.onOptionsButtonMouseOut,scope:this},menu:{itemId:"tool-menu",listeners:{mouseenter:{fn:this.onOptionsMenuMouseEnter,delay:100},mouseover:{fn:this.onOptionsMenuMouseEnter,delay:100},mouseleave:this.onOptionsMenuMouseLeave,scope:this},items:[{text:b.get("mouseSimulation"),
iconCls:"x-fa fa-mouse-pointer",menu:{listeners:{mouseenter:this.onOptionsMenuMouseEnter,mouseleave:this.onOptionsMenuMouseLeave,scope:this},items:[{text:"Slow (accurate)",option:"mouseSimSlow",checked:!a.speedRun&&!a.superSpeedRun,group:"mouse-sim",tooltip:"Slow and accurate mouse simulation"},{text:"Fast (accurate)",option:"mouseSimFast",checked:a.speedRun&&!a.superSpeedRun,group:"mouse-sim",tooltip:"Fast, but still accurate mouse simulation"},{text:"Fastest (not accurate)",option:"mouseSimFastest",
checked:a.superSpeedRun,group:"mouse-sim",tooltip:b.get("superSpeedRunTooltip")}]}},{text:b.get("transparentExText"),option:"transparentEx",checked:a.transparentEx,tooltip:b.get("transparentExTooltip")},{text:b.get("breakOnFailText"),option:"breakOnFail",checked:a.breakOnFail,tooltip:b.get("breakOnFailTooltip")},{text:b.get("debuggerOnFailText"),option:"debuggerOnFail",checked:a.debuggerOnFail,tooltip:b.get("debuggerOnFailTooltip")},{itemId:"observerModeMenuItem",text:b.get("observerModeText"),option:"observerMode",
checked:a.observerMode,tooltip:b.get("observerModeTooltip")},{text:b.get("autoLaunchText"),option:"autoRun",checked:a.autoRun,tooltip:b.get("autoLaunchTooltip")},{xtype:"menuseparator"},{text:b.get("aboutText"),itemId:"aboutSiesta"},{text:b.get("documentationText"),href:b.get("siestaDocsUrl"),hrefTarget:"_blank"}]}});c.push("->",{xtype:"component",cls:"summary-bar",border:!1,width:55,itemId:"result-summary",data:{pass:0,fail:0},tpl:'<div><span class="total-pass">{pass}</span><span class="icon fa-check"></span></div><div><span class="total-fail">{fail}</span><span class="icon fa-bug"></span></div>'});
return c},onHistoryChange:function(a){a&&(a=this.store.getNodeById(a))&&this.selectTestFile(a)},onDimensionOrOrientationChange:function(a,b){var c=this.viewportSizes[this.framesizeSlider.getValue()],d=this.orientationCheckbox.getValue();this.sizeLabel.setText(c.join("x"));this.fireEvent("framesizechange",a,c[0],c[1],d)},getFilterValue:function(){return this.down("#trigger").getValue()},getFilterGroups:function(){return this.down("#trigger").getFilterGroups()},passedColumnRenderer:function(a,b,c){if(!c.isLeaf())return"";
0<c.data.todoPassCount&&(a+=' <span title="'+c.data.todoPassCount+" "+Siesta.Resource("Siesta.Project.Browser.UI.TestGrid","todoPassedText")+'" class="tr-test-todo tr-test-todo-pass">+ '+c.data.todoPassCount+"</span>");return a},failedColumnRenderer:function(a,b,c){if(!c.isLeaf())return"";0<c.data.todoFailCount&&(a+=' <span title="'+c.data.todoFailCount+" "+Siesta.Resource("Siesta.Project.Browser.UI.TestGrid","todoFailedText")+'" class="tr-test-todo tr-test-todo-fail">+ '+c.data.todoFailCount+"</span>");
return a},onOptionsButtonMouseOver:function(a){clearTimeout(this.menuHideTimeout);a.showMenu();a.menu.hide=function(){};setTimeout(function(){delete a.menu.hide},1E3)},onOptionsButtonMouseOut:function(a){var b=this;this.menuHideTimeout||(this.menuHideTimeout=setTimeout(function(){delete a.menu.hide;a.hideMenu();b.menuHideTimeout=null},500))},onOptionsMenuMouseEnter:function(a){clearTimeout(this.menuHideTimeout);this.menuHideTimeout=null},onOptionsMenuMouseLeave:function(){var a=this,b=this.down("#tool-menu");
this.menuHideTimeout||(this.menuHideTimeout=setTimeout(function(){delete b.hide;b.hide();a.menuHideTimeout=null},500))},afterRender:function(){this.callParent(arguments);this.summaryPassEl=this.el.down(".total-pass");this.summaryFailEl=this.el.down(".total-fail");if(this.showSizeControls){this.orientationCheckbox=this.down("#orientationCheckbox");this.sizeLabel=this.down("#sizeLabel");this.framesizeSlider=this.down("#framesizeSlider");var a=this.viewportSizes[this.framesizeSlider.getValue()];this.sizeLabel.setText(a.join("x"))}},
onMyViewReady:function(){Ext.History.on("change",this.onHistoryChange,this);var a=window.location.hash;if(a)this.onHistoryChange(a.substring(1))},updateStatus:function(a,b){this.summaryPassEl.update(String(a));this.summaryFailEl.update(String(b))},setFilterValue:function(a){this.down("treefilter").setValue(a)},selectTestFile:function(a){a&&(a.bubble(function(a){a.expand()}),this.store.getById(a.id)&&0<=this.store.indexOf(a)&&(!this.getCollapsed()&&0<this.getView().getNodes().length&&this.ensureVisible(a),
this.getSelectionModel().select(a)))}});
Ext.define("Siesta.Project.Browser.UI.TestGridContextMenu",{extend:Ext.menu.Menu,xtype:"testgridcontextmenu",items:[{itemId:"uncheckOthers",text:Siesta.Resource("Siesta.Project.Browser.UI.Viewport").get("uncheckOthersText")},{itemId:"uncheckAll",text:Siesta.Resource("Siesta.Project.Browser.UI.Viewport").get("uncheckAllText")},{itemId:"checkAll",text:Siesta.Resource("Siesta.Project.Browser.UI.Viewport").get("checkAllText")},{itemId:"runThis",text:Siesta.Resource("Siesta.Project.Browser.UI.Viewport").get("runThisText")},{itemId:"viewSource",
text:Siesta.Resource("Siesta.Project.Browser.UI.Viewport").get("viewSource")},{text:"Link to this test",menu:[{itemId:"linkSelect",text:"Select only"},{itemId:"linkFilterAutoLaunch",text:"Filter and auto launch"}]},{xtype:"menuseparator"},{itemId:"expandAll",text:Siesta.Resource("Siesta.Project.Browser.UI.Viewport").get("expandAll")},{itemId:"collapseAll",text:Siesta.Resource("Siesta.Project.Browser.UI.Viewport").get("collapseAll")},{xtype:"menuseparator"},{itemId:"filterToCurrentGroup",text:Siesta.Resource("Siesta.Project.Browser.UI.Viewport").get("filterToCurrentGroup")},
{itemId:"filterToFailed",text:Siesta.Resource("Siesta.Project.Browser.UI.Viewport").get("filterToFailed")}]});
Ext.define("Siesta.Project.Browser.UI.VersionUpdateButton",{extend:Ext.Button,xtype:"versionupdatebutton",text:Siesta.Resource("Siesta.Project.Browser.UI.VersionUpdateButton","newUpdateText"),action:"upgrade-siesta",hidden:!0,latestVersion:null,scale:"medium",constructor:function(){this.callParent(arguments);this.scope=this;Siesta.meta.VERSION&&!window.location.href.match("^https")&&this.fetchVersionInfo()},fetchVersionInfo:function(){Ext.data.JsonP.request({url:"https://bryntum.com/siesta_version",
params:{v:Siesta.meta.VERSION},scope:this,callback:this.onRequestCompleted})},onRequestCompleted:function(a,b){a&&b&&b.name&&(new Ext.Version(b.name)).isGreaterThan(Siesta.meta.VERSION||"1.0.0")&&(this.latestVersion=b.name,this.show())},handler:function(){var a=Siesta.Resource("Siesta.Project.Browser.UI.VersionUpdateButton"),b=new Ext.Window({cls:"changelog-window",title:a.get("updateWindowTitleText")+(Siesta.meta.VERSION||"1.0.0"),modal:!0,width:500,height:380,closeAction:"destroy",plain:!0,autoScroll:!0,
buttons:{padding:"10 13",style:"background: transparent",items:[{cls:"light-button",href:"https://www.bryntum.com/products/siesta/download-lite",hrefTarget:"_blank",scale:"medium",text:a.get("downloadText")+this.latestVersion+a.get("liteText")},{cls:"light-button",href:"https://bryntum.com/customerzone",hrefTarget:"_blank",scale:"medium",text:a.get("downloadText")+this.latestVersion+a.get("standardText")},{text:a.get("cancelText"),scale:"medium",handler:function(){b.close()}}]}});b.show();b.body.mask(a.get("loadingChangelogText"));
Ext.Ajax.request({useDefaultXhrHeader:!1,url:"https://bryntum.com/changelogs/_siesta.php",callback:function(a,d,e){b.body.unmask();d&&e&&e.responseText?b.update(e.responseText):b.update(Siesta.Resource("Siesta.Project.Browser.UI.VersionUpdateButton","changelogLoadFailedText"))}})}});
Ext.define("Siesta.Project.Browser.UI.ViewportController",{extend:Ext.app.ViewController,alias:"controller.viewport",mixins:[Siesta.Project.Browser.UI.CanCopyToClipboard],control:{testgrid:{selectionchange:"onTestGridSelectionChange",checkchange:"onTestGridCheckChange",itemcontextmenu:"onTestFileContextMenu",itemdblclick:"onTestFileDoubleClick",itemclick:"onTestFileClick",resize:"onTestGridResize",optionchange:"onTestGridOptionChange",buttonclick:"onTestGridToolbarClick",framesizechange:"onFrameSizeChange"},
"testnamecolumn treefilter":{change:{fn:"onFilterChange",buffer:300}},"testgridcontextmenu #uncheckOthers":{click:"uncheckOthers"},"testgridcontextmenu #runThis":{click:"runThisFile"},"testgridcontextmenu #uncheckAll":{click:"uncheckAll"},"testgridcontextmenu #checkAll":{click:"checkAll"},"testgridcontextmenu #expandAll":{click:"expandAll"},"testgridcontextmenu #collapseAll":{click:"collapseAll"},"testgridcontextmenu #filterToCurrentGroup":{click:"filterToCurrentGroup"},"testgridcontextmenu #filterToFailed":{click:"filterToFailed"},
"testgridcontextmenu #viewSource":{click:"viewSource"},"testgridcontextmenu #linkSelect":{click:"linkSelect"},"testgridcontextmenu #linkFilterAutoLaunch":{click:"linkFilterAutoLaunch"},resultpanel:{viewdomchange:"onDomPanelVisibilityChange",runbuttonclick:"runTest"}},disableRunButtonTimeout:null,disableRunButtonInterval:150,onFilterChange:function(){this.getView().saveState()},filterToFailed:function(){var a=this.getView(),b=[];a.forEachTestFile(function(a){var d=a.get("test");d&&d.isFailed()&&b.push(a.get("title"))});
b.length&&a.slots.filesTree.setFilterValue(b.join(" | "))},filterToCurrentGroup:function(){var a=this.getView(),b=a.currentFile.get("descriptor");b.parent&&a.slots.filesTree.setFilterValue(b.parent.group+">")},onTestGridSelectionChange:function(a,b){if(b.length){var c=this.getView(),d=b[0],e=d.get("test");e&&(T=e,c.slots.resultPanel.showTest(e,d.get("assertionsStore")));d.isLeaf()&&Ext.History.add(d.data.url)}},onTestGridCheckChange:function(a,b){this.getView().setNodeChecked(a,b)},onTestFileContextMenu:function(a,
b,c,d,e){a=this.getView();a.isReadOnlyReport||(a.currentFile=b,a.contextMenu||(a.contextMenu=new Siesta.Project.Browser.UI.TestGridContextMenu),a.contextMenu.showAt(e.getXY()),e.preventDefault())},onTestFileDoubleClick:function(a,b){var c=this.getView();if(!c.isReadOnlyReport){var d=c.testsStore;if(d.isTreeFiltered()&&!b.isLeaf()){var e=[];b.cascadeBy(function(a){a!=b&&a.isLeaf()&&d.isNodeFilteredIn(a)&&e.push(a.get("descriptor"))});c.project.launch(e)}else c.launchTest(b)}},onTestFileClick:function(a,
b,c,d,e){a=this.getView();a.isReadOnlyReport||(b=a.project.getDescriptorConfig(b.get("descriptor"),"referenceUrl"))&&e.ctrlKey&&(window.open(b,"_blank")||Ext.toast("Popups are disabled in the browser","Can't open new tab"))},onTestGridResize:function(){this.getView().slots.resultPanel.ensureLayout()},onTestGridOptionChange:function(a,b,c){a=this.getView();a.setOption(b,c);a.saveState()},onTestGridToolbarClick:function(a,b,c){a=this.getView();switch(c){case "run-checked":a.runChecked();break;case "run-failed":a.runFailed();
break;case "run-all":a.runAll();break;case "stop":a.stopSuite(b)}},onFrameSizeChange:function(a,b,c,d){a=this.getView();d||(d=b,b=c,c=d);$(".tr-iframe").width(b);$(".tr-iframe").height(c);a.project.viewportHeight=c;a.project.viewportWidth=b},uncheckOthers:function(){var a=this.getView(),b=a.currentFile;a.uncheckAllExcept(b);a.setNodeChecked(b,!0)},linkFilterAutoLaunch:function(){var a=this.getView().currentFile,a=/([^\/]*)$/.exec(a.get("descriptor").url),a=location.protocol+"//"+location.host+location.pathname+
"?filter="+encodeURIComponent(a[1])+"&autolaunch=1";this.copyToClipboard(a)?Ext.toast("Url copied to clipboard","Success"):Ext.Msg.show({message:"Please select & copy this url manually:<br>"+a,title:"Copy to clipboard failed",modal:!1})},linkSelect:function(){var a=this.getView().currentFile,a=location.protocol+"//"+location.host+location.pathname+"#"+a.get("descriptor").url;this.copyToClipboard(a)?Ext.toast("Url copied to clipboard","Success"):Ext.Msg.show({message:"Please select & copy this url manually:<br>"+
a,title:"Copy to clipboard failed",modal:!1})},runThisFile:function(){var a=this.getView();a.project.launch([a.currentFile.get("descriptor")])},uncheckAll:function(){this.getView().uncheckAllExcept()},checkAll:function(){var a=this.getView();a.testsStore.forEach(function(b){a.setNodeChecked(b,!0,!0)})},expandAll:function(){this.getView().slots.filesTree.expandAll()},collapseAll:function(){this.getView().slots.filesTree.collapseAll()},viewSource:function(){var a=this.getView().currentFile,b=a.get("test"),
c=window.open("","siesta-source"),d=c.document.documentElement.getElementsByTagName("head")[0],e=c.document.body;d.innerHTML="<title>"+a.get("title")+"</title>";b?e.innerHTML="<pre>"+b.getSource()+"</pre>":$.ajax(a.get("url"),{success:function(a){e.innerHTML="<pre>"+a+"</pre>"}})},onDomPanelVisibilityChange:function(a,b){var c=this.getView();c.setOption("viewDOM",b);c.saveState()},runTest:function(){var a=this;null==a.disableRunButtonTimeout&&(a.disableRunButtonTimeout=setTimeout(function(){a.disableRunButtonTimeout=
null},a.disableRunButtonInterval),a.getView().runTest())}});
Ext.define("Siesta.Project.Browser.Model.TestFile",{extend:Ext.data.Model,idProperty:"id",fields:["id","url","title","tooltip",{name:"passCount",type:"int",defaultValue:0},{name:"failCount",type:"int",defaultValue:0},{name:"todoPassCount",type:"int",defaultValue:0},{name:"todoFailCount",type:"int",defaultValue:0},{name:"time",type:"int",defaultValue:0},{name:"checked",defaultValue:!1},{name:"folderStatus",defaultValue:"yellow"},"isStarting",{name:"isRunning",type:"boolean",defaultValue:!1},{name:"isMissing",
...
Ext.define("Siesta.Project.Browser.UI.Viewport",{extend:Ext.container.Viewport,mixins:[Siesta.Project.Browser.UI.CanFillAssertionsStore],controller:"viewport",title:null,project:null,stateful:!1,layout:"border",selection:null,filter:null,filterGroups:!1,testsStore:null,contextMenu:null,enableVersionCheck:!0,collapsedNodes:null,showSizeControls:!1,expectedExtJSVersion:"6.0.1.250",viewportSizes:[[640,480],[800,600],[1024,768],[1920,1080],[2048,1536]],idGenSequence:1,isReadOnlyReport:!1,dataUrl:"report-data.json",
autoLaunch:!1,initComponent:function(){var a;this.isReadOnlyReport?(a=new Siesta.Project.Browser,a.configure({stateful:!1}),this.project=a):a=this.project;Ext.getBody().addCls("siesta");Ext.getBody().on("keydown",this.onBodyKeyDown,this);Ext.setGlyphFontFamily("FontAwesome");Ext.state.Manager.setProvider(Ext.supports.LocalStorage?new Ext.state.LocalStorageProvider:new Ext.state.CookieProvider);this.selection={};var b=this.filter;a.stateful&&this.applyState(this.loadState());b&&(this.filter=b,this.filterGroups=
!1);b=this.buildTreeData({id:"root",group:"test suite"+this.title,items:a.descriptors}).children;b=this.testsStore=new Siesta.Project.Browser.Model.FilterableTreeStore({model:"Siesta.Project.Browser.Model.TestFile",sortOnLoad:!1,root:{expanded:!0,children:b},proxy:"memory",listeners:{nodecollapse:this.saveState,nodeexpand:this.saveState,scope:this}});Ext.apply(this,{slots:!0,items:[{region:"west",xtype:"testgrid",store:b,stateful:a.stateful,slot:"filesTree",id:a.id.replace(/\W/g,"_")+"-testTree",
showSizeControls:this.showSizeControls,viewportSizes:this.viewportSizes,stateConfig:this.getState(),project:this.project,isReadOnlyReport:this.isReadOnlyReport,animate:!Ext.isIE,split:{size:7},filter:this.filter,filterGroups:this.filterGroups,listeners:{viewready:this.onFilterApplied,scope:this}},{xtype:"resultpanel",region:"center",slot:"resultPanel",cls:"resultPanel-panel",viewDOM:this.getOption("viewDOM"),scaleToFit:this.getOption("scaleToFit"),scaleToFitMode:this.getOption("scaleToFitMode"),id:a.id.replace(/\W/g,
"_")+"-resultpanel",project:a,recorderConfig:a.recorderConfig,isReadOnlyReport:this.isReadOnlyReport,maintainViewportSize:a.maintainViewportSize,domContainerRegion:a.domContainerRegion,listeners:{newjsonreport:this.onNewJsonReport,scope:this}}]});this.callParent();this.slots.filesTree.store.on({"filter-set":this.saveState,"filter-clear":this.saveState,scope:this});this.on("statechange",this.saveState,this);a.on("testendbubbling",this.onEveryTestEnd,this);a.on("testsuitelaunch",this.onTestSuiteLaunch,
this);a.on("assertiondiscard",this.onAssertionDiscarded,this);!window.location.href.match("^file:///")||this.isReadOnlyReport&&Ext.browser.is("Firefox")?this.isReadOnlyReport&&this.fetchJsonReport():(a=Siesta.Resource("Siesta.Project.Browser.UI.Viewport"),Ext.Msg.alert(a.get("httpWarningTitle"),a.get("httpWarningDesc")))},onNewJsonReport:function(a,b){this.loadJsonReport(b)},buildTreeData:function(a){var b={id:a.id,title:a.group||a.title||a.name,descriptor:a,nodeType:1,cloneNode:function(){return this}};
b.tooltip=a.desc||b.title;var c=this,d=b.id,e=this.collapsedNodes||{};if(a.group){var f=[];Ext.each(a.items,function(a){f.push(c.buildTreeData(a))});Ext.apply(b,{expanded:null!=e[d]||!1===a.expanded?!1:!0,checked:c.selection.hasOwnProperty(d)||!1,folderStatus:"yellow",children:f,leaf:!1})}else Ext.apply(b,{url:a.url,leaf:!0,checked:c.selection.hasOwnProperty(d)||!1,passCount:0,failCount:0,time:0,assertionsStore:new Siesta.Project.Browser.Model.AssertionTreeStore({model:"Siesta.Project.Browser.Model.Assertion",
proxy:"memory",root:{id:"__ROOT__",expanded:!0}})});return b},onBodyKeyDown:function(a){if(a.ctrlKey){var b=this.project;a.getKey()==Ext.event.Event[b.rerunHotKey]&&(this.runTest(),a.preventDefault());if(a.getKey()==Ext.event.Event[b.observerModeHotKey]){var b=!b.observerMode,c=this.down("#observerModeMenuItem");c.setChecked(b);c.fireEvent("click",c);a.preventDefault()}}},buildTreeDataFromJSONSReportNode:function(a){var b={id:this.idGenSequence++,title:a.group||a.name||a.url.replace(/(?:.*\/)?([^/]+)$/,
"$1"),descriptor:a,nodeType:1,cloneNode:function(){return this}},c=this;if(a.group){var d=[];Ext.each(a.items,function(a){d.push(c.buildTreeDataFromJSONSReportNode(a))});Ext.apply(b,{expanded:!0,checked:null,leaf:!1,folderStatus:"yellow",children:d})}else{var e=new Siesta.Test.Browser({project:this.project,url:a.url,name:a.name,startDate:new Date(a.startDate)});Ext.apply(b,{url:a.url,leaf:!0,checked:null,time:a.endDate-a.startDate,test:e,assertionsStore:new Siesta.Project.Browser.Model.AssertionTreeStore({model:"Siesta.Project.Browser.Model.Assertion",
proxy:"memory",root:{id:"__ROOT__",expanded:!0,children:this.buildAssertionDataFromJSONSReportNode(a.assertions,e)}})});e.endDate=new Date(a.endDate);Ext.apply(b,{passCount:e.getPassCount(),failCount:e.getFailCount(),todoPassCount:e.getTodoPassCount(),todoFailCount:e.getTodoFailCount()})}return b},buildAssertionDataFromJSONSReportNode:function(a,b){var c=this,d=Joose.A.map(a,function(a){var d="Siesta.Result.SubTest"==a.type,e={id:c.idGenSequence++,leaf:!d,expanded:d&&("it"!=a.bddSpecType||!a.passed)};
d?(d=new Siesta.Test.Browser({trait:Siesta.Test.Sub,name:a.name,isTodo:a.isTodo,startDate:new Date(a.startDate),url:b.url,parent:b,specType:a.bddSpecType}),e.children=c.buildAssertionDataFromJSONSReportNode(a.assertions,d),d.endDate=new Date(a.endDate),a=d.getResults()):a=new (Joose.S.strToClass(a.type))(a);b.addResult(a);e.result=a;return e});if(!b.parent){var e=new Siesta.Result.Summary({isFailed:b.isFailed(),description:b.getSummaryMessage()});b.addResult(e);d.push({id:this.idGenSequence++,result:e,
loaded:!0,leaf:!0,expanded:!1})}return d},loadJsonReport:function(a){this.title=a.testSuiteName||"";this.testsStore.setRootNode(this.buildTreeDataFromJSONSReportNode({group:"TOP",items:a.testCases}));this.testsStore.getRootNode().cascadeBy(function(a){a.parentNode&&!a.isLeaf()&&a.updateFolderStatus()});this.updateStatusIndicator()},fetchJsonReport:function(){var a=this,b=new Ext.LoadMask({target:this,msg:Siesta.Resource("Siesta.Project.Browser.UI.CoverageReport","loadingText")});b.show();Ext.Ajax.request({url:this.dataUrl,
success:function(c){b.hide();a.loadJsonReport(Ext.JSON.decode(c.responseText))},failure:function(){b.hide();Ext.Msg.show({title:Siesta.Resource("Siesta.Project.Browser.UI.CoverageReport","loadingErrorText"),msg:Siesta.Resource("Siesta.Project.Browser.UI.CoverageReport","loadingErrorMessageText")+a.dataUrl,buttons:Ext.MessageBox.OK,icon:Ext.MessageBox.ERROR})}})},onFilterApplied:function(){if(this.autoLaunch)this.runAll();else if(this.getOption("autoRun")){var a=this.getChecked();this.project.launch(a.length&&
a||this.project.descriptors)}},setNodeChecked:function(a,b,c,d){var e=this,f=a.getId();b?this.selection[f]=1:delete this.selection[f];a.set("checked",b);!b&&a.parentNode&&e.setNodeChecked(a.parentNode,!1,!0,!0);a.isLeaf()||c||Ext.each(a.childNodes,function(a){e.setNodeChecked(a,b,!1,!0)});d||this.saveState()},forEachTestFile:function(a,b){b=b||this;var c=this.testsStore,d=c.getRootNode();d.cascadeBy(function(e){var f=c.isNodeFilteredIn(e);e!=d&&f&&a.call(b,e);return f})},getChecked:function(){var a=
[];this.forEachTestFile(function(b){b.get("checked")&&b.isLeaf()&&a.push(b.get("descriptor"))});return a},runChecked:function(){0<this.getChecked().length&&this.project.launch(this.getChecked())},runFailed:function(){var a=[];this.forEachTestFile(function(b){var c=b.get("test");c&&c.isFailed()&&a.push(b.get("descriptor"))});0<a.length&&this.project.launch(a)},runAll:function(){var a=[];this.forEachTestFile(function(b){b.isLeaf()&&a.push(b.get("descriptor"))});0<a.length&&this.project.launch(a)},stopSuite:function(a){a.disable();
this.project.stopCurrentLaunch();setTimeout(function(){a.enable()},1E3)},onTestSuiteStop:function(a){this.testsStore.forEach(function(a){a.get("isStarting")&&a.set("isStarting",!1)});a&&(a=this.testsStore.getNodeById(a.url),this.slots.filesTree.getSelectionModel().select(a))},onBeforeScopePreload:function(a,b){this.testsStore.getNodeById(b)},isTestRunningVisible:function(a){if(!(a.scopeProvider instanceof Scope.Provider.IFrame))return!1;if(this.project.testOfForcedIFrame)return this.project.testOfForcedIFrame.isFromTheSameGeneration(a);
var b=this.slots.resultPanel;return b.test&&b.test.isFromTheSameGeneration(a)?b.isFrameVisible():!1},resetDescriptors:function(a){var b=this.testsStore;Joose.A.each(this.project.flattenDescriptors(a),function(a){var d=b.getNodeById(a.id);d.get("assertionsStore").removeAll(!0);d.reject();d.set("checked",this.selection.hasOwnProperty(a.id)||!1)},this)},onTestSuiteStart:function(a){Ext.getBody().addCls("testsuite-running");var b=this.slots.filesTree.getSelectionModel(),c=b.getLastSelected(),d=this.testsStore;
this.resetDescriptors(a);c&&b.select(d.getNodeById(c.getId()))},onTestSuiteLaunch:function(a,b){var c=this.testsStore,d={};Joose.A.each(this.project.flattenDescriptors(b),function(a){var b=c.getNodeById(a.id);b.set({isMissing:a.isMissing,isStarting:!0});if((a=b.parentNode)&&!d[a.getId()]){for(b=a;b;b=b.parentNode)d[b.getId()]=!0;a.updateFolderStatus()}})},onTestSuiteEnd:function(a){Ext.getBody().removeCls("testsuite-running");this.updateStatusIndicator();Ext.isChrome?window.focus():(document.body.tabIndex=
-1,document.body.focus())},onTestStart:function(a){var b=this.testsStore.getNodeById(a.url);if(this.isTestUpdateActual(a,b)){b.beginEdit();b.set({test:a,isRunning:!0});b.endEdit();var c=this.slots.filesTree.getSelectionModel().getLastSelected();c&&c.getId()==a.url&&(c=this.slots.resultPanel,c.showTest(a,b.get("assertionsStore")),c.setInitializing(!1),T=a)}},isTestUpdateActual:function(a,b){return a.launchId==this.project.currentLaunchId},onTestUpdate:function(a,b,c){var d=this.testsStore.getNodeById(a.url);
this.isTestUpdateActual(a,d)&&this.processNewResult(d.get("assertionsStore"),a,b,c)},onAssertionDiscarded:function(a,b,c){a=this.testsStore.getNodeById(b.url);this.isTestUpdateActual(b,a)&&a.get("assertionsStore").getNodeById(c.id).remove()},onTestEnd:function(a){var b=this.testsStore.getNodeById(a.url);this.isTestUpdateActual(a,b)&&(b.beginEdit(),b.set({passCount:a.getPassCount(),failCount:a.getFailCount(),todoPassCount:a.getTodoPassCount(),todoFailCount:a.getTodoFailCount(),time:a.getDuration()+
"ms"}),b.endEdit(),b.parentNode&&b.parentNode.updateFolderStatus());this.updateStatusIndicator()},onEveryTestEnd:function(a,b){var c=this.testsStore.getNodeById(b.url);this.isTestUpdateActual(b,c)&&this.processEveryTestEnd(c.get("assertionsStore"),b)},onTestFail:function(a,b,c){b=this.testsStore.getNodeById(a.url);this.isTestUpdateActual(a,b)&&!a.isTodo&&(b.set("isFailed",!0),b.parentNode&&b.parentNode.updateFolderStatus())},getOption:function(a,b){switch(a){case "selection":return this.selection;
default:var c=this.project;return b?c.hasOwnProperty(a)?c[a]:void 0:c[a]}},setOption:function(a,b){var c=this.project;switch(a){case "selection":return this.selection=b||{};case "collapsedNodes":return this.collapsedNodes=b;case "filter":return this.filter=b;case "filterGroups":return this.filterGroups=b;case "observerMode":c.setObserverMode(b);break;case "mouseSimSlow":b&&(c.speedRun=!1,c.superSpeedRun=!1);break;case "mouseSimFast":b&&(c.speedRun=!0,c.superSpeedRun=!1);break;case "mouseSimFastest":b&&
(c.speedRun=!0,c.superSpeedRun=!0);break;default:return c[a]=b}},getState:function(a){var b=this.slots&&this.down("domcontainer"),c={scaleToFit:b?b.scaleToFit:this.scaleToFit,scaleToFitMode:b?b.scaleToFitMode:this.scaleToFitMode,selection:this.getCheckedNodes(),collapsedNodes:this.getCollapsedFolders(),filter:this.slots?this.slots.filesTree.getFilterValue():this.filter,filterGroups:this.slots?this.slots.filesTree.getFilterGroups():this.filterGroups},d=this;Joose.A.each("autoRun speedRun superSpeedRun viewDOM transparentEx breakOnFail debuggerOnFail observerMode".split(" "),
function(b){var f=d.getOption(b,a);a?void 0!==f&&(c[b]=f):c[b]=f});return c},getCheckedNodes:function(){var a={};this.testsStore.forEach(function(b){b.get("checked")&&(a[b.getId()]=1)});return a},getCollapsedFolders:function(){var a={};this.testsStore.forEach(function(b){b.isLeaf()||b.isExpanded()||(a[b.getId()]=1)});return a},applyState:function(a){var b=this;a&&Joose.O.each(a,function(a,d){b.setOption(d,a)})},getStateId:function(){return"test-run-"+this.title},loadState:function(){var a=this.getStateId(),
b=Ext.state.Manager.get(a);if(b)return b.collapsedNodes||(b.collapsedNodes=Ext.state.Manager.get(a+"-collapsed")),b.selection||(b.selection=Ext.state.Manager.get(a+"-selection")),b},saveState:function(){var a=this.getStateId(),b=this.getState(!0);Ext.state.Manager.set(a+"-collapsed",b.collapsedNodes);Ext.state.Manager.set(a+"-selection",b.selection);delete b.collapsedNodes;delete b.selection;Ext.state.Manager.set(a,b)},uncheckAllExcept:function(a){var b=this;this.testsStore.forEach(function(c){c!=
a&&b.setNodeChecked(c,!1,!0)})},launchTest:function(a){if(!this.isReadOnlyReport){var b=this.slots.resultPanel,c=a instanceof Ext.data.Model?a.data.leaf:!0;a=a instanceof Siesta.Test?this.project.getScriptDescriptor(a):a.get("descriptor");c&&(Ext.History.add(a.url),b.setInitializing(!0));this.project.launch([a])}},updateStatusIndicator:function(){var a=0,b=0;this.testsStore.forEach(function(c){(c=c.get("test"))&&c.isFinished()&&(a+=c.getPassCount(),b+=c.getFailCount())});this.slots.filesTree.updateStatus(a,
b)},runTest:function(){if(!this.isReadOnlyReport){var a=this.slots.filesTree.getSelectionModel().getSelection()[0]||this.slots.resultPanel.test;a&&this.launchTest(a)}},afterRender:function(){this.callParent(arguments);Ext.versions.extjs.isLessThan(this.expectedExtJSVersion)&&window.console&&console.log("Wrong Ext JS version detected.","Siesta expects that you use Ext JS version >= "+this.expectedExtJSVersion+". You may experience errors when using another version");this.project.isAutomated||setTimeout(Ext.Function.bind(this.deferredSetup,
this),1E3)},deferredSetup:function(){Ext.QuickTips&&Ext.QuickTips.init();this.enableVersionCheck&&Siesta.Project.Browser.UI.VersionUpdateButton&&new Siesta.Project.Browser.UI.VersionUpdateButton},onManualCloseOfForcedIframe:function(a){var b=this.down("domcontainer");b&&b.test==a&&b.alignIFrame(!0)}});
