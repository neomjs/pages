...
*/
<span id='Siesta-Project-Browser'>/**
</span>@class Siesta.Project.Browser
...
<span id='Siesta-Project-Browser-cfg-testClass'>        /**
...
<span id='Siesta-Project-Browser-cfg-autoRun'>        /**
</span>         * @cfg {Boolean} autoRun When set to `true`, project will automatically launch the execution either of the checked test files or the whole suite.
         * Default value is `false`
         */
        autoRun             : false,

<span id='Siesta-Project-Browser-cfg-viewDOM'>        /**
</span>         * @cfg {Boolean} viewDOM When set to `true`, project will expand the panel with the `&lt;iframe&gt;` of the test file, so you can examine the content of DOM.
         * Default value is `false`
         */
        viewDOM             : false,

<span id='Siesta-Project-Browser-cfg-scaleToFit'>        /**
</span>         * @cfg {Boolean} scaleToFit When set to `true`, the `&lt;iframe&gt;` of the test file will be scaled to fit the available space.
         */
        scaleToFit          : true,

<span id='Siesta-Project-Browser-cfg-scaleToFitMode'>        /**
</span>         * @cfg {String} scaleToFitMode One of the `full`, `width`, `height` to scale to fit to particular dimension only, or to both.
         */
        scaleToFitMode      : &#39;full&#39;,


<span id='Siesta-Project-Browser-cfg-domContainerRegion'>        /**
</span>         * @cfg {String} domContainerRegion Should be exactly one of `east/west/south/north`. Controls the position of the dom container
...
<span id='Siesta-Project-Browser-cfg-showTestDurationColumn'>        /**
</span>         * @cfg {Boolean} showTestDurationColumn Enable to display the column with tests duration. This column is always
         * visible in the HTML report.
         */
        showTestDurationColumn  : false,

<span id='Siesta-Project-Browser-cfg-speedRun'>        /**
</span>         * @cfg {Boolean} speedRun When set to `true`, project will reduce the quality or completely remove the visual effects
...
<span id='Siesta-Project-Browser-cfg-mouseMovePrecision'>        /**
</span>         * @cfg {Integer} mouseMovePrecision
         *
...
<span id='Siesta-Project-Browser-cfg-failOnResourceLoadError'>        /**
</span>         * @cfg {Boolean} failOnResourceLoadError When set to `true`, test will try to detect the failures for loading of
...
<span id='Siesta-Project-Browser-cfg-failOnPromiseRejection'>        /**
</span>         * @cfg {Boolean} failOnPromiseRejection When set to `true`, test will add a failing assertion for the unhandled promise rejections (if browser
...
<span id='Siesta-Project-Browser-cfg-disableCaching'>        /**
</span>         * @cfg {Boolean} disableCaching When set to `true`, project will prevent the browser caching of files being preloaded and the test files, by appending
...
<span id='Siesta-Project-Browser-cfg-forceDOMVisible'>        /**
...
<span id='Siesta-Project-Browser-cfg-runInPopup'>        /**
</span>         * @cfg {Boolean} runInPopup Experimental. When set to `true` the tests will be executed in the popup, instead of iframe.
...
<span id='Siesta-Project-Browser-cfg-pageUrl'>        /**
</span>         * @cfg {String} pageUrl The url of the HTML page which will be the target for the test(s) (the URL must be on the same domain the project HTML page). This option is used for application level testing, Siesta will visit this URL and then launch
...
<span id='Siesta-Project-Browser-cfg-useStrictMode'>        /**
...
<span id='Siesta-Project-Browser-cfg-innerHtmlHead'>        /**
</span>         * @cfg {String} innerHtmlHead
         *
...
<span id='Siesta-Project-Browser-cfg-innerHtmlBody'>        /**
</span>         * @cfg {String} innerHtmlBody
         *
...
<span id='Siesta-Project-Browser-cfg-runCore'>        /**
...
<span id='Siesta-Project-Browser-cfg-simulateEventsWith'>        /**
...
<span id='Siesta-Project-Browser-cfg-autoScrollElementsIntoView'>        /**
...
<span id='Siesta-Project-Browser-cfg-enableUnreachableClickWarning'>        /**
</span>         * @cfg {Boolean} enableUnreachableClickWarning When this option is set to `true` (default) Siesta will generate warnings
...
<span id='Siesta-Project-Browser-cfg-maintainViewportSize'>        /**
...
<span id='Siesta-Project-Browser-cfg-viewportWidth'>        /**
...
<span id='Siesta-Project-Browser-cfg-viewportHeight'>        /**
...
<span id='Siesta-Project-Browser-cfg-recorderClass'>        /**
</span>         * @cfg {Function} recorderClass A recorder class to use
         */
...
<span id='Siesta-Project-Browser-cfg-recorderConfig'>        /**
</span>         * @cfg {Object} recorderConfig A custom config object used to configure the {@link Siesta.Recorder.Recorder} instance
         */
        recorderConfig              : null,

<span id='Siesta-Project-Browser-cfg-jasmine'>        /**
</span>         * @cfg {Boolean} jasmine This option can only be specified in the {@link Siesta.Project#start test files descriptor}.
...
<span id='Siesta-Project-Browser-cfg-needUI'>        /**
</span>         * @cfg {Boolean} needUI This option determines whether the Siesta UI should be rendered. By default, it is enabled
...
<span id='Siesta-Project-Browser-cfg-rerunHotKey'>        /**
</span>         * @cfg {String} rerunHotKey The key to press together with CTRL to rerun the latest test
         */
        rerunHotKey                 : &#39;E&#39;,

<span id='Siesta-Project-Browser-cfg-observerModeHotKey'>        /**
</span>         * @cfg {String} observerModeHotKey The key to press together with CTRL to toggle the &quot;observer mode&quot; on/off.
         * The &quot;observer mode&quot; is a combination of enabled {@link #forceDOMVisible} and {@link #runCore} `sequential`.
         */
        observerModeHotKey          : &#39;O&#39;,

<span id='Siesta-Project-Browser-cfg-restartOnBlur'>        /**
</span>         * @cfg {Boolean} restartOnBlur
         *
...
<span id='Siesta-Project-Browser-method-getQueryParam'>        /**
</span>         * @param {String} paramName
         *
...
<span id='Siesta-Project-Browser-method-isStandardPackage'>        /**
</span>         * This methos returns `true` if this project is being run on the
...
<span id='Siesta-Project-Browser-method-getSelectedTest'>        /**
</span>         * This method returns a test instance of the currently selected test in the UI.
         *
